; HOVER-SIGNATURE-HELP-DEFINITION-REFERENCES-E-RENAME-POR-SYMBOLID-F06: Interface-only definitions e dependency boundaries
...
global neboc_interface_definition
