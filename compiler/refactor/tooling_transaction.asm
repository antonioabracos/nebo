; HOVER-SIGNATURE-HELP-DEFINITION-REFERENCES-E-RENAME-POR-SYMBOLID-F07: CLI/LSP parity, stale snapshots e transactional edits
...
global neboc_tooling_transaction
