; PRELUDE-NO-PRELUDE-VISIBILIDADE-DA-STANDARD-LIBRARY-E-MIGRATIONS-DE-IMPORT-F05: Manifest/CLI no-prelude e freestanding profile
...
global neboc_no_prelude

%define DOC_MAX_INPUT NEBOC_PRELUDE_MAX_INPUT
%define DOC_TAG NEBOC_PRELUDE_TAG_DISABLED
