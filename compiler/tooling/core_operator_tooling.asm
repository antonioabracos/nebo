...
%define CORE_TOOL_RECORD_COUNT         NEBOC_CORE_ORF_REGISTRY_ENTRY_COUNT
...
align 8
core_tool_records:
 CORE_TOOL_ROW NEBOC_TOKEN_QUESTION,NEBOC_OPERATOR_ID_NSR_CORE_038,NEBOC_OPERATOR_PARSE_FIXITY_POSTFIX,NEBOC_OPERATOR_BP_POSTFIX,NEBOC_OPERATOR_PARSE_ASSOC_LEFT,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_SHORT_CIRCUIT|CORE_TOOL_FLAG_CONTEXTUAL,lex_question,1,api_question,16,NEBOC_DIAG_QUESTION_PROPAGATION_CONTEXT
 CORE_TOOL_ROW NEBOC_TOKEN_COALESCE,NEBOC_OPERATOR_ID_NSR_CORE_039,NEBOC_OPERATOR_PARSE_FIXITY_INFIX,NEBOC_OPERATOR_BP_COALESCE,NEBOC_OPERATOR_PARSE_ASSOC_RIGHT,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_SHORT_CIRCUIT,lex_coalesce,2,api_coalesce,15,NEBOC_DIAG_QUESTION_COALESCE_OPERANDS
 CORE_TOOL_ROW NEBOC_TOKEN_OPTIONAL_CHAIN,NEBOC_OPERATOR_ID_NSR_CORE_040,NEBOC_OPERATOR_PARSE_FIXITY_SUFFIX,NEBOC_OPERATOR_BP_SUFFIX,NEBOC_OPERATOR_PARSE_ASSOC_LEFT,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_SHORT_CIRCUIT|CORE_TOOL_FLAG_CONTEXTUAL,lex_optional_chain,2,api_optional_chain,13,NEBOC_DIAG_QUESTION_OPTIONAL_CHAIN_RECEIVER
 CORE_TOOL_ROW NEBOC_TOKEN_OPTION_ASSIGN,NEBOC_OPERATOR_ID_NSR_CORE_041,NEBOC_OPERATOR_PARSE_FIXITY_INFIX,NEBOC_OPERATOR_BP_ASSIGNMENT,NEBOC_OPERATOR_PARSE_ASSOC_RIGHT,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_SHORT_CIRCUIT|CORE_TOOL_FLAG_CONTEXTUAL|CORE_TOOL_FLAG_STATEMENT,lex_option_assign,3,api_option_assign,19,NEBOC_DIAG_QUESTION_CONDITIONAL_ASSIGN_TARGET
 CORE_TOOL_ROW NEBOC_TOKEN_RANGE_INCLUSIVE,NEBOC_OPERATOR_ID_NSR_CORE_043,NEBOC_OPERATOR_PARSE_FIXITY_INFIX,NEBOC_OPERATOR_BP_RANGE,NEBOC_OPERATOR_PARSE_ASSOC_NONASSOC,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_UNICODE|CORE_TOOL_FLAG_NONASSOCIATIVE,lex_range_inclusive,3,api_range_inclusive,15,NEBOC_DIAG_OPERATOR_AMBIGUOUS
 CORE_TOOL_ROW NEBOC_TOKEN_RANGE_EXCLUSIVE_END,NEBOC_OPERATOR_ID_NSR_CORE_044,NEBOC_OPERATOR_PARSE_FIXITY_INFIX,NEBOC_OPERATOR_BP_RANGE,NEBOC_OPERATOR_PARSE_ASSOC_NONASSOC,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_UNICODE|CORE_TOOL_FLAG_NONASSOCIATIVE,lex_range_exclusive_end,4,api_range_exclusive_end,18,NEBOC_DIAG_OPERATOR_AMBIGUOUS
 CORE_TOOL_ROW NEBOC_TOKEN_RANGE_EXCLUSIVE_START,NEBOC_OPERATOR_ID_NSR_CORE_045,NEBOC_OPERATOR_PARSE_FIXITY_INFIX,NEBOC_OPERATOR_BP_RANGE,NEBOC_OPERATOR_PARSE_ASSOC_NONASSOC,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_UNICODE|CORE_TOOL_FLAG_NONASSOCIATIVE,lex_range_exclusive_start,4,api_range_exclusive_start,20,NEBOC_DIAG_OPERATOR_AMBIGUOUS
 CORE_TOOL_ROW NEBOC_TOKEN_RANGE_EXCLUSIVE,NEBOC_OPERATOR_ID_NSR_CORE_046,NEBOC_OPERATOR_PARSE_FIXITY_INFIX,NEBOC_OPERATOR_BP_RANGE,NEBOC_OPERATOR_PARSE_ASSOC_NONASSOC,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_UNICODE|CORE_TOOL_FLAG_NONASSOCIATIVE,lex_range_exclusive,5,api_range_exclusive,15,NEBOC_DIAG_OPERATOR_AMBIGUOUS
 CORE_TOOL_ROW NEBOC_TOKEN_LATERAL_FLOW,NEBOC_OPERATOR_ID_NSR_CORE_047,NEBOC_OPERATOR_PARSE_FIXITY_INFIX,NEBOC_OPERATOR_BP_COMPOSITION,NEBOC_OPERATOR_PARSE_ASSOC_NONASSOC,CORE_TOOL_FLAG_CANONICAL|CORE_TOOL_FLAG_CONTEXTUAL|CORE_TOOL_FLAG_NONASSOCIATIVE|CORE_TOOL_FLAG_FLOW,lex_lateral_flow,2,api_lateral_flow,7,NEBOC_DIAG_OPERATOR_AMBIGUOUS
...
.unicode_midline_ellipsis:
 ...
 jmp .publish_range
.ascii_ellipsis:
 ; G144 reserves exact ASCII `...`; tooling must not reinterpret it as the
 ; active U+2026 mathematical range or publish a replacement action.
 jmp .migration_missing
.publish_range:
