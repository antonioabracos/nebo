# NEBO-BIBLIOTECA-PADRAO-POR-DOMINIOS-SECURITY-006

std.math request integrity or bounded purity check failed

```text
Identity: NEBO-BIBLIOTECA-PADRAO-POR-DOMINIOS-SECURITY-006 (DIAGNOSTIC_CODE)
Edition: 1
