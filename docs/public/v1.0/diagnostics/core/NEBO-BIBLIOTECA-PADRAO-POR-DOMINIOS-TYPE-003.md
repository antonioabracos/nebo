# NEBO-BIBLIOTECA-PADRAO-POR-DOMINIOS-TYPE-003

std.math signed Int operand or clamp domain is invalid

```text
Identity: NEBO-BIBLIOTECA-PADRAO-POR-DOMINIOS-TYPE-003 (DIAGNOSTIC_CODE)
Edition: 1
