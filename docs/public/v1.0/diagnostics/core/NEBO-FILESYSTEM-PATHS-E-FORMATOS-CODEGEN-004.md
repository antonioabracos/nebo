# NEBO-FILESYSTEM-PATHS-E-FORMATOS-CODEGEN-004

lexical path code generation is unavailable before FILESYSTEM-PATHS-E-FORMATOS-PF005

```text
Identity: NEBO-FILESYSTEM-PATHS-E-FORMATOS-CODEGEN-004 (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO-FILESYSTEM-PATHS-E-FORMATOS-CODEGEN-004
Severity: 1
Phase: 10
Message: lexical path code generation is unavailable before FILESYSTEM-PATHS-E-FORMATOS-PF005
```

## Meaning and remediation

Condition reported: lexical path code generation is unavailable before FILESYSTEM-PATHS-E-FORMATOS-PF005. Locate the primary span, correct this condition and re-run check before requesting build. For capacity diagnostics reduce the indicated bounded input; for type/receiver errors use the declared domain; for internal invariant failures retain the source and compiler identity for a compiler defect report.
