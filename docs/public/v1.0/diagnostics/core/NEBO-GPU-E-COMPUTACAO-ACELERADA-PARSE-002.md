# NEBO-GPU-E-COMPUTACAO-ACELERADA-PARSE-002

GPU constructs are unavailable in the research-only profile

```text
Identity: NEBO-GPU-E-COMPUTACAO-ACELERADA-PARSE-002 (DIAGNOSTIC_CODE)
Edition: 1
