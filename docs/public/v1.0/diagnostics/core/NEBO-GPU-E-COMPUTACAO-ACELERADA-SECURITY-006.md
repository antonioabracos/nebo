# NEBO-GPU-E-COMPUTACAO-ACELERADA-SECURITY-006

GPU capability is denied by the research-only profile

```text
Identity: NEBO-GPU-E-COMPUTACAO-ACELERADA-SECURITY-006 (DIAGNOSTIC_CODE)
Edition: 1
