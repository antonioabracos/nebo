# NEBO-IMPORTS-MODULOS-NAMESPACES-E-API-PUBLICA-TYPE-003

module package import or symbol identity is invalid

```text
Identity: NEBO-IMPORTS-MODULOS-NAMESPACES-E-API-PUBLICA-TYPE-003 (DIAGNOSTIC_CODE)
Edition: 1
