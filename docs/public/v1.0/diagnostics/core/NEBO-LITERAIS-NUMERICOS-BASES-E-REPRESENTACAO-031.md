# NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-031

continue is only valid inside a loop

```text
Identity: NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-031 (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-031
Severity: 1
Phase: 6
...
### control:continue-outside; expected NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-031

```nebo
start(){continue;23.return;}
```

Oracle: {"artifact_publication": "REJECTED", "compiler_exit": 1, "diagnostic": "NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-031"}
