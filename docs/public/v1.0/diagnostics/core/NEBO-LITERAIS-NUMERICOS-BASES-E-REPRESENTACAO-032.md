# NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-032

while condition must have type Bool

```text
Identity: NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-032 (DIAGNOSTIC_CODE)
Edition: 1
...
### control:while-condition; expected NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-032

```nebo
start(){while(17){break;}23.return;}
```

Oracle: {"artifact_publication": "REJECTED", "compiler_exit": 1, "diagnostic": "NEBO-LITERAIS-NUMERICOS-BASES-E-REPRESENTACAO-032"}
