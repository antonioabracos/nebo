# NEBO-MEDIA-IMAGEM-AUDIO-E-VIDEO-RUNTIME-005

synthetic media resource bound or declared extent was truncated

```text
Identity: NEBO-MEDIA-IMAGEM-AUDIO-E-VIDEO-RUNTIME-005 (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO-MEDIA-IMAGEM-AUDIO-E-VIDEO-RUNTIME-005
Severity: 1
Phase: 11
Message: synthetic media resource bound or declared extent was truncated
```

## Meaning and remediation

Condition reported: synthetic media resource bound or declared extent was truncated. Locate the primary span, correct this condition and re-run check before requesting build. For capacity diagnostics reduce the indicated bounded input; for type/receiver errors use the declared domain; for internal invariant failures retain the source and compiler identity for a compiler defect report.
