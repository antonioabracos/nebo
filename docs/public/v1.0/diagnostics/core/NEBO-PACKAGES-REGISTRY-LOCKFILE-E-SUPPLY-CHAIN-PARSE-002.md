# NEBO-PACKAGES-REGISTRY-LOCKFILE-E-SUPPLY-CHAIN-PARSE-002

malformed package dependency version digest or policy syntax

```text
Identity: NEBO-PACKAGES-REGISTRY-LOCKFILE-E-SUPPLY-CHAIN-PARSE-002 (DIAGNOSTIC_CODE)
Edition: 1
