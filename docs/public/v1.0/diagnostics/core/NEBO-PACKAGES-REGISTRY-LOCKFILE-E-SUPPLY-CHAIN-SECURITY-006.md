# NEBO-PACKAGES-REGISTRY-LOCKFILE-E-SUPPLY-CHAIN-SECURITY-006

package digest policy or lock integrity check failed

```text
Identity: NEBO-PACKAGES-REGISTRY-LOCKFILE-E-SUPPLY-CHAIN-SECURITY-006 (DIAGNOSTIC_CODE)
Edition: 1
