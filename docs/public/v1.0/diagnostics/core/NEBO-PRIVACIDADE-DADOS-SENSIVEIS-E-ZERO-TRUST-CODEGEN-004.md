# NEBO-PRIVACIDADE-DADOS-SENSIVEIS-E-ZERO-TRUST-CODEGEN-004

privacy proof cannot be lowered for this target or front

```text
Identity: NEBO-PRIVACIDADE-DADOS-SENSIVEIS-E-ZERO-TRUST-CODEGEN-004 (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO-PRIVACIDADE-DADOS-SENSIVEIS-E-ZERO-TRUST-CODEGEN-004
Severity: 1
Phase: 10
Message: privacy proof cannot be lowered for this target or front
```

## Meaning and remediation

Condition reported: privacy proof cannot be lowered for this target or front. Locate the primary span, correct this condition and re-run check before requesting build. For capacity diagnostics reduce the indicated bounded input; for type/receiver errors use the declared domain; for internal invariant failures retain the source and compiler identity for a compiler defect report.
