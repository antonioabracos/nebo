# NEBO-QUALITY-CONFIDENCE-E-LINEAGE-CODEGEN-004

quality confidence lineage proof is unavailable before QUALITY-CONFIDENCE-E-LINEAGE-PF005

```text
Identity: NEBO-QUALITY-CONFIDENCE-E-LINEAGE-CODEGEN-004 (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO-QUALITY-CONFIDENCE-E-LINEAGE-CODEGEN-004
Severity: 1
Phase: 10
Message: quality confidence lineage proof is unavailable before QUALITY-CONFIDENCE-E-LINEAGE-PF005
```

## Meaning and remediation

Condition reported: quality confidence lineage proof is unavailable before QUALITY-CONFIDENCE-E-LINEAGE-PF005. Locate the primary span, correct this condition and re-run check before requesting build. For capacity diagnostics reduce the indicated bounded input; for type/receiver errors use the declared domain; for internal invariant failures retain the source and compiler identity for a compiler defect report.
