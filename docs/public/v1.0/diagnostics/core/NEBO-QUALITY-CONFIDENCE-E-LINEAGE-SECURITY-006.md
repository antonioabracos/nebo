# NEBO-QUALITY-CONFIDENCE-E-LINEAGE-SECURITY-006

quality confidence privacy or lineage authority check failed

```text
Identity: NEBO-QUALITY-CONFIDENCE-E-LINEAGE-SECURITY-006 (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO-QUALITY-CONFIDENCE-E-LINEAGE-SECURITY-006
Severity: 1
Phase: 14
Message: quality confidence privacy or lineage authority check failed
```

## Meaning and remediation

Condition reported: quality confidence privacy or lineage authority check failed. Locate the primary span, correct this condition and re-run check before requesting build. For capacity diagnostics reduce the indicated bounded input; for type/receiver errors use the declared domain; for internal invariant failures retain the source and compiler identity for a compiler defect report.
