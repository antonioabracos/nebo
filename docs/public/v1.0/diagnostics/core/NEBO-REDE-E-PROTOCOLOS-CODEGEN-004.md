# NEBO-REDE-E-PROTOCOLOS-CODEGEN-004

network-port code generation is unavailable before REDE-E-PROTOCOLOS-PF005

```text
Identity: NEBO-REDE-E-PROTOCOLOS-CODEGEN-004 (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO-REDE-E-PROTOCOLOS-CODEGEN-004
Severity: 1
Phase: 10
Message: network-port code generation is unavailable before REDE-E-PROTOCOLOS-PF005
```

## Meaning and remediation

Condition reported: network-port code generation is unavailable before REDE-E-PROTOCOLOS-PF005. Locate the primary span, correct this condition and re-run check before requesting build. For capacity diagnostics reduce the indicated bounded input; for type/receiver errors use the declared domain; for internal invariant failures retain the source and compiler identity for a compiler defect report.
