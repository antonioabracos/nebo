# NEBO-RUNTIME-DISTRIBUIDO-E-STREAMING-DISTRIBUIDO-CODEGEN-004

distributed code generation is outside the local simulation profile

```text
Identity: NEBO-RUNTIME-DISTRIBUIDO-E-STREAMING-DISTRIBUIDO-CODEGEN-004 (DIAGNOSTIC_CODE)
Edition: 1
