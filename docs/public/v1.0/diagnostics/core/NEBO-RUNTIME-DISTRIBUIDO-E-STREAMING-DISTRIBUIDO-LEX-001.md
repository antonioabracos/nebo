# NEBO-RUNTIME-DISTRIBUIDO-E-STREAMING-DISTRIBUIDO-LEX-001

unsupported local queue simulation spelling

```text
Identity: NEBO-RUNTIME-DISTRIBUIDO-E-STREAMING-DISTRIBUIDO-LEX-001 (DIAGNOSTIC_CODE)
Edition: 1
