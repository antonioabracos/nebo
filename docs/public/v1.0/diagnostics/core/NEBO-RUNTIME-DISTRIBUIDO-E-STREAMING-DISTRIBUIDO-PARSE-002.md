# NEBO-RUNTIME-DISTRIBUIDO-E-STREAMING-DISTRIBUIDO-PARSE-002

malformed local queue simulation descriptor

```text
Identity: NEBO-RUNTIME-DISTRIBUIDO-E-STREAMING-DISTRIBUIDO-PARSE-002 (DIAGNOSTIC_CODE)
Edition: 1
