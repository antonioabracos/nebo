# NEBO_BEHAVIOR_NOT_SUPPORTED

function does not accept this behavior descriptor

```text
Identity: NEBO_BEHAVIOR_NOT_SUPPORTED (DIAGNOSTIC_CODE)
Edition: 1
...
### scan:legacy-seed-eclipse; expected NEBO_BEHAVIOR_NOT_SUPPORTED

```nebo
start(){ScanPlan;2501;adapter.scan(.console());23.return;}
```
