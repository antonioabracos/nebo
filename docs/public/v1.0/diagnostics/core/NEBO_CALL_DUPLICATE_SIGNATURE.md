# NEBO_CALL_DUPLICATE_SIGNATURE

duplicate function signature

```text
Identity: NEBO_CALL_DUPLICATE_SIGNATURE (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO_CALL_DUPLICATE_SIGNATURE
Severity: 1
Phase: 6
