# NEBO_CALL_NESTED_FUNCTION

nested functions are not supported in Nebo v0.1

```text
Identity: NEBO_CALL_NESTED_FUNCTION (DIAGNOSTIC_CODE)
Edition: 1
