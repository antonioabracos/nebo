# NEBO_CALL_RECURSION_FRAME

selected recursive function requires an exact 16-byte frame

```text
Identity: NEBO_CALL_RECURSION_FRAME (DIAGNOSTIC_CODE)
Edition: 1
