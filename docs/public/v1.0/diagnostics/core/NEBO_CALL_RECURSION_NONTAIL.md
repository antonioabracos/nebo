# NEBO_CALL_RECURSION_NONTAIL

recursive self-call must be the direct expression of a branch return

```text
Identity: NEBO_CALL_RECURSION_NONTAIL (DIAGNOSTIC_CODE)
Edition: 1
