# NEBO_CALL_RECURSION_SURFACE

recursive function must use the selected Int receiver, zero-parameter, Int-return surface

```text
Identity: NEBO_CALL_RECURSION_SURFACE (DIAGNOSTIC_CODE)
Edition: 1
