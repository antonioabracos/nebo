# NEBO_CONST_WRITE_FORBIDDEN

ConstBinding is immutable and cannot be marked mutable or reassigned

```text
Identity: NEBO_CONST_WRITE_FORBIDDEN (DIAGNOSTIC_CODE)
Edition: 1
...
### binding:constant-bool-mutable; expected NEBO_CONST_WRITE_FORBIDDEN

```nebo
start(){true.VALUE.mutable;VALUE.return;}
```
