# NEBO_CONTROL_BRANCH_SCOPE

branch scopes must be distinct children of the parent scope

```text
Identity: NEBO_CONTROL_BRANCH_SCOPE (DIAGNOSTIC_CODE)
Edition: 1
