# NEBO_CONTROL_CONDITION_TYPE

if and logical conditions require Bool

```text
Identity: NEBO_CONTROL_CONDITION_TYPE (DIAGNOSTIC_CODE)
Edition: 1
...
### control:if-condition; expected NEBO_CONTROL_CONDITION_TYPE

```nebo
start(){if(17){23.return;}29.return;}
```

Oracle: {"artifact_publication": "REJECTED", "compiler_exit": 1, "diagnostic": "NEBO_CONTROL_CONDITION_TYPE"}
