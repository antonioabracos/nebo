...
owned value cannot be copied implicitly; move or clone it explicitly

```text
Identity: NEBO_COPY_UNIQUE (DIAGNOSTIC_CODE)
Edition: 1
...
### sequence:List-copy; expected NEBO_COPY_UNIQUE

```nebo
start(){List<Int>.new().a;a.b;23.return;}
```
