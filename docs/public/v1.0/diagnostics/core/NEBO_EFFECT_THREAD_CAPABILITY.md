# NEBO_EFFECT_THREAD_CAPABILITY

only console or scan effects may be thread-capable

```text
Identity: NEBO_EFFECT_THREAD_CAPABILITY (DIAGNOSTIC_CODE)
Edition: 1
