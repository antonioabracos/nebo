# NEBO_ENTRYPOINT_AMBIGUOUS

start() identity is ambiguous in the selected target

```text
Identity: NEBO_ENTRYPOINT_AMBIGUOUS (DIAGNOSTIC_CODE)
Edition: 1
