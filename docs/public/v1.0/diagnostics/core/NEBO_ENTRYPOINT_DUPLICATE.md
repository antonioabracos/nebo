# NEBO_ENTRYPOINT_DUPLICATE

selected target declares more than one start()

```text
Identity: NEBO_ENTRYPOINT_DUPLICATE (DIAGNOSTIC_CODE)
Edition: 1
