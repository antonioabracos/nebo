# NEBO_ENTRYPOINT_FORBIDDEN_FOR_TARGET

library and test targets must not declare start()

```text
Identity: NEBO_ENTRYPOINT_FORBIDDEN_FOR_TARGET (DIAGNOSTIC_CODE)
Edition: 1
