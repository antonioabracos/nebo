# NEBO_FUNCTION_CALL_CAPACITY

direct invocation count exceeds the bounded maximum of 256

```text
Identity: NEBO_FUNCTION_CALL_CAPACITY (DIAGNOSTIC_CODE)
Edition: 1
