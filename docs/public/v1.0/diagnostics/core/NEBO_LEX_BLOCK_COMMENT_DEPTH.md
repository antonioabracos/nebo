# NEBO_LEX_BLOCK_COMMENT_DEPTH

nested block comment exceeds the maximum depth of 64

```text
Identity: NEBO_LEX_BLOCK_COMMENT_DEPTH (DIAGNOSTIC_CODE)
Edition: 1
