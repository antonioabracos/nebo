# NEBO_LEX_REJECTED_FORM

source form is REJECTED; use the explicit canonical migration

```text
Identity: NEBO_LEX_REJECTED_FORM (DIAGNOSTIC_CODE)
Edition: 1
...
### lexical:unicode-10; expected NEBO_LEX_REJECTED_FORM
