# NEBO_LEX_RESERVED_SYMBOL

symbol spelling is RESERVED and has no executable semantics

```text
Identity: NEBO_LEX_RESERVED_SYMBOL (DIAGNOSTIC_CODE)
Edition: 1
