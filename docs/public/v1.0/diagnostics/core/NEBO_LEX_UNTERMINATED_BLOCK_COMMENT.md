# NEBO_LEX_UNTERMINATED_BLOCK_COMMENT

unterminated nested block comment

```text
Identity: NEBO_LEX_UNTERMINATED_BLOCK_COMMENT (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO_LEX_UNTERMINATED_BLOCK_COMMENT
Severity: 1
Phase: 3
