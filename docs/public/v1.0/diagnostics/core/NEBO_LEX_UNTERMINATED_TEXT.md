# NEBO_LEX_UNTERMINATED_TEXT

unterminated Text literal

```text
Identity: NEBO_LEX_UNTERMINATED_TEXT (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO_LEX_UNTERMINATED_TEXT
Severity: 1
Phase: 3
