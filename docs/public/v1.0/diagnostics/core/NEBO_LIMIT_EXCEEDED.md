...
```text
Identity: NEBO_LIMIT_EXCEEDED (DIAGNOSTIC_CODE)
Edition: 1
...
### dict:capacity-invalid-0; expected NEBO_LIMIT_EXCEEDED

```nebo
start(){Dict<Int,Int>.withCapacity(0).d;0.return;}
