# NEBO_NESTED_CALL_BEFORE_DECLARATION

nested helper call must appear after its declaration

```text
Identity: NEBO_NESTED_CALL_BEFORE_DECLARATION (DIAGNOSTIC_CODE)
Edition: 1
