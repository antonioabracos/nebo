# NEBO_NESTED_CAPACITY

nested helper depth or capacity exceeds the selected one-level bound

```text
Identity: NEBO_NESTED_CAPACITY (DIAGNOSTIC_CODE)
Edition: 1
