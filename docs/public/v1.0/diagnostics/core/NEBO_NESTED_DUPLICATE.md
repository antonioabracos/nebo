# NEBO_NESTED_DUPLICATE

only one nested helper is permitted per outer function

```text
Identity: NEBO_NESTED_DUPLICATE (DIAGNOSTIC_CODE)
Edition: 1
