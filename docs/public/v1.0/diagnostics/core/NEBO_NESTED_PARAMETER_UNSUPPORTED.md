# NEBO_NESTED_PARAMETER_UNSUPPORTED

nested helper accepts zero explicit parameters

```text
Identity: NEBO_NESTED_PARAMETER_UNSUPPORTED (DIAGNOSTIC_CODE)
Edition: 1
