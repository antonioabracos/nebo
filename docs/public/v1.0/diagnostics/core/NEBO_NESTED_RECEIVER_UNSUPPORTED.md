# NEBO_NESTED_RECEIVER_UNSUPPORTED

nested helper requires the exact Int.self receiver

```text
Identity: NEBO_NESTED_RECEIVER_UNSUPPORTED (DIAGNOSTIC_CODE)
Edition: 1
