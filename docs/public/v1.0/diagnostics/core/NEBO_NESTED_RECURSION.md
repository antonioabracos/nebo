# NEBO_NESTED_RECURSION

nested helper recursion is outside the selected acyclic call graph

```text
Identity: NEBO_NESTED_RECURSION (DIAGNOSTIC_CODE)
Edition: 1
