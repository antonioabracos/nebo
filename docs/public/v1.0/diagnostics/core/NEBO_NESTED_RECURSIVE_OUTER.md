# NEBO_NESTED_RECURSIVE_OUTER

a recursive outer function cannot declare the selected nested helper

```text
Identity: NEBO_NESTED_RECURSIVE_OUTER (DIAGNOSTIC_CODE)
Edition: 1
