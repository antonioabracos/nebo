# NEBO_NESTED_RETURN_UNSUPPORTED

nested helper must return Int on the selected scalar surface

```text
Identity: NEBO_NESTED_RETURN_UNSUPPORTED (DIAGNOSTIC_CODE)
Edition: 1
