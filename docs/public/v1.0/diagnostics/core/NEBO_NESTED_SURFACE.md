...
nested helper body uses a feature outside the selected noncapturing scalar surface

```text
Identity: NEBO_NESTED_SURFACE (DIAGNOSTIC_CODE)
Edition: 1
