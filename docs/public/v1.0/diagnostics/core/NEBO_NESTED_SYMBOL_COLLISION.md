# NEBO_NESTED_SYMBOL_COLLISION

private nested helper symbol identity collided internally

```text
Identity: NEBO_NESTED_SYMBOL_COLLISION (DIAGNOSTIC_CODE)
Edition: 1
