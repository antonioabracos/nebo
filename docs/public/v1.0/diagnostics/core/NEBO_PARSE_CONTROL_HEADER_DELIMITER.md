# NEBO_PARSE_CONTROL_HEADER_DELIMITER

control header requires a closing parenthesis

```text
Identity: NEBO_PARSE_CONTROL_HEADER_DELIMITER (DIAGNOSTIC_CODE)
Edition: 1
