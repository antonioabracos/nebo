# NEBO_PARSE_CONTROL_HEADER_PARENS_REQUIRED

control header requires parentheses

```text
Identity: NEBO_PARSE_CONTROL_HEADER_PARENS_REQUIRED (DIAGNOSTIC_CODE)
Edition: 1
