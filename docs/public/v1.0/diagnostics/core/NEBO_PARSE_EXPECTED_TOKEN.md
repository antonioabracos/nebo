# NEBO_PARSE_EXPECTED_TOKEN

expected token {0}

```text
Identity: NEBO_PARSE_EXPECTED_TOKEN (DIAGNOSTIC_CODE)
Edition: 1
...
### lexical:unavailable-3; expected NEBO_PARSE_EXPECTED_TOKEN

```nebo
start(){await 7;23.return;}
```
