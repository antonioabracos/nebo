# NEBO_PARSE_INVALID_CONTROL_CHAIN

if/else are statements and cannot be used as fluent chain suffixes

```text
Identity: NEBO_PARSE_INVALID_CONTROL_CHAIN (DIAGNOSTIC_CODE)
Edition: 1
