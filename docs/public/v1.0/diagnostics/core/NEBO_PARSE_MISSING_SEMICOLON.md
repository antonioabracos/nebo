# NEBO_PARSE_MISSING_SEMICOLON

expected ';' after statement

```text
Identity: NEBO_PARSE_MISSING_SEMICOLON (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO_PARSE_MISSING_SEMICOLON
Severity: 1
Phase: 4
