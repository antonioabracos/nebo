# NEBO_PARSE_NONASSOCIATIVE_CHAIN

comparison and equality operators cannot be chained without explicit grouping

```text
Identity: NEBO_PARSE_NONASSOCIATIVE_CHAIN (DIAGNOSTIC_CODE)
Edition: 1
