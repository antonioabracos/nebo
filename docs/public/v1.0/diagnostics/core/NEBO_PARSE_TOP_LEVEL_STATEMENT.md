# NEBO_PARSE_TOP_LEVEL_STATEMENT

statements are not allowed at top level

```text
Identity: NEBO_PARSE_TOP_LEVEL_STATEMENT (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO_PARSE_TOP_LEVEL_STATEMENT
Severity: 1
Phase: 4
