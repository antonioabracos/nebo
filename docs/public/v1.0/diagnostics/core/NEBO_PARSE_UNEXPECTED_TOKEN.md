# NEBO_PARSE_UNEXPECTED_TOKEN

unexpected token while parsing statement

```text
Identity: NEBO_PARSE_UNEXPECTED_TOKEN (DIAGNOSTIC_CODE)
Edition: 1
...
### local:invalid-print; expected NEBO_PARSE_UNEXPECTED_TOKEN
