# NEBO_SOURCE_BOM_FORBIDDEN

UTF-8 BOM is forbidden

```text
Identity: NEBO_SOURCE_BOM_FORBIDDEN (DIAGNOSTIC_CODE)
Edition: 1
...
```text
Code: NEBO_SOURCE_BOM_FORBIDDEN
Severity: 1
Phase: 2
