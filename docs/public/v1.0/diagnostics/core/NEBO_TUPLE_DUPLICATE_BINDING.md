# NEBO_TUPLE_DUPLICATE_BINDING

Tuple destructuring binding is already initialized in this scope

```text
Identity: NEBO_TUPLE_DUPLICATE_BINDING (DIAGNOSTIC_CODE)
Edition: 1
