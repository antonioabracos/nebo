# NEBO_TUPLE_INDEX_OUT_OF_RANGE

constant Tuple component index is outside its arity

```text
Identity: NEBO_TUPLE_INDEX_OUT_OF_RANGE (DIAGNOSTIC_CODE)
Edition: 1
