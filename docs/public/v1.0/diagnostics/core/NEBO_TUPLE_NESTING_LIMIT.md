# NEBO_TUPLE_NESTING_LIMIT

Tuple nesting exceeds the bounded maximum depth of 4

```text
Identity: NEBO_TUPLE_NESTING_LIMIT (DIAGNOSTIC_CODE)
Edition: 1
