# NEBO_TYPE_INCONSISTENT_RETURN

function returns inconsistent fundamental types

```text
Identity: NEBO_TYPE_INCONSISTENT_RETURN (DIAGNOSTIC_CODE)
Edition: 1
