# NEBO_TYPE_MISSING_RETURN

value-returning function can fall through without return

```text
Identity: NEBO_TYPE_MISSING_RETURN (DIAGNOSTIC_CODE)
Edition: 1
