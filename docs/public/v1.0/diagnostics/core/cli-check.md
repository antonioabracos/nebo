...
```text
neboc check source.no [--edition 1|2] [--no-prelude]
```

## Behavior and usage

Checks every admitted statement without executing user code or publishing an executable.
...
neboc check examples/rf204/G185/RF204-G185-S07.no --edition 1
