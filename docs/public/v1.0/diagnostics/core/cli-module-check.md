...
Validate a bounded module graph.

```text
Identity: cli:module-check (CLI_FORM)
Edition: 1
...
Resolves logical module names and exports with no capability grant. Cycles, duplicate identities and effectful imported startup reject before publication.
