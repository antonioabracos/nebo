...
```text
Identity: N1-cancellation-scheduling (NORMATIVE_RULE)
Edition: 1
...
```text
N1-cancellation-scheduling — NORMATIVE_BOUNDARY_OF_MATERIAL_NON_STABLE_PROFILE
```
...
[
  {
    "binary_sha256": "c9b9393bf4933140259b5732400939d87b4354c7866b6d2f051d85479b34ed2d",
    "case_id": "semantic-native:scheduler",
