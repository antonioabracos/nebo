...
```text
Identity: N1-policy-before-sink (NORMATIVE_RULE)
Edition: 1
...
```text
N1-policy-before-sink — NORMATIVE_BOUNDARY_WITH_INTERNAL_SUPPLEMENT
```
...
[
  {
    "binary_sha256": "302a3fb83accd9d379b0c2399f5cbabc17da48534d31d1e850ca784e7466fbd5",
    "case_id": "semantic-native:policy",
