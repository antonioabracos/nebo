...
The assignment production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:assignment (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/mutable_assignment_parser.asm — SHA-256 66e6732809bf9b830acc742147261adbbe18c32303f6e4e183b80489825263a5
