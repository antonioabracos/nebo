# continue_statement syntax

The continue_statement production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:continue_statement (GRAMMAR_PRODUCTION)
Edition: 1
...
### control:continue; expected 25

```nebo
start(){0.total.mutable;0.i.mutable;while(i<7){i+=1;if(i==3){continue;}total+=i;}total.return;}
```

Oracle: {"independent_builds": 2, "process_exit": 25, "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}
