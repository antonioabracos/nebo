# delimited_math syntax

The delimited_math production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:delimited_math (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/expression/matrix_postfix_binder.asm — SHA-256 fe9611954c57d86612b932db906090ae46fd5b32fa3f620bb6754980b5e8e7f6
