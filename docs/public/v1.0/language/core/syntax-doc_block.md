...
The doc_block production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:doc_block (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/doc_lexer.asm — SHA-256 6724290c96a23a265bb633682455853e7fb1638c7e458bca5287090a6747ff08
