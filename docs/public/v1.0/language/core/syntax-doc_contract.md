...
The doc_contract production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:doc_contract (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/doc_contract_blocks.asm — SHA-256 7a1241f4b6ef229a9fa122de96a3ac6996044b1e25f8643e78b29e17bf46f745
