...
The doc_field production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:doc_field (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/doc_fields.asm — SHA-256 ee91630ece8faa11fa9b1ed9a97aab2749bb30412bfb0f3bc3afa68c915ed1b6
