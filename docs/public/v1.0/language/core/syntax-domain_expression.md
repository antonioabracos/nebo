# domain_expression syntax

The domain_expression production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:domain_expression (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/expression/differential_operator_plan.asm — SHA-256 47ea3038c6be988543ee05b98fe5a285cb73f1edd56b9d192adce7d4c9c1fed1
