# domain_suffix syntax

The domain_suffix production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:domain_suffix (GRAMMAR_PRODUCTION)
Edition: 1
