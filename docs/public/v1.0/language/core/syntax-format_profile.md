# format_profile syntax

The format_profile production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:format_profile (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/text/placeholder_plan.asm — SHA-256 651b55461471be3baf616709db5a7cad7e4e1b956b9e95dd0c8c7023a788c4a7
