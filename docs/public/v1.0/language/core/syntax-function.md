...
The function production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:function (GRAMMAR_PRODUCTION)
Edition: 1
...
### control:function-17; expected 24

```nebo
(Int.self)add(Int.delta){(self+delta).return;}start(){17.add(7).return;}
```
...
- compiler/parser/parameters_parser.asm — SHA-256 b0ce57d3a1b274fe75a68a47933fe300ab1dc1105fdadbf6c27628c2c87ade84
