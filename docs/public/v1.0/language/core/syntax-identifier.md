...
The identifier production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:identifier (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/lexer/lexer.asm — SHA-256 6fbdc96cd5389cc5faf4080fb26bf4c6c8b51a76e6069e6ff539c538756314a5
