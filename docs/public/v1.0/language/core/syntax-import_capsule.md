# import_capsule syntax

The import_capsule production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:import_capsule (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/import_parser.asm — SHA-256 4bda90d09e36520254217b0091c4e8d1db3edc51044fd33e169c3db112bd62cd
