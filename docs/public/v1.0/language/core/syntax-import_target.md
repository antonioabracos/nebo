# import_target syntax

The import_target production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:import_target (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/selective_import_parser.asm — SHA-256 4ab77f26edccbc8755c42d3c3c4ce89aa794d0372fe6adc6ba853179e0920301
