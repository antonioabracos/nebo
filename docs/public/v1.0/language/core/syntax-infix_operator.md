...
The infix_operator production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:infix_operator (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/expression/operator_precedence.asm — SHA-256 5c8aade315b6e443b9f40a557ea4653427eb55f324168911d3431012a76543bd
