...
The match_arm production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:match_arm (GRAMMAR_PRODUCTION)
Edition: 1
...
### composite:enum-payload-match; expected 42

```nebo
enum Number { Empty, Value(Int) }
start() {
    Number.Value(42).value;
    match(value) {
        Empty -> 0.return;
        Value(payload) -> payload.return;
    }
}

```

Oracle: {"independent_builds": 2, "process_exit": 42, "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}
...
- compiler/parser/nominal_types.asm — SHA-256 48f8764e37934681cab01bfdbebfbf457cc4f79e15c57bb2150aceaea01fc6b3
