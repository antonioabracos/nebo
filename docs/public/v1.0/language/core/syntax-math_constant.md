# math_constant syntax

The math_constant production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:math_constant (GRAMMAR_PRODUCTION)
Edition: 1
