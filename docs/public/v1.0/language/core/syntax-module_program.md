# module_program syntax

The module_program production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:module_program (GRAMMAR_PRODUCTION)
Edition: 1
