# multiline_text syntax

The multiline_text production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:multiline_text (GRAMMAR_PRODUCTION)
Edition: 1
