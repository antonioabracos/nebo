# postfix_operator syntax

The postfix_operator production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:postfix_operator (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/expression/operator_suffix.asm — SHA-256 ded8fb559c355c84416348673effec96420663957851f043b96dd53e326297d7
