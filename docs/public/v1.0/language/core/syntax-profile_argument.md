# profile_argument syntax

The profile_argument production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:profile_argument (GRAMMAR_PRODUCTION)
Edition: 1
