# profile_binding syntax

The profile_binding production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:profile_binding (GRAMMAR_PRODUCTION)
Edition: 1
