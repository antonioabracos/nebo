# profile_program syntax

The profile_program production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:profile_program (GRAMMAR_PRODUCTION)
Edition: 1
