...
The raw_text production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:raw_text (GRAMMAR_PRODUCTION)
Edition: 1
...
### interpolation:raw; expected 23

```nebo
start(){r"${value}".console();23.return;}
```
...
- compiler/lexer/text_literals.asm — SHA-256 c5c005a691ad961c475fab1201c419c8d453ed43abf30ccc77c21bfd2c256ed6
