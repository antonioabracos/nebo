...
The reduction production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:reduction (GRAMMAR_PRODUCTION)
Edition: 1
...
- compiler/parser/expression/reduction_binder.asm — SHA-256 77f95db4e4a8b0f397a09f77dbd2b5a7edccb434cf66a4a86a3102e1da65abb6
