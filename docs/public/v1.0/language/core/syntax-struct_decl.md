...
The struct_decl production in the admitted structural grammar. Its delimiters and ordering are shown below; type, lifetime and profile restrictions apply after parsing.

```text
Identity: grammar:struct_decl (GRAMMAR_PRODUCTION)
Edition: 1
...
### composite:struct-default; expected 0

```nebo
struct Point { Int.x; Int.y; }
start() { Point.default().origin; origin.y; }
...
- compiler/parser/struct_declaration.inc — SHA-256 79e9aa8ac46b3b699d094f5be1e0b1063092267b4bc63f34528e7486bb3cb3cc
