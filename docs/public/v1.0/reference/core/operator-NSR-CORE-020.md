...
Boolean negation. Postfix factorial is a separate domain-gated context.

```text
Identity: NSR-CORE-020 (REGISTRY_ID)
Edition: 1
...
### operator:wrong-unary-21; expected NEBO_TYPE_MISMATCH
