...
```text
Identity: NSR-CORE-021 (REGISTRY_ID)
Edition: 1
...
left once; right only when left is true. Short-circuit: YES_RIGHT_LAZY. Operand rule: Bool and Bool. Result rule: Bool.
...
### operator:short-and; expected 23
