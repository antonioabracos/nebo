...
Typed equality. Current-head Char uniformity must be replayed before extending claims.

```text
Identity: NSR-CORE-028 (REGISTRY_ID)
Edition: 1
...
### operator:wrong-3d3d; expected NEBO_TYPE_MISMATCH
