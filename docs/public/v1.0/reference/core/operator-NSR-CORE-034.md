# *= — checked multiply assignment

Future checked multiplication assignment.

```text
Identity: NSR-CORE-034 (REGISTRY_ID)
Edition: 1
...
canonical_ascii: *=
operand_rule: mutable lvalue supporting Multiply
result_rule: no value
```

## Evaluation and types

target once, old value once, RHS once, one store on success. Short-circuit: NO. Operand rule: mutable lvalue supporting Multiply. Result rule: no value.
...
### binding:Int-compound-multiply; expected 23

```nebo
start(){17.value.mutable;value*=7;value.console();23.return;}
```

Oracle: {"console_text_utf8": "119", "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_sha256": "b1ec508f863773569493d46a9b2feda5c68187adb13021ec4ca8bc229d1b17fa"}
