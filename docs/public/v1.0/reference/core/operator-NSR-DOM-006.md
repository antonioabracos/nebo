...
Unicode constant alias with an ASCII \`PI\` name in the math module.

```text
Identity: NSR-DOM-006 (REGISTRY_ID)
Edition: 1
...
Oracle: {"console_text_utf8": "3.141593", "independent_builds": 2, "kinds": \[2\], "process_exit": 7, "publications": 1, "runtime_sha256": "17edec55dabd45678dfbd31547db2e5a3dc96821773501b8f4a27dce0cc3d87c"}
