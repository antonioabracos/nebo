...
Negates divisibility.

```text
Identity: NSR-DOM-015 (REGISTRY_ID)
Edition: 1
...
### operator:wrong-domain-e288a4; expected NEBO_TYPE_MISMATCH

```nebo
(Int.self)invalid(){(17 ∤ false).return;}start(){7.invalid().return;}
```
