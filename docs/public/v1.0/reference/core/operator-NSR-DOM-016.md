...
Mathematical floor delimiters.

```text
Identity: NSR-DOM-016 (REGISTRY_ID)
Edition: 1
...
### operator:round-e28c8a-0.5; expected 23
...
### operator:wrong-unary-666c6f6f72; expected NEBO_TYPE_MISMATCH
