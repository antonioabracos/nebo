...
Constructs a typed angle, never a plain number.

```text
Identity: NSR-DOM-019 (REGISTRY_ID)
Edition: 1
...
```text
lexeme: °
context: angle/units profile
fixity: postfix
arity: 1
precedence: P170_POSTFIX
associativity: left
canonical_ascii: Angle.degrees()
