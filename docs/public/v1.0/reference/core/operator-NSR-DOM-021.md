...
Typed basis-point ratio.

```text
Identity: NSR-DOM-021 (REGISTRY_ID)
Edition: 1
...
operand once. Short-circuit: NO. Operand rule: exact numeric value. Result rule: BasisPoints exact ratio scaled by 1/10000.
