...
Tests whether a value belongs to a set or explicitly opted-in collection.

```text
Identity: NSR-DOM-024 (REGISTRY_ID)
Edition: 1
...
### operator:wrong-set-e28888; expected NEBO_TYPE_MISMATCH
