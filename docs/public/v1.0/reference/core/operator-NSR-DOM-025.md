...
```text
Identity: NSR-DOM-025 (REGISTRY_ID)
Edition: 1
...
### operator:membership-e28889-4-2; expected 23
...
### operator:wrong-set-e28889; expected NEBO_TYPE_MISMATCH
