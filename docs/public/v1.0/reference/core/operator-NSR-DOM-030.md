...
Inclusive subset relation.

```text
Identity: NSR-DOM-030 (REGISTRY_ID)
Edition: 1
...
### operator:set-e28a86-4; expected 23
...
### operator:wrong-set-e28a86; expected NEBO_TYPE_MISMATCH
