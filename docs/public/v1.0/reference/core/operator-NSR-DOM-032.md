...
Inclusive superset relation.

```text
Identity: NSR-DOM-032 (REGISTRY_ID)
Edition: 1
...
### operator:set-e28a87-4; expected 23
...
### operator:wrong-set-e28a87; expected NEBO_TYPE_MISMATCH
