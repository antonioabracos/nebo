...
Tests geometric parallelism.

```text
Identity: NSR-DOM-048 (REGISTRY_ID)
Edition: 1
...
### boundedoperator:dom-048-named-0; expected 0

```nebo
start(){Vector<Int,3> [2,3,4].a;Vector<Int,3> [5,6,8].b;a.isParallelTo(b);}
```
