...
Divergence; maximal-munch compound token in calculus context.

```text
Identity: NSR-DOM-055 (REGISTRY_ID)
Edition: 1
...
associativity: right
canonical_ascii: divergence()
operand_rule: vector field
result_rule: scalar field
```

## Evaluation and types

operand once. Short-circuit: NO. Operand rule: vector field. Result rule: scalar field.
...
### boundedoperator:dom-055-e28887c2b7-0; expected 9

```nebo
start(){∇·(3,unitless,numeric,central,64,[2,3,4]).value();}
```

Oracle: {"independent_builds": 2, "process_exit": 9, "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}
