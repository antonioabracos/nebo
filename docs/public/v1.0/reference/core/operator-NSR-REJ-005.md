...
REJECTED: Rejected to keep mutation explicit and exactly-once. The operand/result description records the rejected or reserved proposal; it is not executable permission.

```text
Identity: NSR-REJ-005 (REGISTRY_ID)
Edition: 1
...
### lexical:protected-27; expected NEBO_LEX_REJECTED_FORM
