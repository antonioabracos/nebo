# cond ? a : b — C-style ternary

REJECTED: Rejected in favor of explicit flow-first conditional constructs. The operand/result description records the rejected or reserved proposal; it is not executable permission.

```text
Identity: NSR-REJ-007 (REGISTRY_ID)
Edition: 1
...
precedence: N/A
associativity: right
canonical_ascii: if/else or a typed conditional method
operand_rule: N/A
result_rule: N/A
```
...
N/A. Short-circuit: CONDITIONAL. Operand rule: N/A. Result rule: N/A.

## Errors and remediation

dedicated unsupported-ternary diagnostic. Current native grammar/context only; no implicit activation. Use the exact admitted spelling and operand domain; recognition alone never activates a reserved form.
...
### lexical:protected-29; expected NEBO_LEX_REJECTED_FORM

```nebo
start(){17.value;29.other;true ? 7 : 3;23.return;}
```
