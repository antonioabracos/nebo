...
REJECTED: Rejected legacy spelling. The operand/result description records the rejected or reserved proposal; it is not executable permission.

```text
Identity: NSR-REJ-012 (REGISTRY_ID)
Edition: 1
...
### lexical:protected-34; expected NEBO_LEX_REJECTED_FORM
