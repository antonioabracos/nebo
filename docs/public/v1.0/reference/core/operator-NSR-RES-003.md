# ... — ellipsis/spread/rest/varargs

RESERVED: Does not activate spread, rest, varargs or a range. The operand/result description records the rejected or reserved proposal; it is not executable permission.

```text
Identity: NSR-RES-003 (REGISTRY_ID)
Edition: 1
...
### lexical:protected-2; expected NEBO_LEX_RESERVED_SYMBOL
