...
RESERVED: Reserved for a possible mathematically styled mapping syntax. The operand/result description records the rejected or reserved proposal; it is not executable permission.

```text
Identity: NSR-RES-020 (REGISTRY_ID)
Edition: 1
...
```text
lexeme: ↦
context: future binder/comprehension syntax
fixity: infix/binder
arity: 2
...
### lexical:protected-18; expected NEBO_LEX_RESERVED_SYMBOL
