...
Exact alias for prefix logical \`!\`.

```text
Identity: NSR-UA-008 (REGISTRY_ID)
Edition: 1
...
identical lowering. Short-circuit: NO. Operand rule: Bool. Result rule: Bool.
...
### operator:unary-c2ac-1; expected 23
...
### operator:wrong-unary-c2ac; expected NEBO_TYPE_MISMATCH
