...
An affine temperature quantity shared by Celsius and Fahrenheit spellings.

```text
Identity: type:Temperature (INTRINSIC_TYPE)
Edition: 1
...
### operator:temperature-20-False; expected 23

```nebo
start(){(20°C).c;(68°F).f;flow.assert(c==f);23.return;}
```
...
[
  {
    "base": 0,
    "case_id": "types:type-19",
    "category": "native-type",
    "flags": 2,
    "kind": 19,
    "observed_sha256": "84b5fe1b83a4a7d9ed0d99d2391940e27c0b63fd2713f10d23a34cadd157028e",
    "type_id": 19
  }
]
```
