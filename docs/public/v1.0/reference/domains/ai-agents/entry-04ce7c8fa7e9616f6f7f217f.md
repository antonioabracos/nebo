# ai-agents — cache.length()

Offline tokenizer/generation/agent reference model; no service, network or foundation-model claim; original observation: occupied causal context reports four appended tokens; SDK bounds: {"MAX_CONTEXT":4096,"MAX_EVALUATION_CASES":256,"MAX_GENERATED_TOKENS":256,"MAX_MANIFEST_BYTES":65536,"MAX_PLAN_STEPS":32,"MAX_SCHEMA_FIELDS":64,"MAX_TEXT_BYTES":8192,"MAX_TOOLS":32,"MAX_TOOL_ARGUMENTS":16,"MAX_VOCABULARY":512}

```text
Identity: owner:G023:G023-S02-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "139:     second_cache = KvCache.new({\"maximumLength\": 8, \"modelChecksum\": model.checksum})\n140:     surface(\"G023-S02-03\", second_cache.length() == 0 and second_cache.maximum_length == 8, second_cache.maximum_length)\n141:     surface(\"G023-S02-04\", cache.length() == 4, cache.length())\n142:     generation_before = cache.generation\n143:     cache.truncate(2)",
