...
```text
CausalLanguageModel.contextLength(self) -> int
```
...
[
  ...
  {
    "excerpt": "144:     surface(\"G023-S02-05\", cache.length() == 2 and cache.generation == generation_before + 1, cache.tokens)\n145:     surface(\"G023-S02-06\", model.contextLength() == 64, model.contextLength())\n146: \n147:     altered = independent_logits(model, (4, 6, 5, 8))\n148:     claim(\"metamorphic\", altered != expected, \"causal tokens govern logits\")",
