# ai-agents — Sampler.temperature(value)

Offline tokenizer/generation/agent reference model; no service, network or foundation-model claim; original observation: finite temperature remains explicit and bounded; SDK bounds: {"MAX_CONTEXT":4096,"MAX_EVALUATION_CASES":256,"MAX_GENERATED_TOKENS":256,"MAX_MANIFEST_BYTES":65536,"MAX_PLAN_STEPS":32,"MAX_SCHEMA_FIELDS":64,"MAX_TEXT_BYTES":8192,"MAX_TOOLS":32,"MAX_TOOL_ARGUMENTS":16,"MAX_VOCABULARY":512}

```text
Identity: owner:G023:G023-S03-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Sampler.temperature(cls, value: float) -> 'Sampler'
```
...
[
  ...
  {
    "excerpt": "178:     surface(\"G023-S03-01\", greedy.mode == \"greedy\", greedy.mode)\n179:     temperature = Sampler.temperature(0.75)\n180:     surface(\"G023-S03-02\", temperature.mode == \"temperature\" and temperature.parameter == 0.75, temperature.parameter)\n181:     top_k = Sampler.topK(3)\n182:     surface(\"G023-S03-03\", top_k.mode == \"top-k\" and top_k.parameter == 3, top_k.parameter)",
