# ai-agents — Tokenizer.load(path)

Offline tokenizer/generation/agent reference model; no service, network or foundation-model claim; original observation: authenticated local manifest loads only inside the declared root; SDK bounds: {"MAX_CONTEXT":4096,"MAX_EVALUATION_CASES":256,"MAX_GENERATED_TOKENS":256,"MAX_MANIFEST_BYTES":65536,"MAX_PLAN_STEPS":32,"MAX_SCHEMA_FIELDS":64,"MAX_TEXT_BYTES":8192,"MAX_TOOLS":32,"MAX_TOOL_ARGUMENTS":16,"MAX_VOCABULARY":512}

```text
Identity: owner:G023:G023-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Tokenizer.load(cls, path: str, options: Mapping[str, Any] | None=None) -> 'Tokenizer'
```
...
[
  ...
  {
    "excerpt": "81: def load_tokenizer() -> Tokenizer:\n82:     return Tokenizer.load(str(TOKENIZER_PATH), {\"allowedRoot\": str(FIXTURES), \"expectedChecksum\": \"658fceb153e6f4e88f849defb354368d0056309e54c39d8e36858b8ae2378fa5\"})\n83: \n84: \n85: def load_model() -> CausalLanguageModel:",
