# ai-agents — generator.cancel()

Offline tokenizer/generation/agent reference model; no service, network or foundation-model claim; original observation: cancellation marks the session and releases its KV cache; SDK bounds: {"MAX_CONTEXT":4096,"MAX_EVALUATION_CASES":256,"MAX_GENERATED_TOKENS":256,"MAX_MANIFEST_BYTES":65536,"MAX_PLAN_STEPS":32,"MAX_SCHEMA_FIELDS":64,"MAX_TEXT_BYTES":8192,"MAX_TOOLS":32,"MAX_TOOL_ARGUMENTS":16,"MAX_VOCABULARY":512}

```text
Identity: owner:G023:G023-S03-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "190:     surface(\"G023-S03-07\", 1 <= len(generated.tokens) <= 3 and generated.operations > 0 and bool(generated.text) and generated.finishReason in {\"stop\", \"length\"}, generated)\n191:     generator.cancel()\n192:     surface(\"G023-S03-08\", generator._cancelled and generator._cache is not None and generator._cache.length() == 0, \"cache-released\")\n193: \n194:     repeat = Generator.new(model, tokenizer, penalized).generate(\"hello\", {\"maxTokens\": 3, \"seed\": 11, \"stopTokens\": ()})",
