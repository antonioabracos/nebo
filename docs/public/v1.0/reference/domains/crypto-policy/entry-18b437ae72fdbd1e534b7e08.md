...
```text
constantTime(function: Callable[..., Any]) -> Callable[..., Any]
Verify.constantTime(function: Callable[..., Any], target: str) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "46: \n47: @constantTime\n48: def xor_words(left: int, right: int) -> int:\n49:     return left ^ right\n50: ",
