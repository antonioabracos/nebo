...
```text
ProofCircuit.prove(self, witness: Any, random: Any) -> None
```
...
[
  ...
  {
    "excerpt": "105:        dict(compiled))\n106: rejected(lambda: circuit.prove({\"witness\": 9}, b\"random\"), \"EXTERNAL-REVIEW-REQUIRED\",\n107:          \"circuit.prove(witness,random)\")\n108: proof = Proof(circuit)\n109: rejected(lambda: proof.verify({\"total\": 9}, b\"verification-key\"),",
