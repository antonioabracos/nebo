...
```text
Proof.statistics(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "110:          \"EXTERNAL-REVIEW-REQUIRED\", \"proof.verify(publicInputs,verificationKey)\")\n111: statistics = proof.statistics()\n112: passed(\"proof.statistics()\", statistics[\"constraints\"] == 2 and not statistics[\"generated\"],\n113:        dict(statistics))\n114: ",
