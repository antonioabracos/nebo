...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Text publication reaches the retained fake-console document

```text
Identity: owner:G018:Text.console() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Text.console()
Owner: runtime/core/runtime_core.asm::nebo_runtime_console_publish_text
```
