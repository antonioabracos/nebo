# data — canvas.circle(center, radius, paint)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Bounded radius records deterministic circle coverage

```text
Identity: owner:G018:canvas.circle(center, radius, paint) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/canvas/canvas.asm::nebo_canvas_circle
```
