...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Document closes exactly once

```text
Identity: owner:G018:console.close() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
console.close()
Owner: runtime/console/document/linear_console_document.asm::nebo_console_close
```
