...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Preventable event records explicit default suppression

```text
Identity: owner:G018:event.preventDefault() (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/window/headless/headless_window.asm::nebo_headless_window_event_prevent_default
```
