# data — TextInput.new(value)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Text input owns validated UTF-8 content

```text
Identity: owner:G018:TextInput.new(value) (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
TextInput.new(value)
Owner: runtime/widgets/widgets.asm::nebo_ui_text_input
```
