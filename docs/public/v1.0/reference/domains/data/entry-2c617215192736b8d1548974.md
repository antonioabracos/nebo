# data — Layout.grid(spec, children)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Grid distributes remainders in stable source order

```text
Identity: owner:G018:Layout.grid(spec, children) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/widgets/widgets.asm::nebo_ui_grid
```
