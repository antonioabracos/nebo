# data — widget.accessibility()

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Semantic role name value and state snapshot are bounded

```text
Identity: owner:G018:widget.accessibility() (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/widgets/widgets.asm::nebo_ui_accessibility_snapshot
```
