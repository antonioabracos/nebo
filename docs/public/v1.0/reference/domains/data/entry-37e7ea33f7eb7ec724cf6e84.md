# data — chart.legend(options)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Legend placement and visibility remain deterministic

```text
Identity: owner:G018:chart.legend(options) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/charts/charts.asm::nebo_chart_legend
```
