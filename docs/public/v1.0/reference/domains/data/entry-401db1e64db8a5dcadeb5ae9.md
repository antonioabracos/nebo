# data — window.requestRedraw()

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: A redraw event is queued without blocking

```text
Identity: owner:G018:window.requestRedraw() (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/window/headless/headless_window.asm::nebo_headless_window_request_redraw
```
...
- runtime/window/headless/headless_window.asm — SHA-256 8b555ca3d743ba4f6b6618f2a42b3599a52a4c801ef97f5692066736abe296a0
