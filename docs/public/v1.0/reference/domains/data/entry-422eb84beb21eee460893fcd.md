# data — widget.on(event, handler)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Window event dispatch publishes one stable widget event

```text
Identity: owner:G018:widget.on(event, handler) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/widgets/widgets.asm::nebo_ui_dispatch_window_event
```
...
- runtime/widgets/widgets.asm — SHA-256 6b4c29b391c27637cd34a1c6053f3f04e9f20cf64896fc97224c5291b7b08dcf
