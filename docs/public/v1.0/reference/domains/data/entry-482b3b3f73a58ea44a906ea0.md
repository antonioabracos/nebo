# data — console.scrollToEnd()

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Viewport advances exactly to the final byte

```text
Identity: owner:G018:console.scrollToEnd() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
console.scrollToEnd()
Owner: runtime/console/document/linear_console_document.asm::nebo_console_scroll
```
