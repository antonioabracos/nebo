...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: RED resolves to the canonical premultiplied BGRA value

```text
Identity: owner:G018:RED.color() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
RED.color()
Owner: runtime/console/behavior/console_behavior.asm::nebo_console_palette_color
```
...
- runtime/console/behavior/console_behavior.asm — SHA-256 e4ea57f84ee0612ebb9602c2421a8452bf76c7ce97e2e2348423b75a05a365e9
