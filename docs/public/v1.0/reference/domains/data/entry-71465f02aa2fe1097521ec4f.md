# data — chart.axis(axis, options)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Validated finite bounds and label configure the selected axis

```text
Identity: owner:G018:chart.axis(axis, options) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/charts/charts.asm::nebo_chart_axis
```
