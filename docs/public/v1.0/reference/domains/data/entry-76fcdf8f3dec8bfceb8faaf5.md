...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Finite series lowers to deterministic line commands

```text
Identity: owner:G018:Chart.line(series) (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Chart.line(series)
Owner: runtime/charts/charts.asm::nebo_chart_line
```
