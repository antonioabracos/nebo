# data — Chart.scatter(points)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Finite points lower to deterministic marks

```text
Identity: owner:G018:Chart.scatter(points) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/charts/charts.asm::nebo_chart_scatter
```
