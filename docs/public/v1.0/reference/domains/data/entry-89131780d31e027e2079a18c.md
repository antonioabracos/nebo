# data — canvas.line(from, to, paint)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Integer line coverage includes both endpoints

```text
Identity: owner:G018:canvas.line(from, to, paint) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/canvas/canvas.asm::nebo_canvas_line
```
