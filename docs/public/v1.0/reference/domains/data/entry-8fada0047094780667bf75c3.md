...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Children receive exact vertical integer extents

```text
Identity: owner:G018:Layout.column(children) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/widgets/widgets.asm::nebo_ui_column
```
