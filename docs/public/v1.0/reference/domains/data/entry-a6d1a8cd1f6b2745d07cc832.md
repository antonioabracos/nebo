...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Label owns bounded semantic text

```text
Identity: owner:G018:Label.new(text) (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Label.new(text)
Owner: runtime/widgets/widgets.asm::nebo_ui_label
```
