...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: UTF-8 title bytes copy into caller-owned storage

```text
Identity: owner:G018:window.setTitle(text) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/window/headless/headless_window.asm::nebo_headless_window_set_title
```
