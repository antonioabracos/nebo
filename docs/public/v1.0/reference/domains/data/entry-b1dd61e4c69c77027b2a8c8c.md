...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Integer publication shares the authenticated default console

```text
Identity: owner:G018:Int.console() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Int.console()
Owner: runtime/core/runtime_core.asm::nebo_runtime_console_publish_int
```
