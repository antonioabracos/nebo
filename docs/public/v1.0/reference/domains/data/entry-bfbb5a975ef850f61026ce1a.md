...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Text nodes and viewport return to the empty state

```text
Identity: owner:G018:console.clear() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
console.clear()
Owner: runtime/console/document/linear_console_document.asm::nebo_console_clear
```
