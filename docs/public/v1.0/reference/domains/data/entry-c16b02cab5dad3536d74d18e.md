...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Visible state clears without losing ownership

```text
Identity: owner:G018:window.hide() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
window.hide()
Owner: runtime/window/headless/headless_window.asm::nebo_headless_window_hide
```
