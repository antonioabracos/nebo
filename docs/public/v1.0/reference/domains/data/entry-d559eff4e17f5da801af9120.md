...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Bounded text is normalized and validated before publication

```text
Identity: owner:G018:Text.scan() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Text.scan()
Owner: runtime/textual/scan_plan.asm::neboc_scan_validate_text
```
...
- runtime/textual/scan_plan.asm — SHA-256 5f2c2917f47f3996fe0dfeaa1e7f62e2279ff3d211f38e465b78c258375a7ca8
