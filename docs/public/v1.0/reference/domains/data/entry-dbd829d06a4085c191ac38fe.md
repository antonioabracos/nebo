...
Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Boolean publication shares the authenticated default console

```text
Identity: owner:G018:Bool.console() (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Bool.console()
Owner: runtime/core/runtime_core.asm::nebo_runtime_console_publish_bool
```
