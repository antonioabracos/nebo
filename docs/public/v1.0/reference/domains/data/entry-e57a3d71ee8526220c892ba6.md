# data — console.append(value, style)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Value bytes append within the bounded document

```text
Identity: owner:G018:console.append(value, style) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/console/document/linear_console_document.asm::nebo_console_append
```
