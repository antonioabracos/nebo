# data — canvas.image(image, destination)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Validated RGBA image copies into the destination rectangle

```text
Identity: owner:G018:canvas.image(image, destination) (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
canvas.image(image, destination)
Owner: runtime/canvas/canvas_image.asm::nebo_canvas_image
```
...
- runtime/canvas/canvas_image.asm — SHA-256 3840de8aa9c0bc616ad33b2bb619de05e9d2d71468f0832626908bb695a75c3e
