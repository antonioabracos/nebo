# data — visual.summarize(value)

Legacy data owner record; current typed Table declarations retain their independent public tier; original observation: Authenticated single-use summary publishes result 181

```text
Identity: owner:G018:visual.summarize(value) (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/stdlib/visual_summary_runtime.asm::neboc_visual_summary_runtime_execute
```
...
- runtime/stdlib/visual_summary_runtime.asm — SHA-256 61fbbb4b3e53d74c8cdca12fcba55d7ca8bc8612bee1af5285bdcb277e6f3098
