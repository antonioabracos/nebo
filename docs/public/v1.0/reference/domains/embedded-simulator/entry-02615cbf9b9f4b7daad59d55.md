# embedded-simulator — register.write(value)

Simulator only; no physical board, interrupt latency or real-time certification; original observation: value 0x12 commits and emits volatile write effect; SDK bounds: {"MAX_IMAGE_BYTES":262144,"MAX_TASKS":32,"MAX_TRACE_EVENTS":4096,"MAX_TRANSFER_BYTES":4096}

```text
Identity: owner:G038:G038-S02-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Register.write(self, value: int) -> None
PinHandle.write(self, value: bool) -> None
```
...
[
  ...
  {
    "excerpt": "69: mmio_cap = Capability.new(simulator, \"mmio\", 3_145_728, 4096,\n70:                           (\"read\", \"write\", \"modify\", \"fence\"))\n71: region = MemoryMapped.region(3_145_728, 4096, mmio_cap)\n72: ok(\"positive\", \"MemoryMapped.region\", region.base == 3_145_728 and region.length == 4096)\n73: register = Register.at(3_145_728, mmio_cap)",
