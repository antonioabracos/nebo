# embedded-simulator — interrupt.disable()

Simulator only; no physical board, interrupt latency or real-time certification; original observation: vector stops accepting injection; SDK bounds: {"MAX_IMAGE_BYTES":262144,"MAX_TASKS":32,"MAX_TRACE_EVENTS":4096,"MAX_TRANSFER_BYTES":4096}

```text
Identity: owner:G038:G038-S03-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
InterruptBinding.disable(self) -> 'InterruptBinding'
```
...
- runtime/embedded/interrupt_model.asm — SHA-256 582c494dd80359be566b35b3411c4a081c993d0786f01bb9958da7fbdc09e7ec
