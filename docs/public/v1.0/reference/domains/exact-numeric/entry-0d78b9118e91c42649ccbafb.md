# exact-numeric — Interval.open(min, max)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Interval.open(min, max)

```text
Identity: owner:G035:G035-S05-02 (DOMAIN_CONTRACT_ID)
Edition: 1
