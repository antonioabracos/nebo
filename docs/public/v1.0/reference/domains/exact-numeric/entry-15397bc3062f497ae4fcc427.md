# exact-numeric — Quantity.of(value, unit)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Quantity.of(value, unit)

```text
Identity: owner:G035:G035-S04-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: G035 source vertical + quantity descriptor
```
