# exact-numeric — decimal.divide(other, context)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: decimal.divide(other, context)

```text
Identity: owner:G035:G035-S02-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
decimal.divide(other, context)
Owner: G035 source vertical + decimal rounding core
```
