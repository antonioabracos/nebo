# exact-numeric — quantity.inBaseUnits()

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: quantity.inBaseUnits()

```text
Identity: owner:G035:G035-S04-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: G035 source vertical + unit affine guard
```
