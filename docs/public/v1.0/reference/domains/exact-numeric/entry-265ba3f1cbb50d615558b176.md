# exact-numeric — Symbol.variable(name, domain)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Symbol.variable(name, domain)

```text
Identity: owner:G035:G035-S06-01 (DOMAIN_CONTRACT_ID)
Edition: 1
