# exact-numeric — big.gcd(other)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: big.gcd(other)

```text
Identity: owner:G035:G035-S01-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
big.gcd(other)
Owner: G035 source vertical + nebo_bigint_gcd_u64
```
