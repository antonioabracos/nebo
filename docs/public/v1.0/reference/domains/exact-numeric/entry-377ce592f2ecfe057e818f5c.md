# exact-numeric — interval.intersect(other)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: interval.intersect(other)

```text
Identity: owner:G035:G035-S05-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: G035 source vertical + nebo_interval_intersect_f64
```
