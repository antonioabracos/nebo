# exact-numeric — complex.conjugate()

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: complex.conjugate()

```text
Identity: owner:G035:G035-S03-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
complex.conjugate()
Owner: G035 source vertical + nebo_complex_conjugate_f64
```
