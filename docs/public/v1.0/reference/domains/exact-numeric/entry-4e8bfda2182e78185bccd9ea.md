# exact-numeric — decimal.scale()

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: decimal.scale()

```text
Identity: owner:G035:G035-S02-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
decimal.scale()
Owner: G035 source vertical + decimal descriptor
```
