# exact-numeric — interval.hull(other)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: interval.hull(other)

```text
Identity: owner:G035:G035-S05-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
interval.hull(other)
Owner: G035 source vertical + bounded hull witness
```
