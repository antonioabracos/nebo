# exact-numeric — Rational.of(numerator, denominator)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Rational.of(numerator, denominator)

```text
Identity: owner:G035:G035-S02-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: G035 source vertical + nebo_rational_normalize_i64
```
