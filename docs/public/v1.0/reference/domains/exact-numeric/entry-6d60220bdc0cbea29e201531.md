# exact-numeric — quantity.divide(other)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: quantity.divide(other)

```text
Identity: owner:G035:G035-S04-08 (DOMAIN_CONTRACT_ID)
Edition: 1
