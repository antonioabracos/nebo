# exact-numeric — rational.toDecimal(context)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: rational.toDecimal(context)

```text
Identity: owner:G035:G035-S02-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
rational.toDecimal(context)
Owner: G035 source vertical + decimal conversion witness
```
