# exact-numeric — complex.argument()

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: complex.argument()

```text
Identity: owner:G035:G035-S03-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
complex.argument()
Owner: G035 source vertical + nebo_math_atan2_f64
```
