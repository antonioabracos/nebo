# exact-numeric — complex.imaginary()

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: complex.imaginary()

```text
Identity: owner:G035:G035-S03-03 (DOMAIN_CONTRACT_ID)
Edition: 1
