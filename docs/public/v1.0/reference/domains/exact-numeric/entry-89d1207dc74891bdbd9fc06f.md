# exact-numeric — quaternion.normalize()

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: quaternion.normalize()

```text
Identity: owner:G035:G035-S03-09 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: G035 source vertical + nebo_quaternion_normalize_f64
```
