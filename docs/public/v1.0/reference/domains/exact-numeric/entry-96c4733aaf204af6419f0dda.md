# exact-numeric — interval.multiply(other)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: interval.multiply(other)

```text
Identity: owner:G035:G035-S05-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
interval.multiply(other)
Owner: G035 source vertical + nebo_interval_mul_nonnegative_f64
```
