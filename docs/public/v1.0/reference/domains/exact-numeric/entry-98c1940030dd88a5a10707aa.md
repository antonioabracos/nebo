# exact-numeric — Complex.of(real, imaginary)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Complex.of(real, imaginary)

```text
Identity: owner:G035:G035-S03-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Complex.of(real, imaginary)
Owner: G035 source vertical + complex descriptor
```
