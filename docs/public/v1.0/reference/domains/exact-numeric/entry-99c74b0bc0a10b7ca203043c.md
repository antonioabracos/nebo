# exact-numeric — complex.exp()

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: complex.exp()

```text
Identity: owner:G035:G035-S03-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
complex.exp()
Owner: G035 source vertical + transcendental core
```
