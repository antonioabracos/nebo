# exact-numeric — interval.contains(value)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: interval.contains(value)

```text
Identity: owner:G035:G035-S05-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: G035 source vertical + nebo_interval_contains_f64
```
