# exact-numeric — Dimension.define(name, exponents)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Dimension.define(name, exponents)

```text
Identity: owner:G035:G035-S04-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Dimension.define(name, exponents)
Owner: G035 source vertical + dimension descriptor
```
