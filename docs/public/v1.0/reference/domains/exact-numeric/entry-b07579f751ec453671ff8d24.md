# exact-numeric — complex.real()

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: complex.real()

```text
Identity: owner:G035:G035-S03-02 (DOMAIN_CONTRACT_ID)
Edition: 1
