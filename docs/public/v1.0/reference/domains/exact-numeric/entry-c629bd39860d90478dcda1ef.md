# exact-numeric — Expression.of(operation, operands)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Expression.of(operation, operands)

```text
Identity: owner:G035:G035-S06-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Expression.of(operation, operands)
Owner: G035 source vertical + symbolic DAG
```
