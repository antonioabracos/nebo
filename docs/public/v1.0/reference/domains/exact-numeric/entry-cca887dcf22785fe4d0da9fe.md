# exact-numeric — Quaternion.of(w, x, y, z)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Quaternion.of(w, x, y, z)

```text
Identity: owner:G035:G035-S03-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Quaternion.of(w, x, y, z)
Owner: G035 source vertical + quaternion descriptor
```
