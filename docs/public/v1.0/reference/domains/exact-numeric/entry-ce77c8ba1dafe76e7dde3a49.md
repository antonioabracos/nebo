# exact-numeric — quantity.convert(targetUnit)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: quantity.convert(targetUnit)

```text
Identity: owner:G035:G035-S04-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: G035 source vertical + nebo_quantity_convert_i64
```
