# exact-numeric — Symbol.constant(value)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: Symbol.constant(value)

```text
Identity: owner:G035:G035-S06-02 (DOMAIN_CONTRACT_ID)
Edition: 1
