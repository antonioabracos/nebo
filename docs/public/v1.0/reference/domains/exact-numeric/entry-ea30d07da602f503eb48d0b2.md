# exact-numeric — big.multiply(other)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: big.multiply(other)

```text
Identity: owner:G035:G035-S01-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
big.multiply(other)
Owner: G035 source vertical + nebo_bigint_mul_u32
```
