# exact-numeric — BigInt.fromInt(value)

Native bounded exact-number owners; legacy whole-file source probe is not public typed lowering; original observation: BigInt.fromInt(value)

```text
Identity: owner:G035:G035-S01-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: G035 source vertical + nebo_bigint_from_i64
```
