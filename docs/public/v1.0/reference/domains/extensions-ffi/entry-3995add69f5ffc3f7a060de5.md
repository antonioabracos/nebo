# extensions-ffi — cluster.members()

Capability and ABI reference policy; no arbitrary dlopen, external plugin execution or sandbox certification; original observation: membership snapshot is immutable sorted and state-bearing; SDK bounds: {"MAX_CALLS":4096,"MAX_DURATION":1000000,"MAX_EXPORTS":64,"MAX_MANIFEST_BYTES":65536,"MAX_NODES":16,"MAX_PARTITIONS":1024,"MAX_REPLICAS":3,"MAX_RETRIES":8,"MAX_RETRY_DELAY":1024,"MAX_TASKS":64,"MAX_TRUST_ENTRIES":32}

```text
Identity: owner:G026:G026-S04-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Cluster.members(self) -> tuple[ClusterMember, ...]
```
...
[
  ...
  {
    "excerpt": "299:     surface(\"G026-S04-03\", cluster.health()[\"total\"] == 2, cluster.health())\n300:     members = cluster.members()\n301:     surface(\"G026-S04-04\", tuple(member.identity for member in members) == (\"node-a\", \"node-b\"), members)\n302:     health = cluster.health()\n303:     surface(\"G026-S04-05\", health[\"state\"] == \"healthy\" and health[\"ready\"] == 2, health)",
