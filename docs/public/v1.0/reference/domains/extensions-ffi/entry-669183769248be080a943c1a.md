# extensions-ffi — ffi.lastError()

Capability and ABI reference policy; no arbitrary dlopen, external plugin execution or sandbox certification; original observation: context-local structured error identifies failed symbol boundary; SDK bounds: {"MAX_CALLS":4096,"MAX_DURATION":1000000,"MAX_EXPORTS":64,"MAX_MANIFEST_BYTES":65536,"MAX_NODES":16,"MAX_PARTITIONS":1024,"MAX_REPLICAS":3,"MAX_RETRIES":8,"MAX_RETRY_DELAY":1024,"MAX_TASKS":64,"MAX_TRUST_ENTRIES":32}

```text
Identity: owner:G026:G026-S03-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
_FfiContext.lastError(self) -> Mapping[str, Any] | None
```
...
[
  ...
  {
    "excerpt": "264:     negative(\"TYPE_MISMATCH\", \"foreign.call\", lambda: symbol.call((True, 2)))\n265:     last_error = ffi.lastError()\n266:     surface(\"G026-S03-07\", last_error is not None and last_error[\"code\"] == \"TYPE_MISMATCH\" and last_error[\"symbol\"] == \"add_i64\", last_error)\n267: \n268:     reordered = ForeignType.layout(({\"name\": \"value\", \"type\": \"i64\"}, {\"name\": \"tag\", \"type\": \"u8\"}))",
