# extensions-ffi — sandbox.capabilities(set)

Capability and ABI reference policy; no arbitrary dlopen, external plugin execution or sandbox certification; original observation: only known explicitly delegated capabilities enter the sandbox; SDK bounds: {"MAX_CALLS":4096,"MAX_DURATION":1000000,"MAX_EXPORTS":64,"MAX_MANIFEST_BYTES":65536,"MAX_NODES":16,"MAX_PARTITIONS":1024,"MAX_REPLICAS":3,"MAX_RETRIES":8,"MAX_RETRY_DELAY":1024,"MAX_TASKS":64,"MAX_TRUST_ENTRIES":32}

```text
Identity: owner:G026:G026-S02-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Sandbox.capabilities(self, set: Sequence[str]) -> 'Sandbox'
```
...
[
  ...
  {
    "excerpt": "91:         \"target\": \"x86_64-linux-static\",\n92:         \"capabilities\": [\"buffer\", \"compute\"],\n93:         \"exports\": {\n94:             \"byteTotal\": {\"args\": [\"Bytes\"], \"returns\": \"Int\", \"capability\": \"buffer\"},\n95:             \"sum\": {\"args\": [\"Int\", \"Int\"], \"returns\": \"Int\", \"capability\": \"compute\"},",
