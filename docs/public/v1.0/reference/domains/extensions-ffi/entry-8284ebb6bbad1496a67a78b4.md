# extensions-ffi — plugin.abiVersion()

Capability and ABI reference policy; no arbitrary dlopen, external plugin execution or sandbox certification; original observation: loaded plugin exposes the checked positive ABI version; SDK bounds: {"MAX_CALLS":4096,"MAX_DURATION":1000000,"MAX_EXPORTS":64,"MAX_MANIFEST_BYTES":65536,"MAX_NODES":16,"MAX_PARTITIONS":1024,"MAX_REPLICAS":3,"MAX_RETRIES":8,"MAX_RETRY_DELAY":1024,"MAX_TASKS":64,"MAX_TRUST_ENTRIES":32}

```text
Identity: owner:G026:G026-S01-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "89:         \"identity\": identity,\n90:         \"abiVersion\": 1,\n91:         \"target\": \"x86_64-linux-static\",\n92:         \"capabilities\": [\"buffer\", \"compute\"],\n93:         \"exports\": {",
