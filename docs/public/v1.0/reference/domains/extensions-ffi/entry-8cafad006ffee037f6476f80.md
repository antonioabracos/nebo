# extensions-ffi — ForeignLibrary.open(path)

Capability and ABI reference policy; no arbitrary dlopen, external plugin execution or sandbox certification; original observation: only the certified local Assembly fixture URI opens; SDK bounds: {"MAX_CALLS":4096,"MAX_DURATION":1000000,"MAX_EXPORTS":64,"MAX_MANIFEST_BYTES":65536,"MAX_NODES":16,"MAX_PARTITIONS":1024,"MAX_REPLICAS":3,"MAX_RETRIES":8,"MAX_RETRY_DELAY":1024,"MAX_TASKS":64,"MAX_TRUST_ENTRIES":32}

```text
Identity: owner:G026:G026-S03-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ForeignLibrary.open(cls, path: str) -> 'ForeignLibrary'
```
...
[
  ...
  {
    "excerpt": "248: def subgroup_s03() -> None:\n249:     library = ForeignLibrary.open(\"nebo://ffi/scalar-v1\")\n250:     surface(\"G026-S03-01\", library.path == \"nebo://ffi/scalar-v1\", library.path)\n251:     signature = {\"args\": (\"Int\", \"Int\"), \"returns\": \"Int\", \"capability\": \"compute\"}\n252:     symbol = library.symbol(\"add_i64\", signature)",
