# gpu-reference — module.verify()

CPU reference only; zero authenticated GPU devices; no accelerator backend; original observation: module.verify(); SDK bounds: {"MAX_BUFFER_BYTES":262144,"MAX_CONTEXT_BYTES":1048576,"MAX_LAUNCH_DIMENSION":65535,"MAX_LAUNCH_WORK_ITEMS":1048576,"MAX_PENDING_COMMANDS":256,"MAX_PINNED_BYTES":262144,"MAX_STREAMS":32,"MAX_TRACE_EVENTS":512}

```text
Identity: owner:G022:G022-S03-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "106:                                            ensure_ascii=True).encode(\"ascii\")).hexdigest())\n107: ok(\"positive\", \"module.verify\", module.verify())\n108: \n109: # S04: ordered streams, dependency events, synchronization, and logical timing.\n110: ok(\"positive\", \"GpuStream.create\", stream._context is context)",
