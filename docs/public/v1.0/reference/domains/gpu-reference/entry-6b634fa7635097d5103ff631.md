# gpu-reference — profiler.stop()

CPU reference only; zero authenticated GPU devices; no accelerator backend; original observation: profiler.stop(); SDK bounds: {"MAX_BUFFER_BYTES":262144,"MAX_CONTEXT_BYTES":1048576,"MAX_LAUNCH_DIMENSION":65535,"MAX_LAUNCH_WORK_ITEMS":1048576,"MAX_PENDING_COMMANDS":256,"MAX_PINNED_BYTES":262144,"MAX_STREAMS":32,"MAX_TRACE_EVENTS":512}

```text
Identity: owner:G022:G022-S06-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "154: profile_stream.recordEvent().wait()\n155: event_count = profiler.stop()\n156: ok(\"positive\", \"profiler.stop\", event_count >= 2 and not profiler._running)\n157: ok(\"positive\", \"context.memoryUsed\", context.memoryUsed() == 48)\n158: ok(\"positive\", \"context.setMemoryBudget\", context.setMemoryBudget(96) == 96)",
