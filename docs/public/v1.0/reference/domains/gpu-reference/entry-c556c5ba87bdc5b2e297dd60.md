# gpu-reference — event.elapsed(other)

CPU reference only; zero authenticated GPU devices; no accelerator backend; original observation: event.elapsed(other); SDK bounds: {"MAX_BUFFER_BYTES":262144,"MAX_CONTEXT_BYTES":1048576,"MAX_LAUNCH_DIMENSION":65535,"MAX_LAUNCH_WORK_ITEMS":1048576,"MAX_PENDING_COMMANDS":256,"MAX_PINNED_BYTES":262144,"MAX_STREAMS":32,"MAX_TRACE_EVENTS":512}

```text
Identity: owner:G022:G022-S04-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
GpuEvent.elapsed(self, other: 'GpuEvent') -> int
```
...
[
  ...
  {
    "excerpt": "118: later.wait()\n119: ok(\"positive\", \"event.elapsed\", finished.elapsed(later) > 0)\n120: \n121: # S05: placement and planner decisions remain explicit and never claim\n122: # acceleration for the CPU correctness backend.",
