# gpu-reference — Gpu.enumerate()

CPU reference only; zero authenticated GPU devices; no accelerator backend; original observation: Gpu.enumerate(); SDK bounds: {"MAX_BUFFER_BYTES":262144,"MAX_CONTEXT_BYTES":1048576,"MAX_LAUNCH_DIMENSION":65535,"MAX_LAUNCH_WORK_ITEMS":1048576,"MAX_PENDING_COMMANDS":256,"MAX_PINNED_BYTES":262144,"MAX_STREAMS":32,"MAX_TRACE_EVENTS":512}

```text
Identity: owner:G022:G022-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "56: # the executable differential context.\n57: ok(\"positive\", \"Gpu.enumerate\", Gpu.enumerate() == ())\n58: properties = device.properties()\n59: ok(\"positive\", \"device.properties\", properties[\"backend\"] == \"cpu-reference\" and\n60:    properties[\"accelerated\"] is False and properties[\"driverContract\"] == \"none\")",
