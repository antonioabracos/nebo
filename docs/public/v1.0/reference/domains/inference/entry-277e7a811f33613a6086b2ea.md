...
Bounded CPU model, synthetic local weights only; no downloaded model or GPU claim; original observation: model.parameters(); SDK bounds: {"MAX_BATCH":16,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_LAYERS":64,"MAX_MODEL_BYTES":1048576,"MAX_WARMUP":16,"MAX_WORKSPACE_BYTES":1048576}

```text
Identity: owner:G020:G020-S01-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Model.parameters(self) -> Iterator[tuple[str, Tensor]]
```
...
[
  ...
  {
    "excerpt": "73: ok(\"positive\", \"Model.new\", isinstance(model, Model) and len(model.graph) == 2)\n74: ok(\"positive\", \"model.parameters\", [name for name, _ in model.parameters()] ==\n75:    [\"0.bias\", \"0.weight\", \"1.bias\", \"1.weight\"])\n76: ok(\"positive\", \"model.buffers\", [name for name, _ in model.buffers()] ==\n77:    [\"1.running_mean\", \"1.running_variance\"])",
