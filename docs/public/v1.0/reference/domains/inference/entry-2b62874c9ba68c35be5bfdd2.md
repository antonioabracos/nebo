# inference — linear.forward(input)

Bounded CPU model, synthetic local weights only; no downloaded model or GPU claim; original observation: linear.forward(input); SDK bounds: {"MAX_BATCH":16,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_LAYERS":64,"MAX_MODEL_BYTES":1048576,"MAX_WARMUP":16,"MAX_WORKSPACE_BYTES":1048576}

```text
Identity: owner:G020:G020-S02-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Linear.forward(self, input: Tensor) -> Tensor
Softmax.forward(input: Tensor, axis: int=-1) -> Tensor
Sequential.forward(self, input: Tensor) -> Tensor
LayerNorm.forward(self, input: Tensor) -> Tensor
BatchNorm.forward(self, input: Tensor) -> Tensor
Dropout.forward(self, input: Tensor) -> Tensor
Residual.forward(self, input: Tensor) -> Tensor
Flatten.forward(self, input: Tensor) -> Tensor
```
...
[
  ...
  {
    "excerpt": "55: class DifferentShape:\n56:     def forward(self, input: Tensor) -> Tensor:\n57:         return Tensor([1.0], (1,))\n58: \n59: ",
...
- runtime/ml/dense.asm — SHA-256 663313e87eec7c3b8f4f5c6279d787918448d1710908402212162f7d00494732
