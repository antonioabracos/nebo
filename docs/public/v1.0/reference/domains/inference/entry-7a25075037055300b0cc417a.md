# inference — model.validate()

Bounded CPU model, synthetic local weights only; no downloaded model or GPU claim; original observation: model.validate(); SDK bounds: {"MAX_BATCH":16,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_LAYERS":64,"MAX_MODEL_BYTES":1048576,"MAX_WARMUP":16,"MAX_WORKSPACE_BYTES":1048576}

```text
Identity: owner:G020:G020-S01-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Model.validate(self) -> dict[str, Any]
```
...
[
  ...
  {
    "excerpt": "83: ok(\"positive\", \"model.parameterCount\", count == {\"elements\": 12, \"bytes\": 96})\n84: ok(\"positive\", \"model.validate\", model.validate() ==\n85:    {\"valid\": True, \"layers\": 2, \"parameters\": 6})\n86: \n87: # S02: hand-computed affine values and standard activation definitions.",
...
- compiler/semantic/ml/model_contract.asm — SHA-256 8941e1703370db4f263034f9101f1142907bed14add4dbf89dbadb45a65328d5
