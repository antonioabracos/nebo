...
Bounded CPU model, synthetic local weights only; no downloaded model or GPU claim; original observation: model.summary(); SDK bounds: {"MAX_BATCH":16,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_LAYERS":64,"MAX_MODEL_BYTES":1048576,"MAX_WARMUP":16,"MAX_WORKSPACE_BYTES":1048576}

```text
Identity: owner:G020:G020-S01-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "77:    [\"1.running_mean\", \"1.running_variance\"])\n78: ok(\"positive\", \"model.eval\", model.summary().mode == \"eval\")\n79: summary = model.summary()\n80: ok(\"positive\", \"model.summary\", summary.layers == (\"Linear\", \"BatchNorm\") and\n81:    summary.parameters == 12 and summary.buffers == 4)",
