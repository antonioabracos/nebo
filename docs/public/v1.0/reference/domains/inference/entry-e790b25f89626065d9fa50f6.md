# inference — Activation.gelu(input, approximation)

Bounded CPU model, synthetic local weights only; no downloaded model or GPU claim; original observation: Activation.gelu(input, approximation); SDK bounds: {"MAX_BATCH":16,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_LAYERS":64,"MAX_MODEL_BYTES":1048576,"MAX_WARMUP":16,"MAX_WORKSPACE_BYTES":1048576}

```text
Identity: owner:G020:G020-S02-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Activation.gelu(input: Tensor, approximation: str='tanh') -> Tensor
```
...
[
  ...
  {
    "excerpt": "93:    Activation.relu(Tensor([-2, 0, 3], (3,))).values == (0.0, 0.0, 3.0))\n94: ok(\"positive\", \"Activation.gelu\",\n95:    close_values(Activation.gelu(Tensor([0, 1], (2,)), \"exact\"),\n96:                 [0.0, 0.8413447460685429], 1e-12))\n97: sigmoid = Activation.sigmoid(Tensor([-1000, 0, 1000], (3,)))",
