# inference — Flatten.new(startAxis, endAxis)

Bounded CPU model, synthetic local weights only; no downloaded model or GPU claim; original observation: Flatten.new(startAxis, endAxis); SDK bounds: {"MAX_BATCH":16,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_LAYERS":64,"MAX_MODEL_BYTES":1048576,"MAX_WARMUP":16,"MAX_WORKSPACE_BYTES":1048576}

```text
Identity: owner:G020:G020-S03-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Flatten.new(startAxis: int, endAxis: int) -> 'Flatten'
```
...
- runtime/ml/layers.asm — SHA-256 c3023fb0c2bcdd8e95d8a91c549f4fc39acb7f121fa70a653bfb8d2f11dd30d3
