...
```text
Ontology.subtype(self, child: str, parent: str) -> 'Ontology'
```
...
[
  ...
  {
    "excerpt": "81:         ontology.defineType(name)\n82:     ontology.subtype(\"City\", \"Place\")\n83:     ontology.property(\"livesIn\", \"Person\", \"Place\")\n84:     ontology.property(\"hosts\", \"Place\", \"Person\")\n85:     ontology.inverse(\"livesIn\", \"hosts\")",
