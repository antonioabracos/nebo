# knowledge — result.provenance()

Bounded local graph and retrieval; no external knowledge source or semantic truth guarantee; original observation: result binds source representation and index versions as ranking not proof; SDK bounds: {"MAX_CONTEXT_BYTES":16384,"MAX_DERIVED":4096,"MAX_ENTITIES":512,"MAX_FACTS":4096,"MAX_INDEX_ITEMS":2048,"MAX_PATH_DEPTH":16,"MAX_PROPERTIES":256,"MAX_QUERY_RESULTS":1024,"MAX_ROUNDS":64,"MAX_RULES":256,"MAX_TYPES":128,"MAX_VECTOR_DIMENSION":64}

```text
Identity: owner:G034:G034-S05-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
SearchResult.provenance(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "73: \n74: def provenance(source: str, version: int = 1) -> dict[str, Any]:\n75:     return {\"source\": source, \"version\": version, \"digest\": hashlib.sha256(source.encode(\"utf-8\")).hexdigest()}\n76: \n77: ",
