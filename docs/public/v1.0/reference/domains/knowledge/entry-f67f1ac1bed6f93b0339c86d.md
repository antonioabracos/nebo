# knowledge — ontology.compatibility(previous)

Bounded local graph and retrieval; no external knowledge source or semantic truth guarantee; original observation: version comparison exposes deterministic breaking changes; SDK bounds: {"MAX_CONTEXT_BYTES":16384,"MAX_DERIVED":4096,"MAX_ENTITIES":512,"MAX_FACTS":4096,"MAX_INDEX_ITEMS":2048,"MAX_PATH_DEPTH":16,"MAX_PROPERTIES":256,"MAX_QUERY_RESULTS":1024,"MAX_ROUNDS":64,"MAX_RULES":256,"MAX_TYPES":128,"MAX_VECTOR_DIMENSION":64}

```text
Identity: owner:G034:G034-S02-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Ontology.compatibility(self, previous: 'Ontology') -> CompatibilityResult
```
...
[
  ...
  {
    "excerpt": "189:     previous.subtype(\"City\", \"Place\").property(\"livesIn\", \"Person\", \"Place\").property(\"hosts\", \"Place\", \"Person\").property(\"email\", \"Person\", \"Text\").inverse(\"livesIn\", \"hosts\")\n190:     compatibility = ontology.compatibility(previous)\n191:     surface(\"G034-S02-08\", compatibility.compatible and compatibility.fromVersion == 1 and compatibility.toVersion == 2, compatibility)\n192: \n193:     extended = Ontology.new(\"transport\", 3).defineType(\"Place\").defineType(\"City\").defineType(\"Person\").defineType(\"Country\")",
