...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: VideoFrame.new validates image lifetime timestamp and duration

```text
Identity: owner:G019:G019-S06-F001 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S06-F001
Owner: runtime/video/video_pipeline.asm::nebo_video_frame_init
```
...
- runtime/video/video_pipeline.asm — SHA-256 c8d5a977390a255216ef005e4085e9144048e7288632efd934bda368f8ece613
