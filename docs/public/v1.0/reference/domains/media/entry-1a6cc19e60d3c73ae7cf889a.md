...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: image.composite applies deterministic straight-alpha source-over

```text
Identity: owner:G019:G019-S03-F007 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S03-F007
Owner: runtime/image/image_transform.asm::nebo_image_composite_over
```
