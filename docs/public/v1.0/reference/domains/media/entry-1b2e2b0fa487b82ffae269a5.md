...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: codec.inspect dispatches only authenticated BMP or PNG signatures

```text
Identity: owner:G019:G019-S04-F007 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S04-F007
Owner: runtime/media/media_contract.asm::nebo_codec_inspect
```
