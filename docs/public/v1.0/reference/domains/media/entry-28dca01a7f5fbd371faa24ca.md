...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: color.toLinear returns bounded Q16 linear intensity

```text
Identity: owner:G019:G019-S01-F003 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S01-F003
Owner: runtime/media/color.asm::nebo_color_to_linear_u8
```
