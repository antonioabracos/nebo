...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: Image.fromBuffer validates explicit stride and borrowed capacity

```text
Identity: owner:G019:G019-S02-F002 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S02-F002
Owner: runtime/image/image.asm::nebo_image_wrap_mut
```
...
- runtime/image/image.asm — SHA-256 a10d695143fe95c99cd629d08dc434701d22c41b5793342c98816006657957dc
