...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: audio.mix applies Q15 gain with saturating S16LE arithmetic

```text
Identity: owner:G019:G019-S05-F006 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S05-F006
Owner: runtime/audio/pcm.asm::nebo_pcm_mix_into
```
