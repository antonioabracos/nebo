...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: Color.rgba preserves four validated channels

```text
Identity: owner:G019:G019-S01-F002 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S01-F002
Owner: runtime/media/color.asm::nebo_color_rgba_media_native_vertical
```
