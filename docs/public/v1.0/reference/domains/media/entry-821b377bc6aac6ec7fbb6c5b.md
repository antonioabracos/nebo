...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: PixelFormat.rgba8 returns the versioned four-channel layout

```text
Identity: owner:G019:G019-S01-F005 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S01-F005
Owner: runtime/media/color.asm::nebo_pixel_format_rgba8
```
...
- runtime/media/color.asm — SHA-256 c491b848765a4eaa1578b771d55c27f9740aa7a13068652d2606034e3923ac7a
