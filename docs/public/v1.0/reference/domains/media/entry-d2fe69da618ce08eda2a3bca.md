...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: Image.load uses exact File capability reads and bounded decode

```text
Identity: owner:G019:G019-S04-F005 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S04-F005
Owner: runtime/image/image_io.asm::nebo_image_load
```
...
- runtime/image/image_io.asm — SHA-256 94fb1fc88dbef14c3f6a0fb25c1c18b815acf46497e13480cabcd9fde6f9eb24
