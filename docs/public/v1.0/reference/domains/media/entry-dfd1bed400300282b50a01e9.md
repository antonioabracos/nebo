...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: Color.rgb publishes opaque packed RGBA 0xff332211

```text
Identity: owner:G019:G019-S01-F001 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S01-F001
Owner: runtime/media/color.asm::nebo_color_rgb_media_native_vertical
```
