...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: audio.resample performs bounded deterministic linear interpolation

```text
Identity: owner:G019:G019-S05-F005 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S05-F005
Owner: runtime/audio/pcm.asm::nebo_pcm_resample_linear_into
```
...
- runtime/audio/pcm.asm — SHA-256 09884a4a28b19ec07d5684c8011f2e119bfcf8daf6d3db9d2b1f2ccb9734ff2d
