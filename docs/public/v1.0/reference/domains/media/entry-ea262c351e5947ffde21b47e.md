...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: Bmp.encode emits canonical BMP3 BI_RGB bytes

```text
Identity: owner:G019:G019-S04-F002 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S04-F002
Owner: runtime/image/bmp.asm::nebo_bmp_encode
```
...
- runtime/image/bmp.asm — SHA-256 715377a29328117245ae522634d840ab6fec012a2b741f7f9be1162b3faff8de
