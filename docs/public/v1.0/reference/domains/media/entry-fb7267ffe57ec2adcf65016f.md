...
Bounded native media owner; legacy whole-file source probe is not a public typed API; original observation: pixel.pack preserves RGBA8 and computes weighted GRAY8

```text
Identity: owner:G019:G019-S01-F007 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G019-S01-F007
Owner: runtime/media/color.asm::nebo_pixel_pack
```
