# numeric-kernels — CpuFeatures.detect()

CPU scalar reference; native SIMD dispatch is a separate owner; no timing guarantee; original observation: CpuFeatures.detect(); SDK bounds: {"MAX_BENCH_SAMPLES":64,"MAX_BENCH_WARMUP":32,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_WORKERS":8,"MAX_WORKSPACE_BYTES":65536}

```text
Identity: owner:G017:G017-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "38: \n39: local = CpuFeatures.detect()\n40: scalar_features = CpuFeatures.simulated(sse2=False, avx2=False, logical_cores=1)\n41: sse_features = CpuFeatures.simulated(sse2=True, avx2=False, logical_cores=2)\n42: avx_features = CpuFeatures.simulated(sse2=True, avx2=True, logical_cores=4)",
