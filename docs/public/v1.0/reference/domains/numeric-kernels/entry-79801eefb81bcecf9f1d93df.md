# numeric-kernels — features.logicalCores()

CPU scalar reference; native SIMD dispatch is a separate owner; no timing guarantee; original observation: features.logicalCores(); SDK bounds: {"MAX_BENCH_SAMPLES":64,"MAX_BENCH_WARMUP":32,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_WORKERS":8,"MAX_WORKSPACE_BYTES":65536}

```text
Identity: owner:G017:G017-S01-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
CpuFeatures.logicalCores(self) -> int
```
...
[
  ...
  {
    "excerpt": "49: ok(\"positive\", \"features.cacheInfo\", local.cacheInfo().line_bytes in {32, 64, 128})\n50: ok(\"positive\", \"features.logicalCores\", local.logicalCores() >= 1)\n51: \n52: left = [1.25, -2.0, 3.5, 4.0, -5.25, 6.0, 7.75]\n53: right = [2.0, 3.0, -4.0, 0.5, 1.25, -2.0, 8.0]",
