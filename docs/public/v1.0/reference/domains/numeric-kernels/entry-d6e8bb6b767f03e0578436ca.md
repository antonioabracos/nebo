# numeric-kernels — features.hasSse2()

CPU scalar reference; native SIMD dispatch is a separate owner; no timing guarantee; original observation: features.hasSse2(); SDK bounds: {"MAX_BENCH_SAMPLES":64,"MAX_BENCH_WARMUP":32,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_WORKERS":8,"MAX_WORKSPACE_BYTES":65536}

```text
Identity: owner:G017:G017-S01-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
- compiler/semantic/cpu/cpu_contract.inc — SHA-256 96c76f8a3e1a3bb1520bb08cd023a44d523e223a161c29fa038b263413e96881
