# numeric-kernels — features.hasAvx2()

CPU scalar reference; native SIMD dispatch is a separate owner; no timing guarantee; original observation: features.hasAvx2(); SDK bounds: {"MAX_BENCH_SAMPLES":64,"MAX_BENCH_WARMUP":32,"MAX_DIMENSION":64,"MAX_ELEMENTS":4096,"MAX_WORKERS":8,"MAX_WORKSPACE_BYTES":65536}

```text
Identity: owner:G017:G017-S01-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "46: ok(\"positive\", \"features.hasSse2\", isinstance(local.hasSse2(), bool))\n47: ok(\"positive\", \"features.hasAvx2\", isinstance(local.hasAvx2(), bool))\n48: ok(\"positive\", \"features.hasAvx512\", isinstance(local.hasAvx512(), bool))\n49: ok(\"positive\", \"features.cacheInfo\", local.cacheInfo().line_bytes in {32, 64, 128})\n50: ok(\"positive\", \"features.logicalCores\", local.logicalCores() >= 1)",
...
- runtime/cpu/cpu_features.asm — SHA-256 97f90a339f82a9766c38314d575eecceb8071e433e70645cb6a43b3a494472de
