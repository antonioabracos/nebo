# offline-distributed — conflict.resolve(strategy)

Local event/convergence model; no network or distributed availability guarantee; original observation: explicit choose strategy publishes value seventy-three and both parents; SDK bounds: {"MAX_BATCH":256,"MAX_BYTES":1048576,"MAX_CHANGES":4096,"MAX_EVENTS":4096,"MAX_QUEUE":256,"MAX_REPLICAS":16}

```text
Identity: owner:G033:G033-S06-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Conflict.resolve(self, strategy: str | Callable[[Mapping[str, Any]], Any]) -> Any
```
...
[
  ...
  {
    "excerpt": "11: sys.dont_write_bytecode = True\n12: ROOT = Path(__file__).resolve().parents[3]\n13: sys.path.insert(0, str(ROOT))\n14: \n15: from compiler.sdk.offline import (  # noqa: E402",
