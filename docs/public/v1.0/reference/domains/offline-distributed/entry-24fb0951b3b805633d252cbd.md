# offline-distributed — version.compare(other)

Local event/convergence model; no network or distributed availability guarantee; original observation: crossed counters classify as concurrent; SDK bounds: {"MAX_BATCH":256,"MAX_BYTES":1048576,"MAX_CHANGES":4096,"MAX_EVENTS":4096,"MAX_QUEUE":256,"MAX_REPLICAS":16}

```text
Identity: owner:G033:G033-S04-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
VersionVector.compare(self, other: 'VersionVector') -> str
```
...
[
  ...
  {
    "excerpt": "151: other_vector = VersionVector({\"replica-A\": 0, \"replica-B\": 1})\n152: ok(\"positive\", \"version.compare\", observed_vector.compare(other_vector) == \"concurrent\")\n153: new_clock = HybridLogicalClock.new(LogicalClockCapability.deterministic(\"causal-clock\", 1000))\n154: ok(\"positive\", \"HybridLogicalClock.new\", new_clock.tick(7) == (7, 0, \"causal-clock\"))\n155: ok(\"positive\", \"change.causalParents\", child.causalParents() == (\"upstream:1\",))",
...
- runtime/replication/version_vector.asm — SHA-256 4c404e34152e63923e5568602beaf88ad591b7a345f9231de836c433a725cea9
