# offline-distributed — change.causalParents()

Local event/convergence model; no network or distributed availability guarantee; original observation: child publishes upstream counter-one parent identity; SDK bounds: {"MAX_BATCH":256,"MAX_BYTES":1048576,"MAX_CHANGES":4096,"MAX_EVENTS":4096,"MAX_QUEUE":256,"MAX_REPLICAS":16}

```text
Identity: owner:G033:G033-S04-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Change.causalParents(self) -> tuple[str, ...]
```
...
[
  ...
  {
    "excerpt": "63:             \"timestamp\": clock.tick(physical), \"payload\": {\"amount\": value},\n64:             \"causalParents\": parents,\n65:             \"provenance\": {\"device\": actor, \"source\": \"oracle\"}}\n66: \n67: ",
