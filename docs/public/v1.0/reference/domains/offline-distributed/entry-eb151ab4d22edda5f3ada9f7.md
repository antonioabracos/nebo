# offline-distributed — conflict.provenance()

Local event/convergence model; no network or distributed availability guarantee; original observation: candidate actors and explicit resolution remain auditable; SDK bounds: {"MAX_BATCH":256,"MAX_BYTES":1048576,"MAX_CHANGES":4096,"MAX_EVENTS":4096,"MAX_QUEUE":256,"MAX_REPLICAS":16}

```text
Identity: owner:G033:G033-S06-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Conflict.provenance(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "64:             \"causalParents\": parents,\n65:             \"provenance\": {\"device\": actor, \"source\": \"oracle\"}}\n66: \n67: \n68: # S01 — append-only event identity, exact versions, replay, snapshot, and queue bounds.",
