# portable-reference — component.instantiate(imports,capabilities)

Bytecode/component/eBPF reference only; no native non-x86 target backend certification; original observation: exact import bindings and capability superset govern instantiation; SDK bounds: {"MAX_BPF_INSTRUCTIONS":4096,"MAX_BPF_MAP_ENTRIES":65536,"MAX_CALLS":4096,"MAX_COMPONENTS":32,"MAX_EDGE_STATE_BYTES":1048576,"MAX_EXPORTS":128,"MAX_IMPORTS":128,"MAX_INPUT_BYTES":1048576,"MAX_INTERFACE_FUNCTIONS":128,"MAX_MEMORY_PAGES":4096,"MAX_SOURCE_BYTES":1048576,"MAX_TABLE_ITEMS":65536}

```text
Identity: owner:G039:G039-S02-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Component.instantiate(self, imports: Mapping[str, Any], capabilities: Sequence[Capability]) -> ComponentInstance
```
...
[
  ...
  {
    "excerpt": "68: console_cap = Capability.issue(\"console.write\", \"console:test\")\n69: instance = component.instantiate({\"env.write\": object()}, [console_cap])\n70: passed(\"component.instantiate(imports, capabilities)\", instance.component is component)\n71: other_module = WasmModule.new(\"metrics\")\n72: other_interface = Interface.define(\"metrics.api\", \"2.0.0\", {\"read\": {\"params\": [], \"result\": \"i64\"}})",
