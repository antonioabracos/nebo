# portable-reference — component.compatibility(previous)

Bytecode/component/eBPF reference only; no native non-x86 target backend certification; original observation: missing identities major versions removed functions and signature changes govern compatibility; SDK bounds: {"MAX_BPF_INSTRUCTIONS":4096,"MAX_BPF_MAP_ENTRIES":65536,"MAX_CALLS":4096,"MAX_COMPONENTS":32,"MAX_EDGE_STATE_BYTES":1048576,"MAX_EXPORTS":128,"MAX_IMPORTS":128,"MAX_INPUT_BYTES":1048576,"MAX_INTERFACE_FUNCTIONS":128,"MAX_MEMORY_PAGES":4096,"MAX_SOURCE_BYTES":1048576,"MAX_TABLE_ITEMS":65536}

```text
Identity: owner:G039:G039-S02-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Component.compatibility(self, previous: 'Component') -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "79: ])\n80: passed(\"component.compatibility(previous)\", component.compatibility(previous)[\"compatible\"] is True)\n81: passed(\"component.snapshot()\", component.snapshot() == component.snapshot() and b\"telemetry\" in component.snapshot())\n82: \n83: # S03: typed capability adapters, bounded local host execution and metrics.",
