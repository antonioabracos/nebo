# portable-reference — host.metrics()

Bytecode/component/eBPF reference only; no native non-x86 target backend certification; original observation: metrics expose actual calls cancellations and canonical input bytes; SDK bounds: {"MAX_BPF_INSTRUCTIONS":4096,"MAX_BPF_MAP_ENTRIES":65536,"MAX_CALLS":4096,"MAX_COMPONENTS":32,"MAX_EDGE_STATE_BYTES":1048576,"MAX_EXPORTS":128,"MAX_IMPORTS":128,"MAX_INPUT_BYTES":1048576,"MAX_INTERFACE_FUNCTIONS":128,"MAX_MEMORY_PAGES":4096,"MAX_SOURCE_BYTES":1048576,"MAX_TABLE_ITEMS":65536}

```text
Identity: owner:G039:G039-S03-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
WasmHost.metrics(self) -> Mapping[str, int]
EdgeFunction.metrics(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "70: passed(\"component.instantiate(imports, capabilities)\", instance.component is component)\n71: other_module = WasmModule.new(\"metrics\")\n72: other_interface = Interface.define(\"metrics.api\", \"2.0.0\", {\"read\": {\"params\": [], \"result\": \"i64\"}})\n73: other = Component.fromModule(other_module, [other_interface])\n74: component.link(other)",
