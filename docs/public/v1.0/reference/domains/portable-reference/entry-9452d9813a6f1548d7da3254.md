# portable-reference — host.cancel(instance)

Bytecode/component/eBPF reference only; no native non-x86 target backend certification; original observation: cancellation is observable monotonic and rejects duplicate cancellation; SDK bounds: {"MAX_BPF_INSTRUCTIONS":4096,"MAX_BPF_MAP_ENTRIES":65536,"MAX_CALLS":4096,"MAX_COMPONENTS":32,"MAX_EDGE_STATE_BYTES":1048576,"MAX_EXPORTS":128,"MAX_IMPORTS":128,"MAX_INPUT_BYTES":1048576,"MAX_INTERFACE_FUNCTIONS":128,"MAX_MEMORY_PAGES":4096,"MAX_SOURCE_BYTES":1048576,"MAX_TABLE_ITEMS":65536}

```text
Identity: owner:G039:G039-S03-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
WasmHost.cancel(self, instance: ComponentInstance) -> None
```
...
[
  ...
  {
    "excerpt": "96: passed(\"host.run(component, input)\", host.metrics()[\"calls\"] == 1 and not host_instance.cancelled)\n97: host.cancel(host_instance)\n98: passed(\"host.cancel(instance)\", host_instance.cancelled)\n99: passed(\"host.metrics()\", host.metrics() == {\"calls\": 1, \"cancelled\": 1, \"inputBytes\": 14})\n100: ",
