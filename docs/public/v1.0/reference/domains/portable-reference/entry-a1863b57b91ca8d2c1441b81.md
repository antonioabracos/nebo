# portable-reference — Interface.define(name,version,functions)

Bytecode/component/eBPF reference only; no native non-x86 target backend certification; original observation: canonical semantic version and typed function map form interface identity; SDK bounds: {"MAX_BPF_INSTRUCTIONS":4096,"MAX_BPF_MAP_ENTRIES":65536,"MAX_CALLS":4096,"MAX_COMPONENTS":32,"MAX_EDGE_STATE_BYTES":1048576,"MAX_EXPORTS":128,"MAX_IMPORTS":128,"MAX_INPUT_BYTES":1048576,"MAX_INTERFACE_FUNCTIONS":128,"MAX_MEMORY_PAGES":4096,"MAX_SOURCE_BYTES":1048576,"MAX_TABLE_ITEMS":65536}

```text
Identity: owner:G039:G039-S02-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Interface.define(name: str, version: str, functions: Mapping[str, Mapping[str, Any]]) -> 'Interface'
```
...
[
  ...
  {
    "excerpt": "63: # S02: versioned interfaces and immutable component snapshots.\n64: interface = Interface.define(\"telemetry.api\", \"1.2.0\", {\"transform\": {\"params\": [\"i32\"], \"result\": \"i32\"}})\n65: passed(\"Interface.define(name, version, functions)\", interface.version == \"1.2.0\")\n66: component = Component.fromModule(module, [interface])\n67: passed(\"Component.fromModule(module, interfaces)\", component.inspect()[\"module\"] == \"telemetry\")",
