...
```text
PortableArtifact.manifest(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "137: artifact = PortableArtifact(target, module, program, edge)\n138: manifest = artifact.manifest()\n139: passed(\"PortableArtifact.manifest()\", manifest[\"format\"] == \"NEBO-PORTABLE-ARTIFACT-v1\" and len(manifest[\"components\"]) == 3)\n140: passed(\"artifact.verify()\", artifact.verify()[\"valid\"] is True)\n141: reproducibility = artifact.reproducibilityReport()",
