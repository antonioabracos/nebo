# portable-reference — Target.wasm32(options)

Bytecode/component/eBPF reference only; no native non-x86 target backend certification; original observation: explicit ABI and feature options yield immutable wasm32 target identity; SDK bounds: {"MAX_BPF_INSTRUCTIONS":4096,"MAX_BPF_MAP_ENTRIES":65536,"MAX_CALLS":4096,"MAX_COMPONENTS":32,"MAX_EDGE_STATE_BYTES":1048576,"MAX_EXPORTS":128,"MAX_IMPORTS":128,"MAX_INPUT_BYTES":1048576,"MAX_INTERFACE_FUNCTIONS":128,"MAX_MEMORY_PAGES":4096,"MAX_SOURCE_BYTES":1048576,"MAX_TABLE_ITEMS":65536}

```text
Identity: owner:G039:G039-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Target.wasm32(options: Mapping[str, Any]) -> 'Target'
```
...
[
  ...
  {
    "excerpt": "49: # S01: six SDK surfaces; the two CLI surfaces are tested by validate.sh.\n50: target = Target.wasm32({\"abi\": \"component-v1\", \"features\": [\"bulk-memory\"], \"memory64\": False})\n51: passed(\"Target.wasm32(options)\", target.architecture == \"wasm32\")\n52: module = WasmModule.new(\"telemetry\")\n53: passed(\"WasmModule.new(name)\", module.name == \"telemetry\")",
