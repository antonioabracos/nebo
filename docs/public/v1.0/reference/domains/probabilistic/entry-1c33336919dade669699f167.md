...
```text
Distribution.logProbability(self, value: Any) -> float
```
...
[
  ...
  {
    "excerpt": "62: ok(\"positive\", \"distribution.sample\", close(sample, 1.129482111631409, 1e-12))\n63: ok(\"positive\", \"distribution.logProbability\",\n64:    close(normal.logProbability(2), -math.log(3) - 0.5 * math.log(2 * math.pi)))\n65: ok(\"positive\", \"distribution.support\",\n66:    beta.support()[\"lower\"] == 0.0 and beta.support()[\"upper\"] == 1.0 and beta.support()[\"open\"])",
