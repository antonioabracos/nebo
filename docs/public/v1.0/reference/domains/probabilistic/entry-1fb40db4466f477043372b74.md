...
```text
Forecast.brierScore(self) -> float
```
...
[
  ...
  {
    "excerpt": "185: ok(\"positive\", \"Forecast.calibrate\", forecast.predictions == (0.8, 0.3, 0.6, 0.1))\n186: ok(\"positive\", \"forecast.brierScore\", close(forecast.brierScore(), 0.075))\n187: expected_log = -math.fsum((math.log(0.8), math.log(0.7), math.log(0.6), math.log(0.9))) / 4\n188: ok(\"positive\", \"forecast.logScore\", close(forecast.logScore(), expected_log))\n189: decision_posterior = Posterior((0, 1), (0.25, 0.75), \"decision\")",
