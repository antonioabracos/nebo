# probabilistic — VariationalFamily.meanField(model)

Bounded seeded CPU probability model; no statistical certification or unlimited sampling; original observation: mean-field family bound to model; SDK bounds: {"MAX_ACTIONS":1024,"MAX_CATEGORIES":4096,"MAX_CHAINS":16,"MAX_DRAWS":100000,"MAX_EXACT_STATES":1000000,"MAX_GRAPH_NODES":1024,"MAX_LATENTS":256,"MAX_OUTCOMES":4096,"MAX_PARTICLES":100000,"MAX_PLATE_SIZE":4096}

```text
Identity: owner:G037:G037-S05-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
VariationalFamily.meanField(cls, model: ProbModel) -> 'VariationalFamily'
```
...
[
  ...
  {
    "excerpt": "137: # S05 — both families, bounded optimization, posterior and chain comparison.\n138: mean_field = VariationalFamily.meanField(continuous_model)\n139: ok(\"positive\", \"VariationalFamily.meanField\", mean_field.kind == \"mean-field\")\n140: full_rank = VariationalFamily.fullRank(continuous_model)\n141: ok(\"positive\", \"VariationalFamily.fullRank\", full_rank.kind == \"full-rank\")",
