# probabilistic — model.inferVariational(family,optimizer,options)

Bounded seeded CPU probability model; no statistical certification or unlimited sampling; original observation: seeded bounded Adam result; SDK bounds: {"MAX_ACTIONS":1024,"MAX_CATEGORIES":4096,"MAX_CHAINS":16,"MAX_DRAWS":100000,"MAX_EXACT_STATES":1000000,"MAX_GRAPH_NODES":1024,"MAX_LATENTS":256,"MAX_OUTCOMES":4096,"MAX_PARTICLES":100000,"MAX_PLATE_SIZE":4096}

```text
Identity: owner:G037:G037-S05-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ProbModel.inferVariational(self, family: 'VariationalFamily', optimizer: Mapping[str, Any] | str, options: Mapping[str, Any] | None=None) -> 'VariationalResult'
```
...
[
  ...
  {
    "excerpt": "141: ok(\"positive\", \"VariationalFamily.fullRank\", full_rank.kind == \"full-rank\")\n142: variational = continuous_model.inferVariational(\n143:     full_rank, {\"name\": \"adam\", \"learningRate\": 0.05},\n144:     {\"iterations\": 40, \"seed\": 51, \"tolerance\": 1e-6},\n145: )",
