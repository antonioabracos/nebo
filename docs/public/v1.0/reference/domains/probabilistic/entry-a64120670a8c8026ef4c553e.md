...
```text
Mcmc.metropolis(cls, options: Mapping[str, Any] | None=None) -> McmcKernel
```
...
[
  ...
  {
    "excerpt": "111: # S04 — each kernel is configured, MCMC/SMC execute, and views are immutable.\n112: metropolis = Mcmc.metropolis({\"draws\": 80, \"warmup\": 20, \"seed\": 31, \"stepSize\": 0.7})\n113: ok(\"positive\", \"Mcmc.metropolis\", metropolis.kind == \"metropolis\" and metropolis.draws == 80)\n114: hamiltonian = Mcmc.hamiltonian({\"draws\": 32, \"warmup\": 8, \"seed\": 32,\n115:                                \"stepSize\": 0.12, \"leapfrogSteps\": 4})",
