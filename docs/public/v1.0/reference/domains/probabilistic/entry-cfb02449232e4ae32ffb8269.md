# probabilistic — Distribution.normal(mean,stddev)

Bounded seeded CPU probability model; no statistical certification or unlimited sampling; original observation: immutable normal parameters 2.0 and 3.0; SDK bounds: {"MAX_ACTIONS":1024,"MAX_CATEGORIES":4096,"MAX_CHAINS":16,"MAX_DRAWS":100000,"MAX_EXACT_STATES":1000000,"MAX_GRAPH_NODES":1024,"MAX_LATENTS":256,"MAX_OUTCOMES":4096,"MAX_PARTICLES":100000,"MAX_PLATE_SIZE":4096}

```text
Identity: owner:G037:G037-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Distribution.normal(cls, mean: Any, stddev: Any) -> 'Distribution'
```
...
[
  ...
  {
    "excerpt": "50: # S01 — analytically checked probability, support, moments and seeded samples.\n51: normal = Distribution.normal(2, 3)\n52: ok(\"positive\", \"Distribution.normal\", normal.kind == \"normal\" and normal.parameters == (2.0, 3.0))\n53: beta = Distribution.beta(2, 3)\n54: ok(\"positive\", \"Distribution.beta\", close(beta.statistics()[\"mean\"], 0.4))",
