...
```text
ExactInference.diagnostics(self) -> Mapping[str, Any]
Samples.diagnostics(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "44:         ok(\"negative\", label, error.code() == f\"NEBO-G037-{suffix}\" and bool(error.operation()))\n45:         counts[\"diagnostics\"] += 1\n46:         return\n47:     raise AssertionError(f\"negative:{label}:accepted\")\n48: ",
