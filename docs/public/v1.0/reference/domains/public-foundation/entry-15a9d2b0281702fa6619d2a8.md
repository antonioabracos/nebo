# public-foundation — ConsoleDataArguments

Explicit rejected public syntax: REJECTED: argumentos de dados não são misturados com opções de Console.

```text
Identity: public:g059-format:ConsoleDataArguments (DOMAIN_CONTRACT_ID)
Edition: 1
