...
Explicit rejected public syntax: REJECTED in public format surface; raw addresses require explicit debug capability.

```text
Identity: public:g060-format:%p (DOMAIN_CONTRACT_ID)
Edition: 1
