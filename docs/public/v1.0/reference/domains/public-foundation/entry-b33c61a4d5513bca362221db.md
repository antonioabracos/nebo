# public-foundation — FormattedText

Current corrected G059 explicitly calls FormattedText a conceptual alias/result Text, without a second public type. Alias conceitual/resultado Text; não cria segundo tipo público sem necessidade.

```text
Identity: public:g059-format:FormattedText (DOMAIN_CONTRACT_ID)
Edition: 1
