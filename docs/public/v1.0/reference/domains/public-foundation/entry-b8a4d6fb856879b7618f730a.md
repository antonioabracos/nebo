# public-foundation — FormatTemporary

Current corrected G059 identifies typed IR/ABI nodes, evaluation policy and internal named lowering; these are reached by real format/interpolation source cases but are not standalone public constructors. Native ABI probes remain internal evidence. Temporário HIR/LIR por argumento para preservar effects/ownership.

```text
Identity: public:g059-format:FormatTemporary (DOMAIN_CONTRACT_ID)
Edition: 1
