# public-foundation — __init__

self, diagnostic: str, message: str -&gt; DYNAMIC_PYTHON_RESULT

```text
Identity: public:sdk:compiler:CompilerApiError.__init__ (DOMAIN_CONTRACT_ID)
Edition: 1
...
- compiler/api/compiler_api.py — SHA-256 1b90672ccf201329bff1f6f61f49c67d97c3a7dedb82ee9b5d7b3b5622c363b8
