# public-foundation — EvaluationOrder.LEFT_TO_RIGHT

Current corrected G059 identifies typed IR/ABI nodes, evaluation policy and internal named lowering; these are reached by real format/interpolation source cases but are not standalone public constructors. Native ABI probes remain internal evidence. Argumentos avaliados na ordem lexical.

```text
Identity: public:g059-format:EvaluationOrder.LEFT_TO_RIGHT (DOMAIN_CONTRACT_ID)
Edition: 1
