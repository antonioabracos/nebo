...
### math:cos; expected 29

```nebo
start(){std.math.cos(0.5);29.return;}
```

Oracle: {"binary64_tolerance": {"absolute": 1e-12, "relative": 1e-12}, "capabilities": {"console": "NO_DOCUMENT_OBSERVER", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "filesystem_effects": {}, "independent_builds": 2, "independent_math_values": \[\[9, 2, 0.8775825618903728\]\], "math_trace_sha256": "045710e8f3918e98e001c11762b958cbfbc1c1056e7c57207062174ba8f8a0cf", "observed_math_calls": 1, "process_exit": 29, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}
