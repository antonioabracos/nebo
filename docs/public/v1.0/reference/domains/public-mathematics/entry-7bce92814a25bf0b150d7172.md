...
### math:atan2; expected 29

```nebo
start(){std.math.atan2(3.0, 7.0);29.return;}
```

Oracle: {"binary64_tolerance": {"absolute": 1e-12, "relative": 1e-12}, "capabilities": {"console": "NO_DOCUMENT_OBSERVER", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "filesystem_effects": {}, "independent_builds": 2, "independent_math_values": \[\[11, 2, 0.40489178628508343\]\], "math_trace_sha256": "5a756673cac4e3d3ddaaa601f5da26d81717b4821625f74bf0d06f98740cde78", "observed_math_calls": 1, "process_exit": 29, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}
