...
### math:atomic-pow; expected 23

```nebo
start(){std.math.pow(3.0,4.0);23.return;}
```

Oracle: {"binary64_tolerance": {"absolute": 1e-12, "relative": 1e-12}, "capabilities": {"console": "NO_DOCUMENT_OBSERVER", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "filesystem_effects": {}, "independent_builds": 2, "independent_math_values": \[\[6, 2, 81.0\]\], "math_trace_sha256": "f761daa0cd3f18986de6312a55b6bbb8fedc9a32a5cde4c1b2f398a096a61eb8", "observed_math_calls": 1, "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}
