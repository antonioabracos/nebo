...
### math:tan; expected 29

```nebo
start(){std.math.tan(0.5);29.return;}
```

Oracle: {"binary64_tolerance": {"absolute": 1e-12, "relative": 1e-12}, "capabilities": {"console": "NO_DOCUMENT_OBSERVER", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "filesystem_effects": {}, "independent_builds": 2, "independent_math_values": \[\[10, 2, 0.5463024898437905\]\], "math_trace_sha256": "9820dd45e12de96117ccb0c426306cef7b42fa021f7e8a6bfada24cbdfcbf701", "observed_math_calls": 1, "process_exit": 29, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}
