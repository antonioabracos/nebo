# public-scientific — divideElements
...
```text
Identity: public:claim:b9f0160b7b952ba5f91ef585 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Float-divideElements-0; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.fromRows([[1.0, 2.0], [3.0, 4.0]]).a;Matrix<Float>.fromRows([[5.0, 6.0], [7.0, 8.0]]).b;a.divideElements(b).v;v.at(0,0).v0_0;v.at(0,1).v0_1;v.at(1,0).v1_0;v.at(1,1).v1_1;"${v0_0:fixed(3)}/${v0_1:fixed(3)}/${v1_0:fixed(3)}/${v1_1:fixed(3)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "0.200/0.333/0.429/0.500", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "2b135a396388aac4fbe70b84b8374384826998bb244301710f2635743f2ea777", "text": {"bytes_hex": "302e3230302f302e3333332f302e3432392f302e353030"}}

## Rejected examples

### matrix:Float-type-divideElements-1.0; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.zeros(2,3).m;m.divideElements(1.0);23.return;}
```
