# public-scientific — multiplyElements
...
```text
Identity: public:claim:a96b53c0f26eba1dc0ace438 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-multiplyElements-0; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.fromRows([[1, 2], [3, 4]]).a;Matrix<Int>.fromRows([[5, 6], [7, 8]]).b;a.multiplyElements(b).v;v.at(0,0).v0_0;v.at(0,1).v0_1;v.at(1,0).v1_0;v.at(1,1).v1_1;"${v0_0}/${v0_1}/${v1_0}/${v1_1}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "5/12/21/32", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "825950bdf89c67898490f732b3fd7ebe2fbff328b7ed7b5f5929178c0a040961", "text": {"bytes_hex": "352f31322f32312f3332"}}
