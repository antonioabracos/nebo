...
```text
Identity: public:claim:aacbb3d11cf90b4d90c7dd3e (DOMAIN_CONTRACT_ID)
Edition: 1
...
### tensor:stack-6-\[\]-False-0; expected 23

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Vector<Float> [0.25].v0;Tensor<Float>.fromBuffer(v0,Tuple.of()).a0;Vector<Float> [2.0].v1;Tensor<Float>.fromBuffer(v1,Tuple.of()).a1;Vector<Float> [3.75].v2;Tensor<Float>.fromBuffer(v2,Tuple.of()).a2;Vector<Float> [5.5].v3;Tensor<Float>.fromBuffer(v3,Tuple.of()).a3;Vector<Float> [7.25].v4;Tensor<Float>.fromBuffer(v4,Tuple.of()).a4;Vector<Float> [9.0].v5;Tensor<Float>.fromBuffer(v5,Tuple.of()).a5;Vector<Float> [10.75].v6;Tensor<Float>.fromBuffer(v6,Tuple.of()).a6;a0.stack(Tuple.of(a1,a2,a3,a4,a5,a6),0).t;t.rank().console();t.elementCount().console();"${t.at(Tuple.of(0)):fixed(3)}".console();"${t.at(Tuple.of(1)):fixed(3)}".console();"${t.at(Tuple.of(2)):fixed(3)}".console();"${t.at(Tuple.of(3)):fixed(3)}".console();"${t.at(Tuple.of(4)):fixed(3)}".console();"${t.at(Tuple.of(5)):fixed(3)}".console();"${t.at(Tuple.of(6)):fixed(3)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "170.2502.0003.7505.5007.2509.00010.750", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4, 4, 2, 2, 2, 2, 2, 2, 2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "a17204266312dda2b71e4c649bd87a4df2463a5957ee6d9011b702ec56abeca9", "text": {"bytes_hex": "3137302e323530322e303030332e373530352e353030372e323530392e30303031302e373530"}}

## Rejected examples

### tensor:join-direct-peer; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Tensor<Float>.zeros(Tuple.of(2)).a;a.concatenate(a,0);23.return;}
```
