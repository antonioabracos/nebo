# public-scientific — dotFlattened
...
```text
Identity: public:claim:d0b6a8b8b001e330f31420ef (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:dotFlattened-strided; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.fromRows([[1.0,2.0],[3.0,4.0]]).a;a.transposeView().v;a.dotFlattened(v).x;"${x:fixed(2)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "29.00", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "9d7dc59115ff28ea38a386b31123aade2fdbb9a0ee7fa68579775ad8f4cabf96", "text": {"bytes_hex": "32392e3030"}}

## Rejected examples

### matrix:dotFlattened-argument-type; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.zeros(2,2).m;m.dotFlattened(17);23.return;}
```
