...
```text
Identity: public:claim:396c5d91694f7d7b4554b190 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-fromRows-row; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.fromRows([[17,29,43],[71,83,97]]).m;m.row(1).v;v.at(0,0).v0_0;v.at(0,1).v0_1;v.at(0,2).v0_2;"${v0_0}/${v0_1}/${v0_2}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "71/83/97", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "954b96e2373adb8e25e610c541018b1f88c64851881f5a8975d6823e23395496", "text": {"bytes_hex": "37312f38332f3937"}}

## Rejected examples

### matrix:row-type; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(2,3).m;m.row(true);23.return;}
```
