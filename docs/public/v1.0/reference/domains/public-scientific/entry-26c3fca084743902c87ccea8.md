...
```text
Identity: public:claim:6164f7e068b79f1e4385edbf (DOMAIN_CONTRACT_ID)
Edition: 1
...
### tensor:buffer-view-Float-11-select(0_1)-False; expected 23

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Vector<Float> [12.5, 13.75, 14.125, 18.25, 6.5, 20.75].b;Tensor<Float>.fromBuffer(b,Tuple.of(2,3)).a;a.select(0,1).t;"${t.at(Tuple.of(0)):fixed(3)}".console();"${t.at(Tuple.of(1)):fixed(3)}".console();"${t.at(Tuple.of(2)):fixed(3)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "18.2506.50020.750", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2, 2, 2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e9ced7f50b9c256e7751debce2ad21755338d14ee3a95438babd353af263e8e2", "text": {"bytes_hex": "31382e323530362e35303032302e373530"}}
