...
```text
Identity: public:claim:04d9cb92cf67087f56a3bfff (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:lu-return-255; expected 255

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.fromRows([[2.0,1.0],[4.0,3.0]]).a;a.lu().d;d.1.at(0).console();255.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "1", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 255, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "5045fd7401798a3f5e5ff142ddaf301ef631f92a5499c4029fe3dd26e251335c", "text": {"bytes_hex": "31"}}

## Rejected examples

### matrix:lu-dtype; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(2,2).a;a.lu();23.return;}
```
