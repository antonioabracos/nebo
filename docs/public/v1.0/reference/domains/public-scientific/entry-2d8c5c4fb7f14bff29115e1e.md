...
```text
Identity: public:claim:3af5a07d7b408107b32b19a0 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### statistics:Int-1-quantile-0.75; expected 23

```nebo
start(){Vector<Int> [17,29,43,71].a;"${a.quantile(0.75,linearType7):fixed(6)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "50.000000", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "80719861dc9318fc51b8bb0d5fb206a0924e60b75d4810ec4464910409176ed3", "text": {"bytes_hex": "35302e303030303030"}}

## Rejected examples

### statistics:quantile-0.25; expected NEBO_TYPE_MISMATCH

```nebo
start(){Vector<Float> [1.0,2.0,3.0,4.0].a;a.quantile(0.25).v;23.return;}
```
