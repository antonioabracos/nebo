...
```text
Identity: public:claim:1f646618c206bc4091b49782 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### vector:dot-17-29; expected 23

```nebo
start(){Vector<Int> [17,29].a;Vector<Int> [3,5].b;a.dot(b).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "196", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "a298d8f1fb948bc62d692344a9a1c2390452b127e0ab18e7f7e64c7f5f17c886", "text": {"bytes_hex": "313936"}}

## Rejected examples

### vector:method-dot-17; expected NEBO_TYPE_MISMATCH

```nebo
start(){Vector<Int,4>.filled(17).a;a.dot(17).v;23.return;}
```
