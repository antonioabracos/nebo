...
```text
Identity: public:claim:1c0b6d07949f6c3902798b1c (DOMAIN_CONTRACT_ID)
Edition: 1
...
### tensor:buffer-view-Int-11-narrow(1_1_2)-False; expected 23

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Vector<Int> [28, 40, 54, 82, 94, 108].b;Tensor<Int>.fromBuffer(b,Tuple.of(2,3)).a;a.narrow(1,1,2).t;t.at(Tuple.of(0,0)).console();t.at(Tuple.of(0,1)).console();t.at(Tuple.of(1,0)).console();t.at(Tuple.of(1,1)).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "405494108", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4, 4, 4, 4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "ed82c33635e70f8b17195f85c155c696a3152eeb738d0c6471bd7e0dac7ab6a8", "text": {"bytes_hex": "343035343934313038"}}
