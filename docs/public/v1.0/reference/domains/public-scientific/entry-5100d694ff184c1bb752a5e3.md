...
```text
Identity: public:claim:03a0c75cf0c28529e1b2af67 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-fromRows-original; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.fromRows([[17,29,43],[71,83,97]]).v;v.at(0,0).v0_0;v.at(0,1).v0_1;v.at(0,2).v0_2;v.at(1,0).v1_0;v.at(1,1).v1_1;v.at(1,2).v1_2;"${v0_0}/${v0_1}/${v0_2}/${v1_0}/${v1_1}/${v1_2}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "17/29/43/71/83/97", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "062d7eba5bb3698a7b90c954ace8685d0ef3fe9c85f2d45ca243fff1d21ec166", "text": {"bytes_hex": "31372f32392f34332f37312f38332f3937"}}

## Rejected examples

### matrix:at-type; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(2,3).m;m.at(true,0);23.return;}
```
