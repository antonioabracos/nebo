...
```text
Identity: public:claim:f9395df25b9ce0ac684c6a66 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### tensor:binary-Int-2-multiply; expected 23

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Vector<Int> [1, 2].va;Tensor<Int>.fromBuffer(va,Tuple.of(2,1)).a;Vector<Int> [2, 3, 4].vb;Tensor<Int>.fromBuffer(vb,Tuple.of(1,3)).b;a.multiply(b).c;c.rank().console();c.elementCount().console();c.at(Tuple.of(0,0)).console();c.at(Tuple.of(0,1)).console();c.at(Tuple.of(0,2)).console();c.at(Tuple.of(1,0)).console();c.at(Tuple.of(1,1)).console();c.at(Tuple.of(1,2)).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "26234468", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4, 4, 4, 4, 4, 4, 4, 4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "0571d9511d0c5008b056755dd22ce889f8d228ee89e3f73b8bc7bc2e4ca382b3", "text": {"bytes_hex": "3236323334343638"}}
