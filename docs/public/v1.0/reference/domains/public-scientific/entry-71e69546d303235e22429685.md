...
```text
Identity: public:claim:5633d6573c2350c7aa43c6cb (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-add-0; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.fromRows([[1, 2], [3, 4]]).a;Matrix<Int>.fromRows([[5, 6], [7, 8]]).b;a.add(b).v;v.at(0,0).v0_0;v.at(0,1).v0_1;v.at(1,0).v1_0;v.at(1,1).v1_1;"${v0_0}/${v0_1}/${v1_0}/${v1_1}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "6/8/10/12", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "de0a34f3a3205f78c57762f9a6b412f8a9b99e3081645328887a849511d30dd7", "text": {"bytes_hex": "362f382f31302f3132"}}

## Rejected examples

### matrix:mixed-dtype; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(2,3).a;Matrix<Float>.zeros(2,3).b;a.add(b);23.return;}
```
