...
```text
Identity: public:claim:1edb2d6fba6d2069d8ecb1b2 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### vector:norm-Float-3.0-4.0; expected 23

```nebo
start(){Vector<Float> [3.0,4.0].a;Vector<Float> [1.0,2.0].b;"${a.norm():fixed(6)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "5.000000", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e7aafbdb72087519d72ec409f8bc3234685a1875024e4104430cd180e3f37a85", "text": {"bytes_hex": "352e303030303030"}}

## Rejected examples

### vector:method-norm-empty; expected NEBO_TYPE_MISMATCH

```nebo
start(){Vector<Int,4>.filled(17).a;a.norm().v;23.return;}
```
