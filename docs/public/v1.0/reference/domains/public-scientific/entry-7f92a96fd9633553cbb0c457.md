...
```text
Identity: public:claim:744b5bfb1b31f9747ca28d51 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### tensor:bool-buffer-True-; expected 23

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Bytes.fromValues(1,0,0,1).maskbytes;Tensor<Bool>.fromBuffer(maskbytes,Tuple.of(2,2)).t;t.at(Tuple.of(0,0)).console();t.at(Tuple.of(0,1)).console();t.at(Tuple.of(1,0)).console();t.at(Tuple.of(1,1)).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "truefalsefalsetrue", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[5, 5, 5, 5\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "bc750eee3b016ae7cdddc537920af097dbad60b5c55955d85932887909f475ae", "text": {"bytes_hex": "7472756566616c736566616c736574727565"}}

## Rejected examples

### tensor:at-type; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Tensor<Int>.zeros(Tuple.of(2)).a;a.at(true);23.return;}
```
