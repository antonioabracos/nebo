# public-scientific — standardDeviation
...
```text
Identity: public:claim:c0739f72efe3896918ce9731 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### statistics:Int-1-standardDeviation-population; expected 23

```nebo
start(){Vector<Int> [17,29,43,71].a;"${a.standardDeviation(population):fixed(6)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "20.124612", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "c051799af0b5c47b91bb4e1625c59efd514983561e407659c22a005610908813", "text": {"bytes_hex": "32302e313234363132"}}

## Rejected examples

### statistics:sample-too-small-standardDeviation; expected NEBO_LIMIT_EXCEEDED

```nebo
start(){Vector<Float,1>.filled(1.5).a;a.standardDeviation(sample).v;23.return;}
```
