...
```text
Identity: public:claim:09b7c1054e741b8a444f9092 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:algebra-preserves-input-3; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.fromRows([[7.0, 1.0], [1.0, 6.0]]).a;a.inverse().b;a.at(0,0).v;"${v:fixed(2)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "7.00", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "82857d1986216741068ac01e2c1dfb2ffe131f927157a91d9f64b94d1c157181", "text": {"bytes_hex": "372e3030"}}

## Rejected examples

### matrix:inverse-arity; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.zeros(2,2).m;m.inverse(1);23.return;}
```
