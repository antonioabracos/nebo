...
```text
Identity: public:claim:85b7b475a9f317b026a7b687 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### vector:add-17-29; expected 23

```nebo
start(){Vector<Int,4>.filled(17).a;Vector<Int,4>.filled(29).b;a.add(b).c;c.at(2).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "46", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "832a8a675dacfec1a8757790f5c074d7299487d52f128adae21b6fcf7a6cf0a2", "text": {"bytes_hex": "3436"}}

## Rejected examples

### vector:method-add-17; expected NEBO_TYPE_MISMATCH

```nebo
start(){Vector<Int,4>.filled(17).a;a.add(17).v;23.return;}
```
