...
```text
Identity: public:claim:a267f38e196b6c330761b457 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-axis-mean-0-False-0-0; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.fromRows([[1, 3, 7], [11, 17, 23]]).m;m.a;0.axis;a.mean(axis).v;v.at(0).x;"${x:fixed(3)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "6.000", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "08295eab85e6365ebdfc108cfe468ae8f28bcd6276c4135cb40b055d7f6e5f43", "text": {"bytes_hex": "362e303030"}}

## Rejected examples

### matrix:axis-mean-type; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.zeros(2,3).m;m.mean(true);23.return;}
```
