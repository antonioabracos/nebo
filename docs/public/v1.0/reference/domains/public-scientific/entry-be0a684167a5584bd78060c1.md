...
```text
Identity: public:claim:f1e007d7a52ffd680296d966 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:matmul-rectangular; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.fromRows([[1,2,3],[4,5,6]]).a;Matrix<Int>.fromRows([[7,8],[9,10],[11,12]]).b;a.matmul(b).c;c.at(1,1).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "154", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "6e98afcb8eb655b257ea91c5dc3cf56843db446b5a05e06ce211a77caa17f8ce", "text": {"bytes_hex": "313534"}}
