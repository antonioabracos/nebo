...
```text
Identity: public:claim:872db359c13358ce35543c68 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### vector:scale-17-29; expected 23

```nebo
start(){Vector<Int> [17,17,43].a;a.scale(29).b;b.at(1).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "493", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "88a6d1d05d1a68b1d7456a5c7b5784c7764d075fc5eb8d05c1bfc5486a11bc95", "text": {"bytes_hex": "343933"}}

## Rejected examples

### vector:method-scale-empty; expected NEBO_TYPE_MISMATCH

```nebo
start(){Vector<Int,4>.filled(17).a;a.scale().v;23.return;}
```
