...
```text
Identity: public:claim:494131e4d2c9cc53391e7e16 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:determinant-0; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.fromRows([[4.0, 1.0], [1.0, 3.0]]).a;a.determinant().v;"${v:fixed(3)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "11.000", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "07809c909c8a451ba458978ac8171bb6e9ce3543eb4e0b3e2f0d4eb9e4f78780", "text": {"bytes_hex": "31312e303030"}}

## Rejected examples

### matrix:determinant-arity; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.zeros(2,2).m;m.determinant(1);23.return;}
```
