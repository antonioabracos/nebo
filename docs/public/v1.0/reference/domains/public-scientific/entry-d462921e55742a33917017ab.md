...
```text
Identity: public:claim:f0469eb8a7664220265b2c49 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:fromBuffer-after-source-release; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Array<Int,6> [17,29,43,71,83,97].owner.mutable;owner.asSlice().s;Matrix<Int>.fromBuffer(s,2,3).a;s.release();a.at(1,2).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "97", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "1fe04b82c6440c836a433d3542f2cef2bb2c6c0b0311cdbb98cde25a6ed7a006", "text": {"bytes_hex": "3937"}}

## Rejected examples

### matrix:fromBuffer-vector-dtype; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Vector<Int,2> [17,29].v;Matrix<Float>.fromBuffer(v,1,2).m;23.return;}
```
