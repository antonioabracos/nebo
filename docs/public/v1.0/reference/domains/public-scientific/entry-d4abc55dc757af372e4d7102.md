...
```text
Identity: public:claim:c0998ab6b8fbaf1f877a4314 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### random:return-0; expected 0

```nebo
start(){Random.seed(17).r;r.uniform(10,100).console();0.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "19", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 0, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "c8d97171c9edd7bdd006fcf600caaa47cff785c8a451be584930f2b8849715b6", "text": {"bytes_hex": "3139"}}

## Rejected examples

### random:uniform-arity; expected NEBO_TYPE_MISMATCH

```nebo
start(){Random.seed(17).r;r.uniform(1.0).v;23.return;}
```
