...
```text
Identity: public:claim:f425eab0428f11f66e951d15 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-trace-29; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.filled(2,2,29).m;m.trace().t;t.console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "58", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "d6a9b123bed0cec0c67b43ba584269f5e144a1fe3061415d654298b264fab58a", "text": {"bytes_hex": "3538"}}

## Rejected examples

### matrix:trace-arity; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(2,3).m;m.trace(1);23.return;}
```
