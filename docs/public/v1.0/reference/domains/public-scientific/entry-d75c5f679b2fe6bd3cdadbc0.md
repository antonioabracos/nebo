...
```text
Identity: public:claim:73edaeee7af8fba821251f30 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:fromRows-effects-once; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
(Int.value)cell(){value.console();value.return;}start(){Matrix<Int>.fromRows([[17.cell(),29.cell()]]).m;m.at(0,1).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "172929", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4, 4, 4\], "process_exit": 23, "publications": 3, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "da8c49c522670768355ac530cf3ff2e1b4deaf629f33b7b219ceca93ddc85e77", "text": {"bytes_hex": "313732393239"}}

## Rejected examples

### matrix:fromRows-mixed; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.fromRows([[17,true]]).m;23.return;}
```
