...
```text
Identity: public:NSR-DOM-058 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### boundedoperator:dom-058-discrete-1-False; expected 1

```nebo
start(){distributedAs(17,3,discrete,1,bernoulli,discrete,1,0,1,64).shape();}
```
