...
```text
Identity: public:claim:901c30352afccac5ea13f641 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### tensor:bool-reduce-\[1_1_0_0\]-0-all; expected 23

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Bytes.fromValues(1,1,0,0).b;Tensor<Bool>.fromBuffer(b,Tuple.of(2,2)).a;a.all(0).t;t.at(Tuple.of(0)).console();t.at(Tuple.of(1)).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "falsefalse", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[5, 5\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "70a8ea368bebfe8844a83b6640ec44ffa8b5808b84a8d0441636cfdc05f29e65", "text": {"bytes_hex": "66616c736566616c7365"}}

## Rejected examples

### tensor:all-dtype; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Tensor; }.scientific;
start(){Tensor<Float>.zeros(Tuple.of(2)).a;a.all(0);23.return;}
```
