# public-scientific — conditionEstimate
...
```text
Identity: public:claim:0f0cb5010e3e0372225edc90 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:condition-0; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.fromRows([[4.0, 1.0], [1.0, 3.0]]).a;a.conditionEstimate().v;"${v:fixed(6)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "2.272727", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "f0596b4c83cf0c587b33ee7a9bfc57a91b3acdac6c0c4b7ebb94d6adb5750ee5", "text": {"bytes_hex": "322e323732373237"}}

## Rejected examples

### matrix:conditionEstimate-arity; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.zeros(2,2).m;m.conditionEstimate(1);23.return;}
```
