...
```text
Identity: public:claim:4e804ddf984a1313d447907c (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-outer-0-False-1-2; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Vector<Int> [17, 29].x;Vector<Int> [43, 71, 83].y;x.outer(y).m;m.at(1,2).v;v.console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "2407", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "5e9f194e62053675ad2c6548f3e6a62986cf314c62331e6e9edd3fa5063866a7", "text": {"bytes_hex": "32343037"}}

## Rejected examples

### matrix:outer-argument-dtype; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Vector<Float,2>.filled(1.5).v;v.outer(Vector<Int,2>.filled(17));23.return;}
```
