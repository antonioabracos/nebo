...
```text
Identity: public:claim:94b167d878a551d712b57f41 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-fromRows-column; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.fromRows([[17,29,43],[71,83,97]]).m;m.column(2).v;v.at(0,0).v0_0;v.at(1,0).v1_0;"${v0_0}/${v1_0}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "43/97", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "6e35f0f416248ccc7c155dfc7d1bc2ee8f5f2bf82889144810834ef79a644fd2", "text": {"bytes_hex": "34332f3937"}}

## Rejected examples

### matrix:column-arity; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(2,3).m;m.column();23.return;}
```
