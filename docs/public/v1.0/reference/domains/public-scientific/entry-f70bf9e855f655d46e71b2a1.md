...
```text
Identity: public:claim:f1f3aa4cde215a622900f030 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### vector:return-Int-0; expected 0

```nebo
start(){Vector<Int,4>.filled(9).a;a.at(2).console();0.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "9", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 0, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "6b3b09666ef731599326a5a245912ab617e0669f033b2f9ae877abc22a52e18e", "text": {"bytes_hex": "39"}}

## Rejected examples

### vector:empty-arguments; expected NEBO_TYPE_MISMATCH

```nebo
start(){Vector<Int,4>.filled().a;23.return;}
```
