# public-scientific — transposeView
...
```text
Identity: public:claim:17cad357c790a900c955f40f (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:Int-empty-transpose-0-3-False; expected 23

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(0,3).m;m.transposeView().v;v.rows().r;v.columns().c;"${r}/${c}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "3/0", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "1c869e3149b5aefecd7ea59c5c58bfddc14a91b21836005f36a52bcf1e3ccb99", "text": {"bytes_hex": "332f30"}}

## Rejected examples

### matrix:transpose-arity; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(2,3).m;m.transposeView(1);23.return;}
```
