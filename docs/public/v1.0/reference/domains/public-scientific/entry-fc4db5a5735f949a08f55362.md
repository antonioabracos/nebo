...
```text
Identity: public:claim:f751b8dd7f981c318eea9a3b (DOMAIN_CONTRACT_ID)
Edition: 1
...
### matrix:qr-return-7; expected 7

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Float>.fromRows([[1.0,0.0],[0.0,1.0]]).a;a.qr().d;d.0.rows().console();7.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "2", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 7, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "ada65271c31b0bc29d43a86977c740d413f0cae3cb9363a295e8b2642318c565", "text": {"bytes_hex": "32"}}

## Rejected examples

### matrix:qr-dtype; expected NEBO_TYPE_MISMATCH

```nebo
import "std.scientific" { Matrix; }.scientific;
start(){Matrix<Int>.zeros(2,2).a;a.qr();23.return;}
```
