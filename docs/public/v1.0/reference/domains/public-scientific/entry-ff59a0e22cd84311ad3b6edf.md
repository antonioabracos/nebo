...
```text
Identity: public:claim:031af9436a9f7d0dffe33482 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### statistics:nan-propagation-variance; expected 23

```nebo
start(){Vector<Float> [1.0,(∞-∞)].a;a.variance(population).isNaN().console();23.return;}
```
...
### statistics:policy-variance-17; expected NEBO_TYPE_MISMATCH

```nebo
start(){Vector<Float> [1.0,2.0,3.0,4.0].a;a.variance(17).v;23.return;}
```
