...
Spelling alias only; inspect every qualified declaration: g018-declaration:Label.new(text)

```text
Identity: public:claim:830fe6789739f469536e27a5 (DOMAIN_CONTRACT_ID)
Edition: 1
