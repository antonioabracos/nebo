...
Spelling alias only; inspect every qualified declaration: g018-declaration:Canvas.create(width, height)

```text
Identity: public:claim:556c54b8ded54df938b60ba8 (DOMAIN_CONTRACT_ID)
Edition: 1
