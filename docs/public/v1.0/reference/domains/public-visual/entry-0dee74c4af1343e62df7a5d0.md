...
Spelling alias only; inspect every qualified declaration: g018-declaration:widget.on(event, handler)

```text
Identity: public:claim:cea73b106af8283c756c7888 (DOMAIN_CONTRACT_ID)
Edition: 1
