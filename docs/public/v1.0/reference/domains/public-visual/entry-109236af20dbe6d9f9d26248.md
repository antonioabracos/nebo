# public-visual — TextInput

Spelling alias only; inspect every qualified declaration: g018-declaration:TextInput.new(value)

```text
Identity: public:claim:391a3b0abc5fcfaa25f32931 (DOMAIN_CONTRACT_ID)
Edition: 1
