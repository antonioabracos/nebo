...
Spelling alias only; inspect every qualified declaration: g018-declaration:canvas.text(text, position, font, paint)

```text
Identity: public:claim:f9b3d318db7f2dcf739e26fa (DOMAIN_CONTRACT_ID)
Edition: 1
