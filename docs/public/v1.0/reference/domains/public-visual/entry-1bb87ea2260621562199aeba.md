# public-visual — resize

Spelling alias only; inspect every qualified declaration: g018-declaration:window.resize(width, height); g018-declaration:event.resize()

```text
Identity: public:claim:510923a7355e17893064b946 (DOMAIN_CONTRACT_ID)
Edition: 1
