# public-visual — visual.summarize

Canonical existing pure visual_summary_foundation owner, actual Int value 0..255, decimal provenance, one evaluation and independent explicit return; no document/window/rendering effect is claimed.

```text
Identity: public:g170-console:visual.summarize (DOMAIN_CONTRACT_ID)
Edition: 1
