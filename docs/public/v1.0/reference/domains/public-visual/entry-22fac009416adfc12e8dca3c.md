...
Spelling alias only; inspect every qualified declaration: g018-declaration:console.clear(); g018-declaration:canvas.clear(color)

```text
Identity: public:claim:da20bfa83f48811c625e1146 (DOMAIN_CONTRACT_ID)
Edition: 1
