...
Spelling alias only; inspect every qualified declaration: g018-declaration:canvas.line(from, to, paint); g018-declaration:Chart.line(series)

```text
Identity: public:claim:f59f6ee74909ea6781e03705 (DOMAIN_CONTRACT_ID)
Edition: 1
