# public-visual — legend

Spelling alias only; inspect every qualified declaration: g018-declaration:chart.legend(options)

```text
Identity: public:claim:9ee15351fa05f2d506a50679 (DOMAIN_CONTRACT_ID)
Edition: 1
