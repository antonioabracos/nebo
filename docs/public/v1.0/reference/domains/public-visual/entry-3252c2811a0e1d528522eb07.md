...
Spelling alias only; inspect every qualified declaration: g018-declaration:console.close(); g018-declaration:window.close()

```text
Identity: public:claim:185374eead963ba352652e1c (DOMAIN_CONTRACT_ID)
Edition: 1
