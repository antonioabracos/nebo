...
Spelling alias only; inspect every qualified declaration: g018-declaration:canvas.circle(center, radius, paint)

```text
Identity: public:claim:0b4ad9588cd7eba6c21f0e7f (DOMAIN_CONTRACT_ID)
Edition: 1
