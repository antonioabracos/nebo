...
Spelling alias only; inspect every qualified declaration: g018-declaration:Chart.bar(categories, values)

```text
Identity: public:claim:39dce5a057a05eb6474a8f3e (DOMAIN_CONTRACT_ID)
Edition: 1
