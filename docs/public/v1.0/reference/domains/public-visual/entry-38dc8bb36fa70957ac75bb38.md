...
```text
Identity: public:g170-console:Tree.console (DOMAIN_CONTRACT_ID)
Edition: 1
...
### console:structured-tree-empty; expected 23

```nebo
start(){Tree<Int>.new(17).t;t.removeSubtree(t.root());t.console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_state_trace": true, "console_text_utf8": "Tree\n", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2, 3\], "observation": {"native_oracle": "console_public_test.compare"}, "process_exit": 23, "publications": 1, "runtime_determinism": "DOMAIN_INVARIANTS", "runtime_sha256": "8c81282efa81ee0cefa455e7120efe2450749386eb18c7a32dbd77e410094c72", "text": {"bytes_hex": "547265650a"}}

## Rejected examples

### console:structured-tree-value; expected NEBO_TYPE_MISMATCH

```nebo
start(){Tree<Int>.new(true).t;t.console();23.return;}
```
