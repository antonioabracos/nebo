...
```text
Identity: public:g170-scan:lower (DOMAIN_CONTRACT_ID)
Edition: 1
...
### scan:lower-48654c4c6f; expected 23

```nebo
start(){"Input".scan(.text(),.lower(),.mock("HeLLo")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "hello", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "5b2d56e5c3ae6139dd19510183eb78ce0a3c3734c0a240e00b67cf676f6d244d", "text": {"bytes_hex": "68656c6c6f"}}

## Rejected examples

### scan:option-arity-lower; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.lower(17));23.return;}
```
