...
Spelling alias only; inspect every qualified declaration: g018-declaration:console.style(range, style)

```text
Identity: public:claim:d31b675b1c30ee373abc69a1 (DOMAIN_CONTRACT_ID)
Edition: 1
