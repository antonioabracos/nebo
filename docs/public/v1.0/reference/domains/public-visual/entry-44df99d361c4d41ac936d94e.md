...
Contextual alias for g170-scan:mask; public typed source proof replaces the historical seed/probe evidence. Preserve the qualified row bounds; no separate global option or live capability is claimed.

```text
Identity: public:claim:e8149ff28098a7f2e0908db7 (DOMAIN_CONTRACT_ID)
Edition: 1
