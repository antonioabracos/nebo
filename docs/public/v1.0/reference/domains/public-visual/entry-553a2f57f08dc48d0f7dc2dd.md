...
```text
Identity: public:g170-console:Text.hash (DOMAIN_CONTRACT_ID)
Edition: 1
...
### console:color-text-hash-0; expected 23

```nebo
start(){"".hash().console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_state_trace": true, "console_text_utf8": "-3750763034362895579", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "observation": {"native_oracle": "console_public_test.compare"}, "process_exit": 23, "publications": 1, "runtime_determinism": "DOMAIN_INVARIANTS", "runtime_sha256": "8b9806336574f3ad424329c3e87730dcda50737f752f3058ffa54ffd69f1a5fa", "text": {"bytes_hex": "2d33373530373633303334333632383935353739"}}
