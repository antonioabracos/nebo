# public-visual — scrollToEnd

Spelling alias only; inspect every qualified declaration: g018-declaration:console.scrollToEnd()

```text
Identity: public:claim:549e7059025a971fcc365dc9 (DOMAIN_CONTRACT_ID)
Edition: 1
...
### console:scroll-3; expected 23

```nebo
start(){"abc".console().view;view.scrollToEnd();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_state_trace": true, "console_text_utf8": "abc", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "observation": {"native_oracle": "console_public_test.compare"}, "process_exit": 23, "publications": 1, "runtime_determinism": "DOMAIN_INVARIANTS", "runtime_sha256": "89e519ef33a291a4bff0f40a925ba3a58458c4edf37184ea14ed37adeeb52e9d", "text": {"bytes_hex": "616263"}}

## Rejected examples

### console:scroll-arity; expected NEBO_TYPE_MISMATCH

```nebo
start(){"seed".console().v;v.scrollToEnd(1);23.return;}
```
