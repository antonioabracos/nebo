# public-visual — render

Spelling alias only; inspect every qualified declaration: g018-declaration:chart.render(canvas)

```text
Identity: public:claim:9cee08f100ca91b8a6ab3c48 (DOMAIN_CONTRACT_ID)
Edition: 1
