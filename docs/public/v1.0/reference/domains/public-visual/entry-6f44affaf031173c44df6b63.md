...
Spelling alias only; inspect every qualified declaration: g018-declaration:Layout.row(children); g018-declaration:Layout.column(children); g018-declaration:Layout.grid(spec, children)

```text
Identity: public:claim:639b827943cf93320a390064 (DOMAIN_CONTRACT_ID)
Edition: 1
