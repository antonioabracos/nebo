...
Spelling alias only; inspect every qualified declaration: g018-declaration:canvas.rectangle(rect, paint)

```text
Identity: public:claim:9272814e1720f0635d3f8fd1 (DOMAIN_CONTRACT_ID)
Edition: 1
