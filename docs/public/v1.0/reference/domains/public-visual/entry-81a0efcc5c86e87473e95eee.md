...
Spelling alias only; inspect every qualified declaration: g018-declaration:console.title(text); g018-declaration:chart.title(text)

```text
Identity: public:claim:ce58a02fc4cc1d6cdeeaf444 (DOMAIN_CONTRACT_ID)
Edition: 1
