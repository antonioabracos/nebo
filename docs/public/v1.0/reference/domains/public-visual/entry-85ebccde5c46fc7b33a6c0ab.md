...
```text
Identity: public:g170-scan:choice (DOMAIN_CONTRACT_ID)
Edition: 1
...
### scan:choice-3-0-726564; expected 23

```nebo
start(){"Choice".scan(.choice(["red","green","blue"]),.mock("red")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "red", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "d2ddf646eee46a6582ccc4bfd5620e1dfec4fa1f71adddd6172fd14c150a5e43", "text": {"bytes_hex": "726564"}}

## Rejected examples

### scan:choice-type; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.choice([17,29]));23.return;}
```
