# public-visual — window.resize(width, height)

Corrected G018 explicitly says general GUI is not available and marks this high-level declaration P. Internal native/seed probes do not establish a source-visible implementation. It is not reclassified as a tested public API or as live evidence. Solicita nova dimensão. Corrected G018 SHA256=0944468ee395ee0c83aa6697baf52d111053327405fafd499e3cf08d57031718

```text
Identity: public:g018-declaration:window.resize(width, height) (DOMAIN_CONTRACT_ID)
Edition: 1
