...
Spelling alias only; inspect every qualified declaration: g018-declaration:Layout.row(children)

```text
Identity: public:claim:e9be758e3cbeade32a42f841 (DOMAIN_CONTRACT_ID)
Edition: 1
