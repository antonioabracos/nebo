...
Contextual alias for g170-scan:panel; public typed source proof replaces the historical seed/probe evidence. Preserve the qualified row bounds; no separate global option or live capability is claimed.

```text
Identity: public:claim:b7ffcdf5e25b3713c3415c6c (DOMAIN_CONTRACT_ID)
Edition: 1
