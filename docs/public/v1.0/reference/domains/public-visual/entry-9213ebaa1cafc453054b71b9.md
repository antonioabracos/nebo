...
Spelling alias only; inspect every qualified declaration: g018-declaration:Chart.line(series); g018-declaration:Chart.scatter(points); g018-declaration:Chart.bar(categories, values); g018-declaration:Chart.histogram(values, bins)

```text
Identity: public:claim:c9361e0220afeeb004edb241 (DOMAIN_CONTRACT_ID)
Edition: 1
