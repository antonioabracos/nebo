...
Spelling alias only; inspect every qualified declaration: g018-declaration:window.events()

```text
Identity: public:claim:991e691f7a47f76e2bb4033d (DOMAIN_CONTRACT_ID)
Edition: 1
