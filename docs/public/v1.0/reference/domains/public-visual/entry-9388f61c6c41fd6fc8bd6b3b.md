# public-visual — scatter

Spelling alias only; inspect every qualified declaration: g018-declaration:Chart.scatter(points)

```text
Identity: public:claim:dcf575bdd5c2a2b8f3a8eb1c (DOMAIN_CONTRACT_ID)
Edition: 1
