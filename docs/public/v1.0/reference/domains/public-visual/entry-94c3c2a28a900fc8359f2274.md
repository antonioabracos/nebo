# public-visual — Button

Spelling alias only; inspect every qualified declaration: g018-declaration:Button.new(label)

```text
Identity: public:claim:622ac741502c1a3d2d330126 (DOMAIN_CONTRACT_ID)
Edition: 1
