# public-visual — preventDefault

Spelling alias only; inspect every qualified declaration: g018-declaration:event.preventDefault()

```text
Identity: public:claim:72f3482aa6e2821e3e7eab21 (DOMAIN_CONTRACT_ID)
Edition: 1
