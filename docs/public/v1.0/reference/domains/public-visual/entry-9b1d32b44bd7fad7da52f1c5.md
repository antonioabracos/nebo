...
Spelling alias only; inspect every qualified declaration: g018-declaration:Layout.grid(spec, children)

```text
Identity: public:claim:4745617a708b26eef70d1b3f (DOMAIN_CONTRACT_ID)
Edition: 1
