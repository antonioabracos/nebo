...
Spelling alias only; inspect every qualified declaration: g018-declaration:console.size()

```text
Identity: public:claim:3be8074ed4adc596274a600f (DOMAIN_CONTRACT_ID)
Edition: 1
