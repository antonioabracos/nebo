...
```text
Identity: public:g170-scan:panel (DOMAIN_CONTRACT_ID)
Edition: 1
...
### scan:option-type-panel; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.panel(17));23.return;}
```
