# public-visual — histogram

Spelling alias only; inspect every qualified declaration: g018-declaration:Chart.histogram(values, bins)

```text
Identity: public:claim:59a22aacdf82300702c5de58 (DOMAIN_CONTRACT_ID)
Edition: 1
