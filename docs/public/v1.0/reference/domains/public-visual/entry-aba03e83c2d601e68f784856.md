# public-visual — accessibility

Spelling alias only; inspect every qualified declaration: g018-declaration:widget.accessibility()

```text
Identity: public:claim:bd5234c735e3dc9003535c2a (DOMAIN_CONTRACT_ID)
Edition: 1
