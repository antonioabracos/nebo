# public-visual — forgetAfterUse

Contextual alias for g170-scan:forgetAfterUse; public typed source proof replaces the historical seed/probe evidence. Preserve the qualified row bounds; no separate global option or live capability is claimed.

```text
Identity: public:claim:311685a7a02236989d47900a (DOMAIN_CONTRACT_ID)
Edition: 1
