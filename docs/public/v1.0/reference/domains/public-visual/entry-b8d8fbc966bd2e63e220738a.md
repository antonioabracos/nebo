...
Spelling alias only; inspect every qualified declaration: g018-declaration:canvas.image(image, destination)

```text
Identity: public:claim:56697641d57dfe7da951c074 (DOMAIN_CONTRACT_ID)
Edition: 1
