# public-visual — create

Spelling alias only; inspect every qualified declaration: g018-declaration:Window.create(options); g018-declaration:Canvas.create(width, height)

```text
Identity: public:claim:3b924b1bec519c3e9195ddeb (DOMAIN_CONTRACT_ID)
Edition: 1
