# public-visual — column

Spelling alias only; inspect every qualified declaration: g018-declaration:Layout.column(children)

```text
Identity: public:claim:71f1aaac0442431cfea63328 (DOMAIN_CONTRACT_ID)
Edition: 1
