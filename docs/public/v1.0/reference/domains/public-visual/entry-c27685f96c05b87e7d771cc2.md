...
Spelling alias only; inspect every qualified declaration: g018-declaration:Text.scan(); g018-declaration:Console.scan()

```text
Identity: public:claim:1a9373a3a7fa502dc2f48298 (DOMAIN_CONTRACT_ID)
Edition: 1
