# public-visual — setTitle

Spelling alias only; inspect every qualified declaration: g018-declaration:window.setTitle(text)

```text
Identity: public:claim:6fc9b39228aa1659ef6c3eb3 (DOMAIN_CONTRACT_ID)
Edition: 1
