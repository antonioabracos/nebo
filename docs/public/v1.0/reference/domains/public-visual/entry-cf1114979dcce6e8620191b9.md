# public-visual — append

Spelling alias only; inspect every qualified declaration: g018-declaration:console.append(value, style)

```text
Identity: public:claim:81f88d5ea73328af2efaa0de (DOMAIN_CONTRACT_ID)
Edition: 1
