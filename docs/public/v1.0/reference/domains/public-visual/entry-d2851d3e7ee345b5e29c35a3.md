# public-visual — pointer

Spelling alias only; inspect every qualified declaration: g018-declaration:event.pointer()

```text
Identity: public:claim:6e9ee62093071ea7bc7fc4b4 (DOMAIN_CONTRACT_ID)
Edition: 1
