# public-visual — paragraph

Contextual alias for g170-scan:paragraph; public typed source proof replaces the historical seed/probe evidence. Preserve the qualified row bounds; no separate global option or live capability is claimed.

```text
Identity: public:claim:620b2733fc66bb9048954ffb (DOMAIN_CONTRACT_ID)
Edition: 1
