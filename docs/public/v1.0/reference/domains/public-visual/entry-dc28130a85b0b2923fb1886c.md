...
Contextual alias for g170-scan:scan; public typed source proof replaces the historical seed/probe evidence. Preserve the qualified row bounds; no separate global option or live capability is claimed.

```text
Identity: public:claim:f7adc0185da65a7014d9fd8e (DOMAIN_CONTRACT_ID)
Edition: 1
