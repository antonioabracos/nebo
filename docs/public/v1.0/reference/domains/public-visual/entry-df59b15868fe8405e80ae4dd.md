...
Contextual alias for g170-scan:replay; public typed source proof replaces the historical seed/probe evidence. Preserve the qualified row bounds; no separate global option or live capability is claimed.

```text
Identity: public:claim:6d58fe076f0a92fb0f968d5d (DOMAIN_CONTRACT_ID)
Edition: 1
...
### scan:replay-no-newline-17; expected 23

```nebo
start(){"Age".scan(.int(),.replay("answers.txt")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "17", "filesystem_effects": {}, "independent_builds": 2, "inputs": {"answers.txt": {"bytes_hex": "3137"}}, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "50b51beedee62ac56116895bebfe5602de0a663f834a7fb6a1fdb11dbdb27d18", "text": {"bytes_hex": "3137"}}
