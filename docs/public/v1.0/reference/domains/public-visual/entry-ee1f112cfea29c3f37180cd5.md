# public-visual — redact

Contextual alias for g170-scan:redact; public typed source proof replaces the historical seed/probe evidence. Preserve the qualified row bounds; no separate global option or live capability is claimed.

```text
Identity: public:claim:5c4067090d3eb3b35c41ae27 (DOMAIN_CONTRACT_ID)
Edition: 1
