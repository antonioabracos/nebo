...
Spelling alias only; inspect every qualified declaration: g018-declaration:Button.new(label); g018-declaration:TextInput.new(value); g018-declaration:Label.new(text)

```text
Identity: public:claim:ec314620f2a192265d5e39d2 (DOMAIN_CONTRACT_ID)
Edition: 1
