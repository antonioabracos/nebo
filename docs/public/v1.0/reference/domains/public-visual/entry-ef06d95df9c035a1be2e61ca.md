...
```text
Identity: public:g170-scan:eofAs (DOMAIN_CONTRACT_ID)
Edition: 1
...
### scan:eof-fallback-int; expected 23

```nebo
start(){"Input".scan(.int(),.eofAs(71)).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "71", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "prompt": {"bytes_hex": "496e707574"}, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "7f460260169b5f03b48255975a76d502c0c7244a6f90f2060f26897792e30871", "text": {"bytes_hex": "3731"}}

## Rejected examples

### scan:eof-fallback-type; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.int(),.eofAs(true));23.return;}
```
