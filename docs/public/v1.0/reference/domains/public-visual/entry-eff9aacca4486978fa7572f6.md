# public-visual — ScanPlan.indexChoice
...
```text
Identity: public:g170-scan:indexChoice (DOMAIN_CONTRACT_ID)
Edition: 1
...
### scan:index-3-0-726564; expected 23

```nebo
start(){"Choice".scan(.indexChoice(["red","green","blue"]),.mock("red")).console();23.return;}
```
