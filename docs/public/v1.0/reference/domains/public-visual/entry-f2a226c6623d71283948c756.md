...
Spelling alias only; inspect every qualified declaration: g018-declaration:event.textInput()

```text
Identity: public:claim:ebca1d83f744c097e92b7ec3 (DOMAIN_CONTRACT_ID)
Edition: 1
