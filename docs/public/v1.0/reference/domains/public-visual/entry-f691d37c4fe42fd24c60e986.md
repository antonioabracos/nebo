# public-visual — requestRedraw

Spelling alias only; inspect every qualified declaration: g018-declaration:window.requestRedraw()

```text
Identity: public:claim:3be127c3cbd95d126f09179b (DOMAIN_CONTRACT_ID)
Edition: 1
