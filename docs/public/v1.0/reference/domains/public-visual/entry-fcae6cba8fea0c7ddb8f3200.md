...
```text
Identity: public:g170-scan:block (DOMAIN_CONTRACT_ID)
Edition: 1
...
### scan:multiline-block-replay; expected 23

```nebo
start(){"Input".scan(.block("END"),.replay("answers.txt")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "first\nsecond", "filesystem_effects": {}, "independent_builds": 2, "inputs": {"answers.txt": {"bytes_hex": "66697273740a7365636f6e640a454e440a69676e6f7265640a"}}, "kinds": \[2, 3, 2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "67164e5d37d0b68f8432c424a26268b06751b32f7e871f0e5bc387b3b16768c2", "text": {"bytes_hex": "66697273740a7365636f6e64"}}

## Rejected examples

### scan:multiline-type-block; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.block(17));23.return;}
```
