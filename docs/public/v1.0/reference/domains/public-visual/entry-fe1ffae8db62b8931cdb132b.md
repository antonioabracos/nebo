...
Spelling alias only; inspect every qualified declaration: g018-declaration:Window.create(options)

```text
Identity: public:claim:40c477c7a1ba40dffe257647 (DOMAIN_CONTRACT_ID)
Edition: 1
