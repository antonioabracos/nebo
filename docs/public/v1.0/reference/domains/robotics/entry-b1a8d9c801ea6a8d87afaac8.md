# robotics — SystemIdentification.fit(data,structure,options)

Deterministic DSP/PID/replay model; no physical actuator, sensor or hard real-time proof; original observation: ARX data identifies analytical state and input coefficients; SDK bounds: {"MAX_LOOP_TICKS":512,"MAX_MATRIX_DIMENSION":16,"MAX_SAMPLES":4096,"MAX_TRANSFORM_POINTS":256}

```text
Identity: owner:G041:G041-S04-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
SystemIdentification.fit(data: Mapping[str, Any], structure: str, options: Mapping[str, Any] | None) -> Identification
```
...
[
  ...
  {
    "excerpt": "210:     surface(\"G041-S04-06\", discrete.sample_time == 0.05 and close(discrete.A[0][1], 0.05), discrete.A)\n211:     identification = SystemIdentification.fit(\n212:         {\"input\": (0.0, 1.0, 0.0, 2.0, 1.0), \"output\": (1.0, 0.5, 2.25, 1.125, 4.5625)},\n213:         \"arx-1\",\n214:         {\"solver\": \"normal-equations\"},",
