# robotics — identification.residualReport()

Deterministic DSP/PID/replay model; no physical actuator, sensor or hard real-time proof; original observation: zero residual data yields zero MSE and full fit; SDK bounds: {"MAX_LOOP_TICKS":512,"MAX_MATRIX_DIMENSION":16,"MAX_SAMPLES":4096,"MAX_TRANSFORM_POINTS":256}

```text
Identity: owner:G041:G041-S04-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Identification.residualReport(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "216:     surface(\"G041-S04-07\", close(identification.coefficient, 0.5) and close(identification.input_gain, 2.0), (identification.coefficient, identification.input_gain))\n217:     residual = identification.residualReport()\n218:     surface(\"G041-S04-08\", close(residual[\"mse\"], 0.0) and close(residual[\"fit\"], 1.0), dict(residual))\n219: \n220:     scaled = model.step((2.0, 4.0), (6.0,))",
