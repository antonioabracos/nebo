# robotics — model.observable()

Deterministic DSP/PID/replay model; no physical actuator, sensor or hard real-time proof; original observation: observability matrix has full rank; SDK bounds: {"MAX_LOOP_TICKS":512,"MAX_MATRIX_DIMENSION":16,"MAX_SAMPLES":4096,"MAX_TRANSFORM_POINTS":256}

```text
Identity: owner:G041:G041-S04-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
StateSpace.observable(self) -> bool
```
...
[
  ...
  {
    "excerpt": "206:     surface(\"G041-S04-04\", model.controllable() is True, model.controllable())\n207:     surface(\"G041-S04-05\", model.observable() is True, model.observable())\n208:     continuous = StateSpace.define(((0.0, 1.0), (-1.0, -0.2)), ((0.0,), (1.0,)), ((1.0, 0.0),), ((0.0,),), 0.0)\n209:     discrete = continuous.discretize(0.05, \"forward-euler\")\n210:     surface(\"G041-S04-06\", discrete.sample_time == 0.05 and close(discrete.A[0][1], 0.05), discrete.A)",
