# scientific — SparseVector.fromIndices(length, indices, values)

Bounded CPU sparse/FFT/solver reference; no arbitrary precision or convergence outside documented limits; original observation: SparseVector.fromIndices(length, indices, values); SDK bounds: {"MAX_DENSE_CELLS":65536,"MAX_DIMENSION":4096,"MAX_FFT_LENGTH":64,"MAX_GRID_CELLS":65536,"MAX_ITERATIONS":100000,"MAX_NONZERO":65536,"MAX_TRACE":4096}

```text
Identity: owner:G036:G036-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
SparseVector.fromIndices(length: int, indices: Sequence[int], values: Sequence[Any]) -> 'SparseVector'
```
...
[
  ...
  {
    "excerpt": "46: # S01 — sparse values, canonical representations and explicit densification.\n47: vector = SparseVector.fromIndices(3, (0, 2), (4, 6))\n48: ok(\"positive\", \"SparseVector.fromIndices\", vector.dense() == (4.0, 0.0, 6.0))\n49: csr = SparseMatrix.csr(2, 3, (0, 2, 3), (0, 2, 1), (1, 2, 3))\n50: ok(\"positive\", \"SparseMatrix.csr\", csr.toDense(6) == ((1.0, 0.0, 2.0), (0.0, 3.0, 0.0)))",
...
- runtime/sparse/sparse.asm — SHA-256 4bc6a0029637c3ed9ad24d9e999c0988137a8f380aaeff73eafa5ef075268228
