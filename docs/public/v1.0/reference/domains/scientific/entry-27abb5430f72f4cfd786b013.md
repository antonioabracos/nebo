# scientific — OdeProblem.define(initialState, derivative, interval)

Bounded CPU sparse/FFT/solver reference; no arbitrary precision or convergence outside documented limits; original observation: OdeProblem.define(initialState, derivative, interval); SDK bounds: {"MAX_DENSE_CELLS":65536,"MAX_DIMENSION":4096,"MAX_FFT_LENGTH":64,"MAX_GRID_CELLS":65536,"MAX_ITERATIONS":100000,"MAX_NONZERO":65536,"MAX_TRACE":4096}

```text
Identity: owner:G036:G036-S04-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
OdeProblem.define(initialState: Sequence[Any], derivative: Callable[..., Any], interval: Sequence[Any]) -> 'OdeProblem'
```
