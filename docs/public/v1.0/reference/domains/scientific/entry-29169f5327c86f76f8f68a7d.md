# scientific — Root.bisection(function, bracket, tolerance)

Bounded CPU sparse/FFT/solver reference; no arbitrary precision or convergence outside documented limits; original observation: Root.bisection(function, bracket, tolerance); SDK bounds: {"MAX_DENSE_CELLS":65536,"MAX_DIMENSION":4096,"MAX_FFT_LENGTH":64,"MAX_GRID_CELLS":65536,"MAX_ITERATIONS":100000,"MAX_NONZERO":65536,"MAX_TRACE":4096}

```text
Identity: owner:G036:G036-S03-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Root.bisection(function: Callable[[float], Any], bracket: Sequence[Any], tolerance: Any) -> NumericResult
```
...
[
  ...
  {
    "excerpt": "84: # S03 — three root strategies and four quadrature policies publish errors.\n85: bisection = Root.bisection(lambda x: x*x - 2, (0, 2), 1e-10)\n86: ok(\"positive\", \"Root.bisection\", close(bisection.value, math.sqrt(2), 1e-9))\n87: brent = Root.brent(lambda x: x*x - 2, (0, 2), 1e-10)\n88: ok(\"positive\", \"Root.brent\", close(brent.value, math.sqrt(2), 1e-9))",
...
- runtime/scientific/root_integrate.asm — SHA-256 bee8c1c1eac580da98e86b3bb667c2ba8fcef99d22e4c689ebb4b71737fbc8b9
