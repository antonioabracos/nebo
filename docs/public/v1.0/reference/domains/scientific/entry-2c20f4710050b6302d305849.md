# scientific — pde.solve(method, options)

Bounded CPU sparse/FFT/solver reference; no arbitrary precision or convergence outside documented limits; original observation: pde.solve(method, options); SDK bounds: {"MAX_DENSE_CELLS":65536,"MAX_DIMENSION":4096,"MAX_FFT_LENGTH":64,"MAX_GRID_CELLS":65536,"MAX_ITERATIONS":100000,"MAX_NONZERO":65536,"MAX_TRACE":4096}

```text
Identity: owner:G036:G036-S05-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
- runtime/pde/pde.asm — SHA-256 3862cd9c797d3d7184cdf742eb33960ee61915c5d8e0517043743cfaa23de497
