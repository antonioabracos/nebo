# scientific — sparse.matmul(other)

Bounded CPU sparse/FFT/solver reference; no arbitrary precision or convergence outside documented limits; original observation: sparse.matmul(other); SDK bounds: {"MAX_DENSE_CELLS":65536,"MAX_DIMENSION":4096,"MAX_FFT_LENGTH":64,"MAX_GRID_CELLS":65536,"MAX_ITERATIONS":100000,"MAX_NONZERO":65536,"MAX_TRACE":4096}

```text
Identity: owner:G036:G036-S01-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
SparseMatrix.matmul(self, other: Any) -> Any
```
...
[
  ...
  {
    "excerpt": "56: ok(\"positive\", \"sparse.transpose\", transposed.toDense(6) == ((1.0, 0.0), (0.0, 3.0), (2.0, 0.0)))\n57: product = csr.matmul((4, 5, 6))\n58: ok(\"positive\", \"sparse.matmul\", product == (16.0, 15.0))\n59: ok(\"positive\", \"sparse.toDense\", csr.toDense(6)[1][1] == 3.0)\n60: invariants = csr.validateInvariants()",
