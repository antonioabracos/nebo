# scientific — sparse.validateInvariants()

Bounded CPU sparse/FFT/solver reference; no arbitrary precision or convergence outside documented limits; original observation: sparse.validateInvariants(); SDK bounds: {"MAX_DENSE_CELLS":65536,"MAX_DIMENSION":4096,"MAX_FFT_LENGTH":64,"MAX_GRID_CELLS":65536,"MAX_ITERATIONS":100000,"MAX_NONZERO":65536,"MAX_TRACE":4096}

```text
Identity: owner:G036:G036-S01-09 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
SparseMatrix.validateInvariants(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "59: ok(\"positive\", \"sparse.toDense\", csr.toDense(6)[1][1] == 3.0)\n60: invariants = csr.validateInvariants()\n61: ok(\"positive\", \"sparse.validateInvariants\", invariants[\"valid\"] and invariants[\"nonZeroCount\"] == 3)\n62: transcript.append((product, csr.toDense(6), transposed.storage))\n63: ",
