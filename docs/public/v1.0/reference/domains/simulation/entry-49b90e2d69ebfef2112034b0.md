# simulation — system.after(other)

Seeded bounded ECS/physics model; no physical fidelity or safety certification; original observation: move follows prepare; SDK bounds: {"MAX_ADVANCE_TICKS":256,"MAX_BODIES":1024,"MAX_CONSTRAINTS":4096,"MAX_CONTACTS":4096,"MAX_ENTITIES":4096,"MAX_PARTICLES":65536,"MAX_RESOURCES":1024,"MAX_ROLLBACK_TICKS":1024,"MAX_SYSTEMS":128,"MAX_TRACE_TICKS":1024}

```text
Identity: owner:G043:G043-S02-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
System.after(self, other: 'System | str') -> 'System'
```
...
[
  ...
  {
    "excerpt": "85: observe = System.define(\"observe\", (\"Position\",), record(\"observe\")).reads((\"Position\",))\n86: move = move.after(prepare)\n87: ok(\"positive\", \"system.after(other)\", move._after == {\"prepare\"})\n88: move = move.before(observe)\n89: ok(\"positive\", \"system.before(other)\", move._before == {\"observe\"})",
