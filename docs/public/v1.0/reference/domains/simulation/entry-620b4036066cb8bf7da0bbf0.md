# simulation — World.new(options)

Seeded bounded ECS/physics model; no physical fidelity or safety certification; original observation: bounded seeded world exposes entity budget; SDK bounds: {"MAX_ADVANCE_TICKS":256,"MAX_BODIES":1024,"MAX_CONSTRAINTS":4096,"MAX_CONTACTS":4096,"MAX_ENTITIES":4096,"MAX_PARTICLES":65536,"MAX_RESOURCES":1024,"MAX_ROLLBACK_TICKS":1024,"MAX_SYSTEMS":128,"MAX_TRACE_TICKS":1024}

```text
Identity: owner:G043:G043-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
World.new(options: Mapping[str, Any]) -> 'World'
```
