# simulation — physics.energyReport()

Seeded bounded ECS/physics model; no physical fidelity or safety certification; original observation: report publishes energy drift residual integrator and timestep; SDK bounds: {"MAX_ADVANCE_TICKS":256,"MAX_BODIES":1024,"MAX_CONSTRAINTS":4096,"MAX_CONTACTS":4096,"MAX_ENTITIES":4096,"MAX_PARTICLES":65536,"MAX_RESOURCES":1024,"MAX_ROLLBACK_TICKS":1024,"MAX_SYSTEMS":128,"MAX_TRACE_TICKS":1024}

```text
Identity: owner:G043:G043-S03-09 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
PhysicsWorld.energyReport(self) -> Mapping[str, Any]
```
...
[
  ...
  {
    "excerpt": "128: ok(\"positive\", \"physics.overlap(shape,pose,limit)\", overlaps == (1, 2))\n129: energy = physics.energyReport()\n130: ok(\"positive\", \"physics.energyReport()\", energy[\"integrator\"] == \"semi-implicit-euler-v1\" and\n131:    energy[\"units\"] == \"metre-second-kilogram-v1\" and\n132:    energy[\"collisionModel\"] == \"sphere-overlap-v1\" and",
