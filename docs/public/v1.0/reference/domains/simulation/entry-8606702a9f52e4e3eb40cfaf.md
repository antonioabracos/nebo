# simulation — entity.get&lt;Component&gt;()

Seeded bounded ECS/physics model; no physical fidelity or safety certification; original observation: validated component view observes position; SDK bounds: {"MAX_ADVANCE_TICKS":256,"MAX_BODIES":1024,"MAX_CONSTRAINTS":4096,"MAX_CONTACTS":4096,"MAX_ENTITIES":4096,"MAX_PARTICLES":65536,"MAX_RESOURCES":1024,"MAX_ROLLBACK_TICKS":1024,"MAX_SYSTEMS":128,"MAX_TRACE_TICKS":1024}

```text
Identity: owner:G043:G043-S01-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
EntityRef.get(self, component_type: str) -> ComponentView
```
...
[
  ...
  {
    "excerpt": "51: ok(\"positive\", \"entity.add(component)\", world.validate()[\"archetypes\"] == 1)\n52: position_view = entity.get(\"Position\")\n53: ok(\"positive\", \"entity.get<Component>()\", position_view.value().data[\"x\"] == 2)\n54: entity.add(Component.of(\"Velocity\", {\"x\": 1, \"y\": 0, \"z\": 0}))\n55: queried = world.query((\"Position\", \"Velocity\"))",
