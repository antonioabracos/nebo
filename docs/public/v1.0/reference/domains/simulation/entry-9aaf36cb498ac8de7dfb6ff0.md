# simulation — neboc-simulation-replay

Seeded bounded ECS/physics model; no physical fidelity or safety certification; original observation: binary log replays input-dependent final state and rejects mismatch; SDK bounds: {"MAX_ADVANCE_TICKS":256,"MAX_BODIES":1024,"MAX_CONSTRAINTS":4096,"MAX_CONTACTS":4096,"MAX_ENTITIES":4096,"MAX_PARTICLES":65536,"MAX_RESOURCES":1024,"MAX_ROLLBACK_TICKS":1024,"MAX_SYSTEMS":128,"MAX_TRACE_TICKS":1024}

```text
Identity: owner:G043:G043-S07-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Simulation.replay(self, log: Sequence[Any]) -> str
```
...
[
  ...
  {
    "excerpt": "183:    {\"restoredTick\": 0, \"replayedInputs\": 1} and rollback_sim._state[\"counter\"] == 2)\n184: replay_hash = rollback_sim.replay(({\"delta\": 2}, {\"delta\": 3}, {\"delta\": -1}))\n185: ok(\"positive\", \"simulation.replay(log)\", rollback_sim._state[\"counter\"] == 4 and\n186:    replay_hash == rollback_sim.stateHash())\n187: final_snapshot = rollback_sim.snapshot()",
...
- compiler/driver/cli/linux-x86_64/simulation_cli.inc — SHA-256 ac288b2f1c37cac06af3b5198d30cf73de41210a992a3e5bdd14997f44ba15ee
