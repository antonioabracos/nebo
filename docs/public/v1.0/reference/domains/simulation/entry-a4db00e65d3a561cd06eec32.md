# simulation — world.addSystem(system)

Seeded bounded ECS/physics model; no physical fidelity or safety certification; original observation: three unique systems register within budget; SDK bounds: {"MAX_ADVANCE_TICKS":256,"MAX_BODIES":1024,"MAX_CONSTRAINTS":4096,"MAX_CONTACTS":4096,"MAX_ENTITIES":4096,"MAX_PARTICLES":65536,"MAX_RESOURCES":1024,"MAX_ROLLBACK_TICKS":1024,"MAX_SYSTEMS":128,"MAX_TRACE_TICKS":1024}

```text
Identity: owner:G043:G043-S02-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
World.addSystem(self, system: 'System') -> None
```
...
[
  ...
  {
    "excerpt": "90: schedule_world = World.new({\"entityBudget\": 4})\n91: schedule_world.addSystem(observe)\n92: schedule_world.addSystem(move)\n93: schedule_world.addSystem(prepare)\n94: ok(\"positive\", \"world.addSystem(system)\", len(schedule_world._systems) == 3)",
