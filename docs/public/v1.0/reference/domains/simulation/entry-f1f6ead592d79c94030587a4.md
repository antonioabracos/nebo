# simulation — System.define(name,query,function)

Seeded bounded ECS/physics model; no physical fidelity or safety certification; original observation: named system retains query and callable; SDK bounds: {"MAX_ADVANCE_TICKS":256,"MAX_BODIES":1024,"MAX_CONSTRAINTS":4096,"MAX_CONTACTS":4096,"MAX_ENTITIES":4096,"MAX_PARTICLES":65536,"MAX_RESOURCES":1024,"MAX_ROLLBACK_TICKS":1024,"MAX_SYSTEMS":128,"MAX_TRACE_TICKS":1024}

```text
Identity: owner:G043:G043-S02-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
System.define(name: str, query: Sequence[str], function: Callable[[World, Mapping[str, Any]], None]) -> 'System'
```
...
[
  ...
  {
    "excerpt": "78: \n79: prepare = System.define(\"prepare\", (\"Position\",), record(\"prepare\"))\n80: ok(\"positive\", \"System.define(name,query,function)\", prepare.name == \"prepare\")\n81: prepare = prepare.writes((\"Position\",))\n82: ok(\"positive\", \"system.writes(components)\", prepare._writes == {\"Position\"})",
