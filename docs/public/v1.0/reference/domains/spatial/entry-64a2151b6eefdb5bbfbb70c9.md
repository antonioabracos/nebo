# spatial — Transform3.rotation(quaternion)

Local bounded geometry/GIS; no external maps or global navigation assurance; original observation: identity quaternion preserves point; SDK bounds: {"MAX_CODEC_BYTES":65536,"MAX_FACES":8192,"MAX_INDEX_ITEMS":4096,"MAX_POINTS":4096,"MAX_ROUTE_EDGES":8192,"MAX_ROUTE_NODES":2048}

```text
Identity: owner:G042:G042-S02-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Transform3.rotation(quaternion: Sequence[Any]) -> 'Transform3'
```
...
[
  ...
  {
    "excerpt": "79: ok(\"positive\", \"Transform3.translation(vector)\", translation.apply(origin3) == Point3.of(2, 3, 4))\n80: rotation = Transform3.rotation((1, 0, 0, 0))\n81: ok(\"positive\", \"Transform3.rotation(quaternion)\", rotation.apply(Point3.of(1, 2, 3)) == Point3.of(1, 2, 3))\n82: composed = translation.compose(rotation)\n83: ok(\"positive\", \"transform.compose(other)\", composed.apply(Point3.of(1, 1, 1)) == Point3.of(3, 4, 5))",
