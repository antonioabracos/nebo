# spatial — mesh.transform(transform)

Local bounded geometry/GIS; no external maps or global navigation assurance; original observation: detached mesh moves seven units; SDK bounds: {"MAX_CODEC_BYTES":65536,"MAX_FACES":8192,"MAX_INDEX_ITEMS":4096,"MAX_POINTS":4096,"MAX_ROUTE_EDGES":8192,"MAX_ROUTE_NODES":2048}

```text
Identity: owner:G042:G042-S03-09 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Mesh.transform(self, transform: Transform3) -> 'Mesh'
```
