# spatial — Segment.between(a,b)

Local bounded geometry/GIS; no external maps or global navigation assurance; original observation: nondegenerate endpoints retained; SDK bounds: {"MAX_CODEC_BYTES":65536,"MAX_FACES":8192,"MAX_INDEX_ITEMS":4096,"MAX_POINTS":4096,"MAX_ROUTE_EDGES":8192,"MAX_ROUTE_NODES":2048}

```text
Identity: owner:G042:G042-S01-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Segment.between(a: Point2, b: Point2) -> 'Segment'
```
...
[
  ...
  {
    "excerpt": "52: ok(\"positive\", \"Vector2.of(x,y)\", vector.x == 3 and vector.y == 4)\n53: segment = Segment.between(p0, Point2.of(6, 0))\n54: ok(\"positive\", \"Segment.between(a,b)\", segment.a == p0 and segment.b.x == 6)\n55: line = Polyline.from_((p0, Point2.of(3, 4), Point2.of(6, 4)))\n56: ok(\"positive\", \"Polyline.from(points)\", len(line.points) == 3)",
