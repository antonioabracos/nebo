# spatial — Transform3.translation(vector)

Local bounded geometry/GIS; no external maps or global navigation assurance; original observation: origin translates to two three four; SDK bounds: {"MAX_CODEC_BYTES":65536,"MAX_FACES":8192,"MAX_INDEX_ITEMS":4096,"MAX_POINTS":4096,"MAX_ROUTE_EDGES":8192,"MAX_ROUTE_NODES":2048}

```text
Identity: owner:G042:G042-S02-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Transform3.translation(vector: Sequence[Any]) -> 'Transform3'
```
...
[
  ...
  {
    "excerpt": "77: ok(\"positive\", \"Plane.from(point,normal)\", plane.normal == (1.0, 0.0, 0.0))\n78: translation = Transform3.translation((2, 3, 4))\n79: ok(\"positive\", \"Transform3.translation(vector)\", translation.apply(origin3) == Point3.of(2, 3, 4))\n80: rotation = Transform3.rotation((1, 0, 0, 0))\n81: ok(\"positive\", \"Transform3.rotation(quaternion)\", rotation.apply(Point3.of(1, 2, 3)) == Point3.of(1, 2, 3))",
