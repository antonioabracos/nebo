# spatial — index.insert(bounds,value)

Local bounded geometry/GIS; no external maps or global navigation assurance; original observation: stable handles one and two returned; SDK bounds: {"MAX_CODEC_BYTES":65536,"MAX_FACES":8192,"MAX_INDEX_ITEMS":4096,"MAX_POINTS":4096,"MAX_ROUTE_EDGES":8192,"MAX_ROUTE_NODES":2048}

```text
Identity: owner:G042:G042-S04-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
SpatialIndex.insert(self, bounds: Sequence[Any], value: Any) -> int
```
...
[
  ...
  {
    "excerpt": "14: ROOT_PATH = Path(__file__).resolve().parents[3]\n15: sys.path.insert(0, str(ROOT_PATH))\n16: \n17: from compiler.sdk.spatial import (  # noqa: E402\n18:     Crs, GeoCoordinate, GeoPath, GeoPolygon, GeometryCodec, KdTree, MapMatcher,",
