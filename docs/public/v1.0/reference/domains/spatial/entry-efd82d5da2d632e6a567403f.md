# spatial — geometry.distance(a,b)

Local bounded geometry/GIS; no external maps or global navigation assurance; original observation: three-four-five distance equals five; SDK bounds: {"MAX_CODEC_BYTES":65536,"MAX_FACES":8192,"MAX_INDEX_ITEMS":4096,"MAX_POINTS":4096,"MAX_ROUTE_EDGES":8192,"MAX_ROUTE_NODES":2048}

```text
Identity: owner:G042:G042-S01-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
geometry.distance(a: Any, b: Any) -> float
```
...
[
  ...
  {
    "excerpt": "65: ok(\"positive\", \"geometry.intersects(a,b)\", geometry.intersects(segment, crossing))\n66: ok(\"positive\", \"geometry.distance(a,b)\", geometry.distance(p0, Point2.of(3, 4)) == 5)\n67: ok(\"positive\", \"polygon.area()\", square.area() == 24)\n68: ok(\"positive\", \"polygon.contains(point)\", square.contains(Point2.of(2, 3)))\n69: transcript.append((square.area(), square.contains(Point2.of(6, 2)), geometry.distance(p0, line.points[1])))",
