# spatial — index.nearest(point,count)

Local bounded geometry/GIS; no external maps or global navigation assurance; original observation: east ranks first near six six; SDK bounds: {"MAX_CODEC_BYTES":65536,"MAX_FACES":8192,"MAX_INDEX_ITEMS":4096,"MAX_POINTS":4096,"MAX_ROUTE_EDGES":8192,"MAX_ROUTE_NODES":2048}

```text
Identity: owner:G042:G042-S04-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
SpatialIndex.nearest(self, point: Point2, count: int) -> tuple[Any, ...]
```
...
[
  ...
  {
    "excerpt": "115: kd = KdTree.from_((Point2.of(2, 2), Point2.of(9, 9)), {\"capacity\": 4})\n116: ok(\"positive\", \"KdTree.from(points,options)\", kd.nearest(Point2.of(1, 1), 1)[0] == Point2.of(2, 2))\n117: h1 = index.insert((0, 0, 2, 2), \"west\")\n118: h2 = index.insert((5, 5, 7, 7), \"east\")\n119: ok(\"positive\", \"index.insert(bounds,value)\", (h1, h2) == (1, 2))",
