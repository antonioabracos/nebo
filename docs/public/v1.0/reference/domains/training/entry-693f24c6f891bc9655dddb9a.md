# training — tensor.detach()

Bounded CPU reference gradients and local checkpoint model; no large-model training claim; original observation: tensor.detach(); SDK bounds: {"MAX_BATCH":64,"MAX_CHECKPOINT_BYTES":1048576,"MAX_ELEMENTS":4096,"MAX_EPOCHS":1024,"MAX_GRAPH_NODES":256,"MAX_PARAMETERS":4096,"MAX_PREFETCH":8,"MAX_ROTATIONS":8,"MAX_SAMPLES":4096}

```text
Identity: owner:G021:G021-S01-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "70: ok(\"positive\", \"tensor.gradient\", x.gradient() is not None and x.gradient().values == (7.0,))\n71: detached = result.detach()\n72: ok(\"positive\", \"tensor.detach\", detached.values == (12.0,) and\n73:    not detached._requires_gradient and detached._parents == ())\n74: node_view = graph.nodes()",
...
- compiler/semantic/autograd/autograd_contract.asm — SHA-256 3b37943df908484dfd0ba6ca8aee1ee7e227fb64648461e0b789556f9667ed60
