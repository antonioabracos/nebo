...
Bounded CPU reference gradients and local checkpoint model; no large-model training claim; original observation: optimizer.step(); SDK bounds: {"MAX_BATCH":64,"MAX_CHECKPOINT_BYTES":1048576,"MAX_ELEMENTS":4096,"MAX_EPOCHS":1024,"MAX_GRAPH_NODES":256,"MAX_PARAMETERS":4096,"MAX_PREFETCH":8,"MAX_ROTATIONS":8,"MAX_SAMPLES":4096}

```text
Identity: owner:G021:G021-S04-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "143: ok(\"positive\", \"Sgd.new\", sgd.learning_rate == 0.1 and sgd.momentum == 0.0)\n144: ok(\"positive\", \"optimizer.step\", sgd.step() == 1 and sgd_parameter.values == (1.95, -0.8))\n145: state = sgd.state()\n146: ok(\"positive\", \"optimizer.state\", state[\"kind\"] == \"sgd\" and state[\"step\"] == 1)\n147: sgd_parameter._gradient = [8.0, 9.0]",
...
- runtime/training/optimizers.asm — SHA-256 cd62876faa802b6a39b2394fd2eebbb88f4090bc965b00724a801e15c3c0b332
