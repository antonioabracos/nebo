# training — optimizer.zeroGrad()

Bounded CPU reference gradients and local checkpoint model; no large-model training claim; original observation: optimizer.zeroGrad(); SDK bounds: {"MAX_BATCH":64,"MAX_CHECKPOINT_BYTES":1048576,"MAX_ELEMENTS":4096,"MAX_EPOCHS":1024,"MAX_GRAPH_NODES":256,"MAX_PARAMETERS":4096,"MAX_PREFETCH":8,"MAX_ROTATIONS":8,"MAX_SAMPLES":4096}

```text
Identity: owner:G021:G021-S04-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
[
  ...
  {
    "excerpt": "147: sgd_parameter._gradient = [8.0, 9.0]\n148: ok(\"positive\", \"optimizer.zeroGrad\", sgd.zeroGrad() == 2 and\n149:    sgd_parameter.gradient().values == (0.0, 0.0))\n150: sgd_copy = Sgd.new([Tensor([0.0, 0.0], (2,), True)], 0.3,\n151:                    {\"momentum\": 0.2, \"weightDecay\": 0.1})",
