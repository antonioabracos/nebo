# visual-owner-G085 — diagnostic-code

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: write failure maps to a stable constant diagnostic

```text
Identity: owner:G085:G085-S08-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
diagnostic-code
Owner: compiler/diagnostics/p01.asm::neboc_diag_from_const_status
```
