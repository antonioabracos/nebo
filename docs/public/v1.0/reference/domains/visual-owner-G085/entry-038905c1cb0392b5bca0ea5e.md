# visual-owner-G085 — source-preservation

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: format stdout preserves constant spelling and source bytes

```text
Identity: owner:G085:G085-S08-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
- tools/rf27-format.py — SHA-256 4b1690cc7867b52b5c1b4ed48abdcafbccafabb502aa66355a401f8fa6be78de
