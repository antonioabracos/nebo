# visual-owner-G085 — read

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ConstBinding read action is admitted

```text
Identity: owner:G085:G085-S06-01 (DOMAIN_CONTRACT_ID)
Edition: 1
