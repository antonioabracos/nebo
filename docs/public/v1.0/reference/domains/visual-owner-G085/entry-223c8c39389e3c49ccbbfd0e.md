# visual-owner-G085 — stable-id

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: repeated name and scope yield the same SymbolId

```text
Identity: owner:G085:G085-S02-04 (DOMAIN_CONTRACT_ID)
Edition: 1
