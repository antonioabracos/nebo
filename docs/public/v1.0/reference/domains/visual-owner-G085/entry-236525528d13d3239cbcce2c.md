# visual-owner-G085 — structured-errors

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: check JSON and emit/build diagnostics report deterministic codes

```text
Identity: owner:G085:G085-S08-06 (DOMAIN_CONTRACT_ID)
Edition: 1
