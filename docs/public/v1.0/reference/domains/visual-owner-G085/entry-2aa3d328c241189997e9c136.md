# visual-owner-G085 — rename-category

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ALL_CAPS to camelCase rename is rejected

```text
Identity: owner:G085:G085-S08-03 (DOMAIN_CONTRACT_ID)
Edition: 1
