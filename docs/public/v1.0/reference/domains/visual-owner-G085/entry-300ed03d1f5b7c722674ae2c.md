# visual-owner-G085 — two-identities

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: two ALL_CAPS values are independently readable

```text
Identity: owner:G085:G085-S02-08 (DOMAIN_CONTRACT_ID)
Edition: 1
