# visual-owner-G085 — ordinary

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: flow ordinary name remains OrdinaryBinding

```text
Identity: owner:G085:G085-S05-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ordinary
Owner: compiler/parser/const_compat.asm::neboc_const_parse_classify
```
...
- compiler/parser/const_compat.asm — SHA-256 fec3508f7a76f9879d2e46bcc8a191867f795d75fdb7671a8abe15a57ea89266
