# visual-owner-G085 — PascalCase

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Pascal spelling classified without ConstBinding

```text
Identity: owner:G085:G085-S01-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
PascalCase
Owner: compiler/semantic/name_style.asm::neboc_name_style_classify
```
...
- compiler/semantic/name_style.asm — SHA-256 3e5c31126066f55f1e19eacb6605a25c51fd71a956d5e6eb17db9943a3f882b8
