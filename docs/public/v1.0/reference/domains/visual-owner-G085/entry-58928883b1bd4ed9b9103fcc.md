# visual-owner-G085 — deterministic-link

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: reordered unit arguments produce byte-identical ELF

```text
Identity: owner:G085:G085-S04-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
deterministic-link
Owner: compiler/codegen/modules/x86_64/module_graph_codegen.asm
```
...
- compiler/codegen/modules/x86_64/module_graph_codegen.asm — SHA-256 a47e0808dd81f0188cdaa5c759158a5df6d380799b0f9d239c2de3c58d6fcf52
