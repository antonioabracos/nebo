# visual-owner-G085 — conditional

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Bool constant is consumed by conditional lowering

```text
Identity: owner:G085:G085-S07-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
conditional
Owner: compiler/lowering/x86_64/binding_vertical.asm
```
