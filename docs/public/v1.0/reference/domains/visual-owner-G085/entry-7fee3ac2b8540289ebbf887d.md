...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: failed module validation leaves output untouched

```text
Identity: owner:G085:G085-S04-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
atomic
Owner: compiler/semantic/module_const.asm::neboc_module_const_validate
```
...
- compiler/semantic/module_const.asm — SHA-256 1ed474ab35efe41a0e954cbd728e82790de1baf72b2440bebd28490d015ed975
