# visual-owner-G085 — PI

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: short uppercase spelling is ALL_CAPS

```text
Identity: owner:G085:G085-S01-03 (DOMAIN_CONTRACT_ID)
Edition: 1
