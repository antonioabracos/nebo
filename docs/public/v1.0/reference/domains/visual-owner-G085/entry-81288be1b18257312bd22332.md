# visual-owner-G085 — single-store

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: emitted program materializes the constant once

```text
Identity: owner:G085:G085-S03-08 (DOMAIN_CONTRACT_ID)
Edition: 1
