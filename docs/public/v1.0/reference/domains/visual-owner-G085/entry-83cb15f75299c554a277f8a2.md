# visual-owner-G085 — flow

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: flow ALL_CAPS classifies as preferred ConstBinding

```text
Identity: owner:G085:G085-S05-02 (DOMAIN_CONTRACT_ID)
Edition: 1
