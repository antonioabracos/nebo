# visual-owner-G085 — kind

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: resolved symbol kind is ConstBinding

```text
Identity: owner:G085:G085-S02-02 (DOMAIN_CONTRACT_ID)
Edition: 1
