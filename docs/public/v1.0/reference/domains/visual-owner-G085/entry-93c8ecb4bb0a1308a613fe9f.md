# visual-owner-G085 — spelling-id

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: different names yield different SymbolIds

```text
Identity: owner:G085:G085-S02-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
spelling-id
Owner: tests/rf204/G085/reference_oracle.py::stable_symbol_id
```
