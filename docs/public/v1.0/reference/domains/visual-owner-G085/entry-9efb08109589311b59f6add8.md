# visual-owner-G085 — leading-underscore

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: leading underscore is not ALL_CAPS

```text
Identity: owner:G085:G085-S01-06 (DOMAIN_CONTRACT_ID)
Edition: 1
