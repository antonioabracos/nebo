# visual-owner-G085 — scope-id

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: different lexical scopes yield different SymbolIds

```text
Identity: owner:G085:G085-S02-05 (DOMAIN_CONTRACT_ID)
Edition: 1
