# visual-owner-G085 — export

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ALL_CAPS export is admitted as a binding identity

```text
Identity: owner:G085:G085-S04-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
export
Owner: compiler/parser/module_parser.asm::mod_binding_identity
```
...
- compiler/parser/module_parser.asm — SHA-256 7ed7e5620b5196c982738948391e1f67deb49092d116c114af75e8ef43b5dac9
