# visual-owner-G085 — rename

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ALL_CAPS to ALL_CAPS rename produces a new stable symbol

```text
Identity: owner:G085:G085-S08-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
rename
Owner: compiler/lsp/const_binding.asm::neboc_lsp_const_rename
```
...
- compiler/lsp/const_binding.asm — SHA-256 d0f93b6f6cbb2bf4db0f033f51d398caedd79e65819700dcb3f41399b0802722
