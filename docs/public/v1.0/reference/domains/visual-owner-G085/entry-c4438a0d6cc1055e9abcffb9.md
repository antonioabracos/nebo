# visual-owner-G085 — noncaps

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ordinary names do not publish a ConstBinding record

```text
Identity: owner:G085:G085-S02-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
noncaps
Owner: compiler/semantic/const_binding.asm::neboc_const_symbol_resolve
```
...
- compiler/semantic/const_binding.asm — SHA-256 750ccf46707a69e7eb786e723a316dd8e58eef318c5e111d72285ac4b8a12a7c
