# visual-owner-G085 — native-abi

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: static x86-64 executable has no undefined symbols

```text
Identity: owner:G085:G085-S07-08 (DOMAIN_CONTRACT_ID)
Edition: 1
