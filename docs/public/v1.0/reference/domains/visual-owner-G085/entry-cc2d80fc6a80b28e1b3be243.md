# visual-owner-G085 — double-underscore

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: empty underscore segment is not ALL_CAPS

```text
Identity: owner:G085:G085-S01-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
double-underscore
Owner: compiler/semantic/name_style.asm::neboc_name_is_all_caps
```
