# visual-owner-G085 — atomic

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: invalid materialization leaves output untouched

```text
Identity: owner:G085:G085-S07-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
atomic
Owner: compiler/codegen/const_binding.asm::neboc_const_codegen_materialize
```
...
- compiler/codegen/const_binding.asm — SHA-256 98d2770557bf587153ccdab2931e431fd6da88839c39c5ecc56999c355993532
