# visual-owner-G085 — grammar

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: explicit const name type initializer and terminator are parsed

```text
Identity: owner:G085:G085-S05-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
grammar
Owner: compiler/parser/statements/statements.asm::neboc_statement_parse_const
```
