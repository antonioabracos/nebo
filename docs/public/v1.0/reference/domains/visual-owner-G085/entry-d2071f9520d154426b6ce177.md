# visual-owner-G085 — load

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: runtime loads the materialized value

```text
Identity: owner:G085:G085-S07-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
load
Owner: runtime/const_binding.asm::nebo_const_load
```
...
- runtime/const_binding.asm — SHA-256 d502e6ad2d63672752bf3a44b3044f449d78be9704aff1af7c1bfb579184c620
