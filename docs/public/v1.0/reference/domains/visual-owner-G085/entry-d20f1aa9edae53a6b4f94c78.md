# visual-owner-G085 — mutable

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ConstBinding mutable action is rejected

```text
Identity: owner:G085:G085-S06-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
mutable
Owner: compiler/semantic/const_binding.asm::neboc_const_validate_action
```
