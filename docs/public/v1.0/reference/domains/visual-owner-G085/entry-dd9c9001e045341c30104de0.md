# visual-owner-G085 — qualified-read

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: qualified ALL_CAPS reference resolves across units

```text
Identity: owner:G085:G085-S04-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
qualified-read
Owner: compiler/parser/module_parser.asm::mod_reference
```
