...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: failed initializer leaves output untouched

```text
Identity: owner:G085:G085-S03-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
atomic
Owner: compiler/lowering/const_binding.asm::neboc_const_lower_local
```
...
- compiler/lowering/const_binding.asm — SHA-256 f547737f805c097628fee1442bdd1a2cefea81196e436d70a4c57aedabd2db91
