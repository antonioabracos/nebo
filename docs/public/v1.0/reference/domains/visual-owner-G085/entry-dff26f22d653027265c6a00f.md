# visual-owner-G085 — shadow

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: visible equal spelling rejects shadowing

```text
Identity: owner:G085:G085-S06-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
shadow
Owner: compiler/semantic/const_binding.asm::neboc_const_check_visible_collision
```
