# visual-owner-G085 — symbol-id

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: lowered local retains stable SymbolId

```text
Identity: owner:G085:G085-S03-03 (DOMAIN_CONTRACT_ID)
Edition: 1
