# visual-owner-G085 — mixed-bindings

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: camel and Pascal bindings remain mutable while ALL_CAPS is constant

```text
Identity: owner:G085:G085-S01-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
mixed-bindings
Owner: compiler/semantic/bindings/binding_vertical.asm
```
