# visual-owner-G085 — invalid-class

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: unknown storage class is rejected

```text
Identity: owner:G085:G085-S07-04 (DOMAIN_CONTRACT_ID)
Edition: 1
