# visual-owner-G085 — rodata

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: module storage class is retained

```text
Identity: owner:G085:G085-S07-02 (DOMAIN_CONTRACT_ID)
Edition: 1
