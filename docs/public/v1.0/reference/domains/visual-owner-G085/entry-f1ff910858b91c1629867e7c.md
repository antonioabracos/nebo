# visual-owner-G085 — diagnostic-span

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: diagnostic retains exact start and end span

```text
Identity: owner:G085:G085-S08-05 (DOMAIN_CONTRACT_ID)
Edition: 1
