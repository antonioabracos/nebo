# visual-owner-G085 — initializer

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: local initializer callback runs exactly once

```text
Identity: owner:G085:G085-S03-01 (DOMAIN_CONTRACT_ID)
Edition: 1
