# visual-owner-G085 — compatibility

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: explicit const executable returns its source-derived value

```text
Identity: owner:G085:G085-S05-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
compatibility
Owner: compiler/codegen/x86_64/binding_vertical.asm
```
