# visual-owner-G085 — distinct

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: different spelling does not collide

```text
Identity: owner:G085:G085-S06-05 (DOMAIN_CONTRACT_ID)
Edition: 1
