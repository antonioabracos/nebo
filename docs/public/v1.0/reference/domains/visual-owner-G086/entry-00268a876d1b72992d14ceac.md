# visual-owner-G086 — argument-list

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: two argument nodes form one bounded list

```text
Identity: owner:G086:G086-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
