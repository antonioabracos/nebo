# visual-owner-G086 — node-count

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: subtree node totals are retained

```text
Identity: owner:G086:G086-S01-02 (DOMAIN_CONTRACT_ID)
Edition: 1
