# visual-owner-G086 — chain

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: two nested receiver-first factory calls compose

```text
Identity: owner:G086:G086-S02-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
chain
Owner: compiler/codegen/functions/x86_64/function_codegen.asm::fcg_emit_call_expr
```
