...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: nested add result reaches Console before exit 31

```text
Identity: owner:G086:G086-S01-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
execution
Owner: compiler/codegen/functions/x86_64/function_codegen.asm::fcg_emit_console_call
```
