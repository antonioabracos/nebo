# visual-owner-G086 — exactly-once

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: each successful evaluator runs once

```text
Identity: owner:G086:G086-S03-02 (DOMAIN_CONTRACT_ID)
Edition: 1
