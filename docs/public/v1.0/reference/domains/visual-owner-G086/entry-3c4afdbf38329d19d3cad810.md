# visual-owner-G086 — span

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: resolved option retains exact source span

```text
Identity: owner:G086:G086-S02-04 (DOMAIN_CONTRACT_ID)
Edition: 1
