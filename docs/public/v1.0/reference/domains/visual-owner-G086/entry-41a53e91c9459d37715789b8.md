# visual-owner-G086 — option-order

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: first factory call precedes second factory call

```text
Identity: owner:G086:G086-S03-06 (DOMAIN_CONTRACT_ID)
Edition: 1
