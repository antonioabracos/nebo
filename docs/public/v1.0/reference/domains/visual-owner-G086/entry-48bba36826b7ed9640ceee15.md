# visual-owner-G086 — depth

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: maximum nested-call depth is retained

```text
Identity: owner:G086:G086-S01-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
depth
Owner: compiler/parser/console_arguments.asm::neboc_console_argument_list_build
```
