# visual-owner-G086 — output-atomicity

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: failed evaluation leaves values untouched

```text
Identity: owner:G086:G086-S05-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
output-atomicity
Owner: compiler/lowering/console_calls.asm::neboc_console_options_evaluate
```
...
- compiler/lowering/console_calls.asm — SHA-256 64fec5e6ff640b184cba923e0cac6e97d99a5e17b3cf19333a729aa3dcb7efce
