# visual-owner-G086 — bool-option

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Bool value is admitted in ArgumentList

```text
Identity: owner:G086:G086-S04-06 (DOMAIN_CONTRACT_ID)
Edition: 1
