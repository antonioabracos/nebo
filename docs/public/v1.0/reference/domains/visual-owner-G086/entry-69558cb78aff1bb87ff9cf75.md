# visual-owner-G086 — argument-boundary

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: maximum per-factory argument count is accepted

```text
Identity: owner:G086:G086-S06-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
argument-boundary
Owner: compiler/parser/console_arguments.asm::neboc_console_budget_validate
```
...
- compiler/parser/console_arguments.asm — SHA-256 2bcf53055a08aab4172c7bdaa3bf42a6885fa9fd64ce2d550cc03bbb01b38174
