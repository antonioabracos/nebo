# visual-owner-G086 — bounded-chain

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: four nested calls consume real depth

```text
Identity: owner:G086:G086-S06-07 (DOMAIN_CONTRACT_ID)
Edition: 1
