# visual-owner-G086 — console-call

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receiver and ArgumentList form one ConsoleCall

```text
Identity: owner:G086:G086-S01-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
console-call
Owner: compiler/parser/console_call.asm::neboc_console_call_build
```
...
- compiler/parser/console_call.asm — SHA-256 960ffe9e63e0e7ae5523e6d1eacf40320c9708ad75017c8ec7f171ffbf22a5ba
