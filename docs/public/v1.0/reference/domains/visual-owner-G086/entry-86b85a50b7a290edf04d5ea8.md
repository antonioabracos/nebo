# visual-owner-G086 — proof

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: effect proof retains required and granted masks

```text
Identity: owner:G086:G086-S04-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
proof
Owner: compiler/semantic/console_effects.asm::neboc_console_option_effect_check
```
...
- compiler/semantic/console_effects.asm — SHA-256 a8ad0e9298de5b6be60bdbdbe49c7c85b9b77e195d8348da43bda44593f69e20
