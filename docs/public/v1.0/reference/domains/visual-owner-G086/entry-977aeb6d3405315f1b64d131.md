# visual-owner-G086 — metamorphic

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: changed factory input changes observed exit result

```text
Identity: owner:G086:G086-S08-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
metamorphic
Owner: tests/rf204/G086/cases/metamorphic-option.no
```
