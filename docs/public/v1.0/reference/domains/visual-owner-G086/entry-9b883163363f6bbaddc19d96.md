# visual-owner-G086 — call-span

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ConsoleCall retains exact full source span

```text
Identity: owner:G086:G086-S01-06 (DOMAIN_CONTRACT_ID)
Edition: 1
