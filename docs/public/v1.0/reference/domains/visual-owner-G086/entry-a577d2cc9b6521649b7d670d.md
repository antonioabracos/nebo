# visual-owner-G086 — composition

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: two Console calls publish independently

```text
Identity: owner:G086:G086-S08-05 (DOMAIN_CONTRACT_ID)
Edition: 1
