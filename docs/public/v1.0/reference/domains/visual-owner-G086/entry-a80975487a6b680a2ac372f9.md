...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: bounded-depth example reaches exit 36

```text
Identity: owner:G086:G086-S06-08 (DOMAIN_CONTRACT_ID)
Edition: 1
