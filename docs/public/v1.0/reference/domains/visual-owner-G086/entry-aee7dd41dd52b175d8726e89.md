# visual-owner-G086 — argument-count

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: resolved record retains two factory arguments

```text
Identity: owner:G086:G086-S02-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
argument-count
Owner: compiler/semantic/console_calls.asm::neboc_console_option_resolve
```
...
- compiler/semantic/console_calls.asm — SHA-256 0061d894015381e6849781ac57bc821c2ee8a65f7b0cfca3ee4d1a207a51cad8
