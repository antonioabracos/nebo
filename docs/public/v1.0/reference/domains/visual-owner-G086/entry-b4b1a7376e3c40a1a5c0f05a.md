# visual-owner-G086 — publish-last

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Console publication follows all option evaluation

```text
Identity: owner:G086:G086-S03-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
publish-last
Owner: tests/rf204/G086/validate.sh
```
