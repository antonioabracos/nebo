# visual-owner-G086 — options

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: call descriptor retains option values and count

```text
Identity: owner:G086:G086-S08-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
options
Owner: compiler/codegen/console_calls.asm::neboc_console_call_codegen
```
...
- compiler/codegen/console_calls.asm — SHA-256 d832aaad215c725e973e64a441b31ac581314b67131440aa83ae543c2938857e
