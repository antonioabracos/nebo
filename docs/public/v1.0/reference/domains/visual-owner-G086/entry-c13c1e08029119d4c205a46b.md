# visual-owner-G086 — nested-argument

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: general Pratt call expression parses inside console arguments

```text
Identity: owner:G086:G086-S01-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
nested-argument
Owner: compiler/parser/expression/pratt.asm::neboc_parse_call_suffix
```
