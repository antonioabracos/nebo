# visual-owner-G086 — pure

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: pure option requires no capability

```text
Identity: owner:G086:G086-S04-01 (DOMAIN_CONTRACT_ID)
Edition: 1
