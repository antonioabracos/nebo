# visual-owner-G086 — invocation-bound

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: bounded invocation proof is retained

```text
Identity: owner:G086:G086-S07-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
invocation-bound
Owner: compiler/semantic/console_calls.asm::neboc_console_factory_validate
```
