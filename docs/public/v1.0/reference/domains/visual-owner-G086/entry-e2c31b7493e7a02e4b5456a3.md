# visual-owner-G086 — factory-function

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: factory descriptor requires a callable function

```text
Identity: owner:G086:G086-S07-01 (DOMAIN_CONTRACT_ID)
Edition: 1
