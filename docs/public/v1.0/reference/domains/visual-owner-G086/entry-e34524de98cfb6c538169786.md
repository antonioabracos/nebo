# visual-owner-G086 — receiver

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: call descriptor retains receiver value

```text
Identity: owner:G086:G086-S08-02 (DOMAIN_CONTRACT_ID)
Edition: 1
