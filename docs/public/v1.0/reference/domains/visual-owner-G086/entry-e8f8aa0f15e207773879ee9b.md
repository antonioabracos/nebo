# visual-owner-G086 — unbounded-rejection

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: zero or excessive bounds fail atomically

```text
Identity: owner:G086:G086-S07-05 (DOMAIN_CONTRACT_ID)
Edition: 1
