...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Serialization path reaches source-derived exit 109

```text
Identity: owner:G087:G087-S08-08 (DOMAIN_CONTRACT_ID)
Edition: 1
