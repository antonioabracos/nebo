# visual-owner-G087 — blue

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: blue returns the logical blue byte

```text
Identity: owner:G087:G087-S06-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
blue
Owner: runtime/color.asm::nebo_color_blue
```
