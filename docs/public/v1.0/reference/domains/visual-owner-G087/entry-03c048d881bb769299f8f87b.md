# visual-owner-G087 — immutable

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color descriptor declares immutable value semantics

```text
Identity: owner:G087:G087-S01-04 (DOMAIN_CONTRACT_ID)
Edition: 1
