# visual-owner-G087 — invalid

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Invalid literal digits fail closed

```text
Identity: owner:G087:G087-S03-04 (DOMAIN_CONTRACT_ID)
Edition: 1
