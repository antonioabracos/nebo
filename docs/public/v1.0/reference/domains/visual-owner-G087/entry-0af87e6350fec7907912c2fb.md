# visual-owner-G087 — lower

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: G087 family payload lowers to a static probe call

```text
Identity: owner:G087:G087-S10-05 (DOMAIN_CONTRACT_ID)
Edition: 1
