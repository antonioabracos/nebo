# visual-owner-G087 — hex-diagnostic

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Invalid hex diagnostic retains the invalid byte span

```text
Identity: owner:G087:G087-S09-03 (DOMAIN_CONTRACT_ID)
Edition: 1
