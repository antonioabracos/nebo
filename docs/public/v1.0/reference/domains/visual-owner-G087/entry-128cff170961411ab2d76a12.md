# visual-owner-G087 — red

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: red returns the logical red byte

```text
Identity: owner:G087:G087-S06-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
red
Owner: runtime/color.asm::nebo_color_red
```
