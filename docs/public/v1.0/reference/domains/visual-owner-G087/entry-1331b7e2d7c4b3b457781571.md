...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ASM ELF oracle and diagnostics are reproducible

```text
Identity: owner:G087:G087-S10-07 (DOMAIN_CONTRACT_ID)
Edition: 1
