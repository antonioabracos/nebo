# visual-owner-G087 — range

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: A channel above 255 is rejected

```text
Identity: owner:G087:G087-S02-03 (DOMAIN_CONTRACT_ID)
Edition: 1
