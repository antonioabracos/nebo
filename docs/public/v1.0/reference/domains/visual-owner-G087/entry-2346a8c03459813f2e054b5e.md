# visual-owner-G087 — equality

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color equality compares the complete logical value

```text
Identity: owner:G087:G087-S06-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
equality
Owner: runtime/color.asm::nebo_color_equal
```
