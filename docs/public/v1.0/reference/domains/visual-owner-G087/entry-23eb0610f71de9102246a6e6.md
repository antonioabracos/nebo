...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Property path reaches source-derived exit 127

```text
Identity: owner:G087:G087-S09-08 (DOMAIN_CONTRACT_ID)
Edition: 1
