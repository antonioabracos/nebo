...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Literal path reaches source-derived exit 41

```text
Identity: owner:G087:G087-S03-08 (DOMAIN_CONTRACT_ID)
Edition: 1
