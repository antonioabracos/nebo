# visual-owner-G087 — case

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Hexadecimal letters accept either case

```text
Identity: owner:G087:G087-S03-03 (DOMAIN_CONTRACT_ID)
Edition: 1
