# visual-owner-G087 — rgba-sugar

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color(r,g,b,a) lowers to checked Color.rgba

```text
Identity: owner:G087:G087-S05-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
rgba-sugar
Owner: compiler/lowering/color.asm::neboc_color_sugar_lower
```
...
- compiler/lowering/color.asm — SHA-256 1be0f3106d92371ad5a17d1070f52d05c26741b5c07c963a436c25f751ce73ee
