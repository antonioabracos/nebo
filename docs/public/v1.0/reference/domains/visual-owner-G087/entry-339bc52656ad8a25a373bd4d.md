# visual-owner-G087 — compile-time

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color.hex requires canonical TextLiteral spelling

```text
Identity: owner:G087:G087-S03-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
compile-time
Owner: compiler/codegen/collections/x86_64/color_public_codegen.inc::g87_validate_hex_literal
```
