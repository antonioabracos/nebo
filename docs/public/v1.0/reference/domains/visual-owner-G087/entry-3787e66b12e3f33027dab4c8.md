# visual-owner-G087 — mapping

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Headless ANSI256 truecolor and live mappings are factual

```text
Identity: owner:G087:G087-S07-07 (DOMAIN_CONTRACT_ID)
Edition: 1
