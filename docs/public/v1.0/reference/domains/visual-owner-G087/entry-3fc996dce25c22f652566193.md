# visual-owner-G087 — dynamic-invalid

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Malformed dynamic Text remains a valid Result-producing program

```text
Identity: owner:G087:G087-S04-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
dynamic-invalid
Owner: tests/rf204/G087/cases/dynamic-invalid.no
```
