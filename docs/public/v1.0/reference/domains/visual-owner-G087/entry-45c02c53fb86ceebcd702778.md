...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Rejected construction leaves output untouched

```text
Identity: owner:G087:G087-S02-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
atomicity
Owner: tests/rf116/g87/rf116-g87-f02.asm
```
...
- tests/rf116/g87/rf116-g87-f02.asm — SHA-256 724ca359fb308b6ea54218bdc933c3c8133058306ea1e4057baca1e3a8d35b0d
