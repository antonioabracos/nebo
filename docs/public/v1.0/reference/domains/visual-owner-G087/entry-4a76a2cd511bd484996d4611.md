# visual-owner-G087 — rgba-shape

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Public RGBA arity and Int types are checked

```text
Identity: owner:G087:G087-S02-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
rgba-shape
Owner: compiler/codegen/collections/x86_64/color_public_codegen.inc
```
