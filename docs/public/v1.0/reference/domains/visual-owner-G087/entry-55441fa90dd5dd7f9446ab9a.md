# visual-owner-G087 — rgb-sugar

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Public three-argument constructor is shape checked

```text
Identity: owner:G087:G087-S05-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
rgb-sugar
Owner: compiler/codegen/collections/x86_64/color_public_codegen.inc::g87_validate_direct
```
...
- compiler/codegen/collections/x86_64/color_public_codegen.inc — SHA-256 617d03e20ab753d4dcc593e11865e9f35b12fd479a1dea8d0307f3d91307185e
