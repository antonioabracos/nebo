# visual-owner-G087 — index

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Parse error records the first invalid byte index

```text
Identity: owner:G087:G087-S04-03 (DOMAIN_CONTRACT_ID)
Edition: 1
