# visual-owner-G087 — alpha

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: alpha returns the logical alpha byte

```text
Identity: owner:G087:G087-S06-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
alpha
Owner: runtime/color.asm::nebo_color_alpha
```
