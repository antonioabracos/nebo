# visual-owner-G087 — hash-diversity

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Changed channels change the hash under the oracle

```text
Identity: owner:G087:G087-S06-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
hash-diversity
Owner: tests/rf204/G087/reference_oracle.py::fnv1a
```
