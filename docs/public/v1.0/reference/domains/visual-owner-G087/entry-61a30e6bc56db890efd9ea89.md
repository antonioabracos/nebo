...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color(r,g,b) lowers to checked Color.rgb

```text
Identity: owner:G087:G087-S05-01 (DOMAIN_CONTRACT_ID)
Edition: 1
