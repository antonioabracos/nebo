# visual-owner-G087 — result

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color.parseHex returns a consumed Result value

```text
Identity: owner:G087:G087-S04-05 (DOMAIN_CONTRACT_ID)
Edition: 1
