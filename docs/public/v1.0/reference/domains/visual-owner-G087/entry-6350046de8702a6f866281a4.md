# visual-owner-G087 — rgb-literal

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Six-digit literal receives opaque alpha

```text
Identity: owner:G087:G087-S03-01 (DOMAIN_CONTRACT_ID)
Edition: 1
