...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Serialize then parse round-trip preserves Color

```text
Identity: owner:G087:G087-S04-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
parse
Owner: runtime/g087_source_probe.asm::g87_make_roundtrip_text
```
