# visual-owner-G087 — green

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: green returns the logical green byte

```text
Identity: owner:G087:G087-S06-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
green
Owner: runtime/color.asm::nebo_color_green
```
