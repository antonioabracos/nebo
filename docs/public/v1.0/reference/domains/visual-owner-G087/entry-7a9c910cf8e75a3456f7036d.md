# visual-owner-G087 — ansi

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ANSI target rejects nonopaque Color atomically

```text
Identity: owner:G087:G087-S07-06 (DOMAIN_CONTRACT_ID)
Edition: 1
