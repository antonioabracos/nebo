# visual-owner-G087 — tri-mode

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Eight invalid sources fail in check emit-asm and build

```text
Identity: owner:G087:G087-S09-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
tri-mode
Owner: tests/rf204/G087/validate.sh
```
