# visual-owner-G087 — alpha-range

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: withAlpha rejects values outside u8 range

```text
Identity: owner:G087:G087-S07-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
alpha-range
Owner: runtime/color.asm::nebo_color_with_alpha
```
