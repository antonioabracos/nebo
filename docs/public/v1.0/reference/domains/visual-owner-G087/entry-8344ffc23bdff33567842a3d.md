# visual-owner-G087 — rgb

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color.rgb packs three checked channels with alpha 255

```text
Identity: owner:G087:G087-S02-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
rgb
Owner: runtime/color.asm::nebo_color_rgb_lowering
```
