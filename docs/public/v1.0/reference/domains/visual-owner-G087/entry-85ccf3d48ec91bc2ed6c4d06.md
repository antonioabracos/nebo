# visual-owner-G087 — opaque

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: isOpaque reflects exactly alpha 255

```text
Identity: owner:G087:G087-S07-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
opaque
Owner: runtime/color.asm::nebo_color_is_opaque
```
