# visual-owner-G087 — headless

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Headless target accepts alpha with capability

```text
Identity: owner:G087:G087-S07-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
headless
Owner: runtime/color_target.asm::nebo_color_target_validate
```
