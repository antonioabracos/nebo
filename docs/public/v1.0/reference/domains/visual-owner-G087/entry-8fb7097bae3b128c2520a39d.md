# visual-owner-G087 — runtime

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Static executable reaches canonical Color owners

```text
Identity: owner:G087:G087-S10-06 (DOMAIN_CONTRACT_ID)
Edition: 1
