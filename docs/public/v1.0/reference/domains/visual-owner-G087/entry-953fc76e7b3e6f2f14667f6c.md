# visual-owner-G087 — to-hex

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: toHex emits canonical uppercase #RRGGBB

```text
Identity: owner:G087:G087-S08-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
to-hex
Owner: runtime/color.asm::nebo_color_to_hex
```
