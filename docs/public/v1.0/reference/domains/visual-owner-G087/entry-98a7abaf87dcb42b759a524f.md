# visual-owner-G087 — differential

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Thirty-two independent RGBA round-trips agree

```text
Identity: owner:G087:G087-S09-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
differential
Owner: tests/rf204/G087/reference_oracle.py
```
