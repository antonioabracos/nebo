...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Public four-argument constructor is shape checked

```text
Identity: owner:G087:G087-S05-06 (DOMAIN_CONTRACT_ID)
Edition: 1
