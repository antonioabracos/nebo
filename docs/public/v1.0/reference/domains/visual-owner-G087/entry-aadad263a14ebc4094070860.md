...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Invalid literal leaves destination untouched

```text
Identity: owner:G087:G087-S03-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
atomicity
Owner: tests/rf116/g87/rf116-g87-f03.asm
```
...
- tests/rf116/g87/rf116-g87-f03.asm — SHA-256 0afa5e50e793093c57b1ef7645640a0bd31ace2d890c9c386e3eb8be71625a3f
