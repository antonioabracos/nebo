# visual-owner-G087 — copy

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color copy preserves the complete logical value

```text
Identity: owner:G087:G087-S01-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
copy
Owner: runtime/color.asm::nebo_color_copy
```
