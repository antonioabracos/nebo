# visual-owner-G087 — length

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Noncanonical literal length is rejected in all modes

```text
Identity: owner:G087:G087-S03-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
length
Owner: tests/rf204/G087/cases/invalid-hex-length.no
```
