# visual-owner-G087 — lowering

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Checked Color value reaches codegen descriptor

```text
Identity: owner:G087:G087-S10-01 (DOMAIN_CONTRACT_ID)
Edition: 1
