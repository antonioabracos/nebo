# visual-owner-G087 — effect

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Constructor sugar path reaches source-derived exit 67

```text
Identity: owner:G087:G087-S05-08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
effect
Owner: runtime/console/document/public_color_bridge.inc::nebo_runtime_color_public_call
```
...
- runtime/console/document/public_color_bridge.inc — SHA-256 dd8368e5ad963d82f807d63167170f4962a64a7c922f10cc369fe11e6376f569
