# visual-owner-G087 — oracle

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Wrong expected output is rejected by the oracle

```text
Identity: owner:G087:G087-S09-07 (DOMAIN_CONTRACT_ID)
Edition: 1
