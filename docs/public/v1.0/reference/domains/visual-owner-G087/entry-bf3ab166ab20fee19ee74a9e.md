# visual-owner-G087 — with-alpha

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: withAlpha returns a checked modified copy

```text
Identity: owner:G087:G087-S07-01 (DOMAIN_CONTRACT_ID)
Edition: 1
