# visual-owner-G087 — parse

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Canonical lexer tokens select the G087 owner

```text
Identity: owner:G087:G087-S10-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
parse
Owner: compiler/codegen/collections/x86_64/color_public_codegen.inc::neboc_g087_source_parse
```
