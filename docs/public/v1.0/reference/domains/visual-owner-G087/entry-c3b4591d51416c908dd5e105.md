# visual-owner-G087 — roundtrip

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Native constructor serialize parse equality path agrees

```text
Identity: owner:G087:G087-S09-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
roundtrip
Owner: tests/rf116/g87/rf116-g87-f09.asm
```
...
- tests/rf116/g87/rf116-g87-f09.asm — SHA-256 66ec801d3bba55ded9ee20e4bebe78b911365f92b8cb509ca77a0aba35b937a7
