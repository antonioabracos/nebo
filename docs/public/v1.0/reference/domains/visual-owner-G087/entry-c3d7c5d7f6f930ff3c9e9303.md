# visual-owner-G087 — size

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color ABI size is four bytes

```text
Identity: owner:G087:G087-S01-02 (DOMAIN_CONTRACT_ID)
Edition: 1
