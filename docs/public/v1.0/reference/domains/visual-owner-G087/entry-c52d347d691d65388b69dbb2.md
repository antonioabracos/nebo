# visual-owner-G087 — input

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Changing red changes canonical Text

```text
Identity: owner:G087:G087-S08-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
input
Owner: tests/rf204/G087/reference_oracle.py::to_hex
```
