# visual-owner-G087 — rgba

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color.rgba packs four checked unpremultiplied channels

```text
Identity: owner:G087:G087-S02-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
rgba
Owner: runtime/color.asm::nebo_color_rgba_lowering
```
