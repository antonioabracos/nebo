# visual-owner-G087 — u8

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Inclusive channel bounds 0 and 255 compile and run

```text
Identity: owner:G087:G087-S02-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
u8
Owner: tests/rf204/G087/cases/boundary-color.no
```
