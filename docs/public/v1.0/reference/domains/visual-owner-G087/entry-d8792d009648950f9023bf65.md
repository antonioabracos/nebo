# visual-owner-G087 — rgb-shape

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Public RGB arity and Int types are checked

```text
Identity: owner:G087:G087-S02-05 (DOMAIN_CONTRACT_ID)
Edition: 1
