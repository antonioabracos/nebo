# visual-owner-G087 — target

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Codegen retains selected target and capabilities

```text
Identity: owner:G087:G087-S10-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
target
Owner: compiler/codegen/color.asm::neboc_color_codegen
```
...
- compiler/codegen/color.asm — SHA-256 31be52e84f04a8c53e654c2d28065cc7721c1b94cbc87d3b1b39b40227131343
