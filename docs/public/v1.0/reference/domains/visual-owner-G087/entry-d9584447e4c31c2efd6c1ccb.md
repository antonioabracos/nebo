# visual-owner-G087 — to-hex-alpha

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: toHexWithAlpha emits canonical uppercase #RRGGBBAA

```text
Identity: owner:G087:G087-S08-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
to-hex-alpha
Owner: runtime/color.asm::nebo_color_to_hex_with_alpha
```
...
- runtime/color.asm — SHA-256 4d57e616eabc364487419eaa64191735fbb4d26b12150db15866a92b7b735671
