# visual-owner-G087 — rgba-literal

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Eight-digit literal preserves explicit alpha

```text
Identity: owner:G087:G087-S03-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
rgba-literal
Owner: runtime/color.asm::nebo_color_hex_literal
```
