# visual-owner-G087 — channel-diagnostic

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Out-of-range channel maps to stable Color diagnostic

```text
Identity: owner:G087:G087-S09-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
channel-diagnostic
Owner: compiler/diagnostics/p01.asm::neboc_diag_from_color_status
```
...
- compiler/diagnostics/p01.asm — SHA-256 56050e5a687984beb8384a3e77026b5e4cd5b7b0bc5302bb418dee429a16c83a
