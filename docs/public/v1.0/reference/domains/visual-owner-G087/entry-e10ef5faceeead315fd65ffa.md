# visual-owner-G087 — hash

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Equal Colors have equal stable FNV-1a hashes

```text
Identity: owner:G087:G087-S06-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
hash
Owner: runtime/color.asm::nebo_color_hash
```
