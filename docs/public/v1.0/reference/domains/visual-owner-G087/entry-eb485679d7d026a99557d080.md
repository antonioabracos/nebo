# visual-owner-G087 — error

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Malformed dynamic Text returns Result error

```text
Identity: owner:G087:G087-S04-02 (DOMAIN_CONTRACT_ID)
Edition: 1
