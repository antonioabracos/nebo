# visual-owner-G087 — text-sugar

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color(TextLiteral) lowers to Color.hex

```text
Identity: owner:G087:G087-S05-03 (DOMAIN_CONTRACT_ID)
Edition: 1
