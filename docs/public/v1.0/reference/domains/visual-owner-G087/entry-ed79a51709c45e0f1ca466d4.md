...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: RGBA Text round-trip preserves all channels

```text
Identity: owner:G087:G087-S08-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
roundtrip
Owner: runtime/g087_source_probe.asm::g87_property_roundtrip
```
