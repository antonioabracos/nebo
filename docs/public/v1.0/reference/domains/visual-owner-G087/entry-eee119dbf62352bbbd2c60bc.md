# visual-owner-G087 — alpha-atomicity

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Rejected alpha leaves destination untouched

```text
Identity: owner:G087:G087-S07-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
alpha-atomicity
Owner: tests/rf116/g87/rf116-g87-f07.asm
```
...
- tests/rf116/g87/rf116-g87-f07.asm — SHA-256 0ab333d740912221bc9bc7d3f5ae523a9aa027937b3f8cd8dc30f3a44c860a96
