# visual-owner-G087 — srgb

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color descriptor declares the sRGB space

```text
Identity: owner:G087:G087-S01-06 (DOMAIN_CONTRACT_ID)
Edition: 1
