...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Codegen retains nominal Color type identity

```text
Identity: owner:G087:G087-S10-02 (DOMAIN_CONTRACT_ID)
Edition: 1
