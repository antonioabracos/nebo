...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Explicit alpha() source terminal reaches exit 7

```text
Identity: owner:G087:G087-S02-08 (DOMAIN_CONTRACT_ID)
Edition: 1
