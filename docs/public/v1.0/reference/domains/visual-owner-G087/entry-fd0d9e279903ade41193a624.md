...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Source-derived red channel reaches exit 17

```text
Identity: owner:G087:G087-S01-08 (DOMAIN_CONTRACT_ID)
Edition: 1
