# visual-owner-G087 — atomicity

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Capacity failure leaves output bytes untouched

```text
Identity: owner:G087:G087-S08-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
atomicity
Owner: tests/rf116/g87/rf116-g87-f08.asm
```
...
- tests/rf116/g87/rf116-g87-f08.asm — SHA-256 10205cccc322c11faf93eade15a066f5e5e6fc11bcdc1d991311ced8eeddf8bf
