# visual-owner-G088 — target-determinism

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Repeated target mappings are identical

```text
Identity: owner:G088:G088-S08-07 (DOMAIN_CONTRACT_ID)
Edition: 1
