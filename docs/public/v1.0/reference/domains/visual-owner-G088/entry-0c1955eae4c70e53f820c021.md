# visual-owner-G088 — index

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: colorBy index is a normalized explicit kind

```text
Identity: owner:G088:G088-S05-01 (DOMAIN_CONTRACT_ID)
Edition: 1
