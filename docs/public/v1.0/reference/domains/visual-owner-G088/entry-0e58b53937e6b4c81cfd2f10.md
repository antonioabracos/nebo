# visual-owner-G088 — typed-fg

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Typed Color foreground retains role and value

```text
Identity: owner:G088:G088-S01-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
typed-fg
Owner: compiler/semantic/color_options.asm::neboc_color_option_typecheck
```
...
- compiler/semantic/color_options.asm — SHA-256 f250a806153caadee5b485a9eb9863720002a7910175b432c2f89b88bbd9cfe8
