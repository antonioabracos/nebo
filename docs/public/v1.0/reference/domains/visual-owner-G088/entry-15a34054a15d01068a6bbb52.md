# visual-owner-G088 — colorby-type

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Public colorBy requires a controlled Text token

```text
Identity: owner:G088:G088-S05-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
colorby-type
Owner: tests/rf204/G088/cases/invalid-color-by-type.no
```
