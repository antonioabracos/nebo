# visual-owner-G088 — semantic-parse

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Token method shapes and boundaries are checked

```text
Identity: owner:G088:G088-S09-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
semantic-parse
Owner: compiler/semantic/visual/g088_source_vertical.inc::neboc_g088_source_parse
```
