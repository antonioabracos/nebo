# visual-owner-G088 — accent-token

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Present accent token resolves its Color

```text
Identity: owner:G088:G088-S04-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
accent-token
Owner: tests/rf204/G088/reference_oracle.py::resolve_theme
```
