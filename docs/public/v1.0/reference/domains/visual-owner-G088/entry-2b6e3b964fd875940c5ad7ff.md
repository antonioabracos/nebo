# visual-owner-G088 — accent-fallback

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Absent accent deterministically falls back to foreground

```text
Identity: owner:G088:G088-S04-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
accent-fallback
Owner: runtime/color_theme.asm::nebo_theme_resolve
```
...
- runtime/color_theme.asm — SHA-256 5d208143ba8a8e7f142f5ced631d9190a8d5a36b220041e35e26affee56aad19
