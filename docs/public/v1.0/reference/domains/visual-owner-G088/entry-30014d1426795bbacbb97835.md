# visual-owner-G088 — ansi256

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ANSI256 maps through deterministic six-level cube

```text
Identity: owner:G088:G088-S08-04 (DOMAIN_CONTRACT_ID)
Edition: 1
