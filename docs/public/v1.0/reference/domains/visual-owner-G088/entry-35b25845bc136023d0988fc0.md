# visual-owner-G088 — unknown-role

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Unknown role methods fail closed

```text
Identity: owner:G088:G088-S02-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
unknown-role
Owner: tests/rf204/G088/cases/unknown-role-method.no
```
