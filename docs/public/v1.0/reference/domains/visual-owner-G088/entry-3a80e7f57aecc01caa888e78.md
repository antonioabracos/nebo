# visual-owner-G088 — u16-boundary

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Linear endpoints 0 and 65535 are inclusive

```text
Identity: owner:G088:G088-S07-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
u16-boundary
Owner: tests/rf204/G088/cases/boundary-color-space.no
```
