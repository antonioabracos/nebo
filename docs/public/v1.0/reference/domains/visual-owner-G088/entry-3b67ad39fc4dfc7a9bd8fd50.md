# visual-owner-G088 — preferred

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Accessible preferred Color is retained

```text
Identity: owner:G088:G088-S06-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
preferred
Owner: runtime/color_accessibility.asm::nebo_color_pick_accessible
```
...
- runtime/color_accessibility.asm — SHA-256 0f2207fa6d8f5586d81590c96e56ae528b9f97eeace1021578f0a89439185e8b
