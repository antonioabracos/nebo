# visual-owner-G088 — capability

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Headless and live alpha require explicit capability

```text
Identity: owner:G088:G088-S08-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
capability
Owner: tests/rf204/G088/reference_oracle.py::map_target
```
