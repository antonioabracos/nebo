# visual-owner-G088 — threshold-limit

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Contrast threshold is bounded at 255

```text
Identity: owner:G088:G088-S06-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
threshold-limit
Owner: tests/rf204/G088/cases/invalid-contrast-threshold.no
```
