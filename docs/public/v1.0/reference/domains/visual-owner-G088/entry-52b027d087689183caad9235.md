# visual-owner-G088 — live

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Live mapping preserves RGBA with capability

```text
Identity: owner:G088:G088-S08-02 (DOMAIN_CONTRACT_ID)
Edition: 1
