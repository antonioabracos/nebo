...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Named palette lookup reaches source red at exit 41

```text
Identity: owner:G088:G088-S03-08 (DOMAIN_CONTRACT_ID)
Edition: 1
