# visual-owner-G088 — duplicate

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Duplicate names are rejected

```text
Identity: owner:G088:G088-S03-03 (DOMAIN_CONTRACT_ID)
Edition: 1
