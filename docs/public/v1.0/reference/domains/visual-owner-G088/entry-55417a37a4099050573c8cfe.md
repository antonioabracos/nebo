# visual-owner-G088 — fallback

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Accessible fallback Color is selected deterministically

```text
Identity: owner:G088:G088-S06-06 (DOMAIN_CONTRACT_ID)
Edition: 1
