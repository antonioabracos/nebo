# visual-owner-G088 — lookup

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Lookup returns the matched named Color

```text
Identity: owner:G088:G088-S03-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
lookup
Owner: runtime/color_palette.asm::nebo_palette_lookup
```
...
- runtime/color_palette.asm — SHA-256 58d215a30f3721a0350c5ba08f9402cc5da27c71db773aaf100ea13909287092
