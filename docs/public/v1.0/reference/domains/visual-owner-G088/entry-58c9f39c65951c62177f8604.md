# visual-owner-G088 — ansi-truecolor

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ANSI truecolor maps to factual RGB payload

```text
Identity: owner:G088:G088-S08-03 (DOMAIN_CONTRACT_ID)
Edition: 1
