# visual-owner-G088 — border-token

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Theme border token is bounded and typed

```text
Identity: owner:G088:G088-S04-05 (DOMAIN_CONTRACT_ID)
Edition: 1
