# visual-owner-G088 — oracle

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Independent policy model rejects deliberately wrong output

```text
Identity: owner:G088:G088-S09-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
oracle
Owner: tests/rf204/G088/reference_oracle.py
```
