# visual-owner-G088 — background-token

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Theme background token resolves its Color

```text
Identity: owner:G088:G088-S04-02 (DOMAIN_CONTRACT_ID)
Edition: 1
