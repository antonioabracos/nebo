# visual-owner-G088 — luma

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Integer luma uses deterministic 299 587 114 weights

```text
Identity: owner:G088:G088-S06-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
luma
Owner: runtime/color_accessibility.asm::nebo_color_luma8
```
