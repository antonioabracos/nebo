# visual-owner-G088 — gray8

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Gray8 requires unused color channels to be zero

```text
Identity: owner:G088:G088-S07-02 (DOMAIN_CONTRACT_ID)
Edition: 1
