# visual-owner-G088 — entry-limit

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Palette length is bounded at 256 entries

```text
Identity: owner:G088:G088-S03-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
entry-limit
Owner: tests/rf204/G088/reference_oracle.py::validate_palette
```
