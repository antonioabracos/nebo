# visual-owner-G088 — bool-type

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Boolean is not accepted as a Color or integer channel

```text
Identity: owner:G088:G088-S01-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
bool-type
Owner: tests/rf204/G088/cases/invalid-fg-type.no
```
