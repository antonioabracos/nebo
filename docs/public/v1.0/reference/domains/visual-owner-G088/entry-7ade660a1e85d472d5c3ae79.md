# visual-owner-G088 — position-limit

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Stop positions are bounded at 65535

```text
Identity: owner:G088:G088-S05-05 (DOMAIN_CONTRACT_ID)
Edition: 1
