# visual-owner-G088 — value

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: colorBy value is a normalized explicit kind

```text
Identity: owner:G088:G088-S05-02 (DOMAIN_CONTRACT_ID)
Edition: 1
