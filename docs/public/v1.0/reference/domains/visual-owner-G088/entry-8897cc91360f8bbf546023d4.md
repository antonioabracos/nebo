# visual-owner-G088 — theme-type

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Non-Text public theme selector is rejected

```text
Identity: owner:G088:G088-S04-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
theme-type
Owner: tests/rf204/G088/cases/invalid-theme-type.no
```
