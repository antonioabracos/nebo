# visual-owner-G088 — lowering

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Family mode and source seed lower to static x86-64

```text
Identity: owner:G088:G088-S09-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
lowering
Owner: compiler/codegen/collections/x86_64/array_codegen.asm
```
...
- compiler/codegen/collections/x86_64/array_codegen.asm — SHA-256 0ffb7e8e2b0ac776fa38cdd69b5dcbff7236ad4c82d01ec06cbb8c3d78e6fde2
