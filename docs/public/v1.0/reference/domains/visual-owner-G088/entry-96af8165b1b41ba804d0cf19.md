# visual-owner-G088 — source-owner

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Color roots and role witnesses select only G088

```text
Identity: owner:G088:G088-S09-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
source-owner
Owner: compiler/driver/cli/linux-x86_64/cli_driver.asm::cli_tokens_contain_g088_atom
```
