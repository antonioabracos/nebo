# visual-owner-G088 — series

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Series semantic role is nominal

```text
Identity: owner:G088:G088-S02-06 (DOMAIN_CONTRACT_ID)
Edition: 1
