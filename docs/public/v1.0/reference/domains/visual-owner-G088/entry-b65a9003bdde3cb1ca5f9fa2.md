# visual-owner-G088 — category

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: colorBy category is a normalized explicit kind

```text
Identity: owner:G088:G088-S05-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
category
Owner: tests/rf204/G088/reference_oracle.py::normalize_colormap
```
