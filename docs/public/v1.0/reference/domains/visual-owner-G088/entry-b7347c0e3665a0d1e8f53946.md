# visual-owner-G088 — tri-mode-negative

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Invalid sources fail check emit-asm and build atomically

```text
Identity: owner:G088:G088-S09-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
tri-mode-negative
Owner: tests/rf204/G088/validate.sh::reject_source
```
