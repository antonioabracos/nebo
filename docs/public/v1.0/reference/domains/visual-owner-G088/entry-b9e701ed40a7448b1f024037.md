# visual-owner-G088 — stop-limit

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Colormaps contain from 2 through 256 stops

```text
Identity: owner:G088:G088-S05-06 (DOMAIN_CONTRACT_ID)
Edition: 1
