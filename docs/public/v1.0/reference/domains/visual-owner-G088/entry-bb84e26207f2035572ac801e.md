# visual-owner-G088 — not-found

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Unknown palette names return explicit failure

```text
Identity: owner:G088:G088-S03-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
not-found
Owner: tests/rf116/g88/rf116-g88-f03.asm
```
...
- tests/rf116/g88/rf116-g88-f03.asm — SHA-256 94fa54458d5c4fca3c5e115a9cc7ec7cf40bbc22b484d8bf158b7659e6797c65
