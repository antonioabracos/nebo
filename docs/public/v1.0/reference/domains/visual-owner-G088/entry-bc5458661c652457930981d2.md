# visual-owner-G088 — named

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Named entries retain Color identity

```text
Identity: owner:G088:G088-S03-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
named
Owner: runtime/color_palette.asm::nebo_palette_validate
```
