# visual-owner-G088 — arity

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Foreground arity is checked before lowering

```text
Identity: owner:G088:G088-S01-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
arity
Owner: tests/rf204/G088/cases/invalid-fg-arity.no
```
