# visual-owner-G088 — legacy-fg

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Three integer foreground channels normalize through Color.rgb

```text
Identity: owner:G088:G088-S01-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
legacy-fg
Owner: compiler/semantic/visual/g088_source_vertical.inc::g88_validate_role
```
