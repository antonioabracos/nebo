# visual-owner-G088 — metamorphic

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Changing the named Color changes the observed lookup

```text
Identity: owner:G088:G088-S03-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
metamorphic
Owner: tests/rf204/G088/cases/metamorphic-palette.no
```
