# visual-owner-G088 — u16-overflow

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: A linear channel of 65536 is rejected

```text
Identity: owner:G088:G088-S07-07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
u16-overflow
Owner: tests/rf204/G088/cases/invalid-linear-boundary.no
```
