# visual-owner-G088 — bare-color

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: A Color without a semantic role is rejected

```text
Identity: owner:G088:G088-S01-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
bare-color
Owner: tests/rf204/G088/cases/bare-color.no
```
