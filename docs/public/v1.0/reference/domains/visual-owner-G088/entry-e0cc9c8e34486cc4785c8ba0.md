# visual-owner-G088 — headless

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Headless mapping preserves RGBA with capability

```text
Identity: owner:G088:G088-S08-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
headless
Owner: runtime/color_target.asm::nebo_color_target_map
```
...
- runtime/color_target.asm — SHA-256 cce6db103882c43076191ed3f974050248e2593595991ce6468991e91c496bd2
