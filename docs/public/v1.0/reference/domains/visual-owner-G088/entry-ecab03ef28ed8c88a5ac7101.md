# visual-owner-G088 — background

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Background semantic role is nominal

```text
Identity: owner:G088:G088-S02-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
background
Owner: runtime/color_roles.asm::nebo_color_role_define
```
...
- runtime/color_roles.asm — SHA-256 b09bbf8cdddbdf0f822daaabf20f7bbd17f5e5418f7d6f46c02d56423ec70acd
