# visual-owner-G088 — name-limit

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Palette names are bounded at 64 UTF-8 bytes

```text
Identity: owner:G088:G088-S03-06 (DOMAIN_CONTRACT_ID)
Edition: 1
