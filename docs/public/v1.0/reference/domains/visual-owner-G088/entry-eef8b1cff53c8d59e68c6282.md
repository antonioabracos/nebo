# visual-owner-G088 — ordered

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Stop positions must be strictly increasing

```text
Identity: owner:G088:G088-S05-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ordered
Owner: runtime/colormap.asm::nebo_colormap_normalize
```
...
- runtime/colormap.asm — SHA-256 f853f2572d289d5d0e6d8fe1c0200e9a54d1a99c34e2b5ba4d4e0f7b4035f234
