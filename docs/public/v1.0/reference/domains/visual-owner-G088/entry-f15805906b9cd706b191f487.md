# visual-owner-G088 — linear16

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Linear sRGB16 accepts four bounded wide channels

```text
Identity: owner:G088:G088-S07-03 (DOMAIN_CONTRACT_ID)
Edition: 1
