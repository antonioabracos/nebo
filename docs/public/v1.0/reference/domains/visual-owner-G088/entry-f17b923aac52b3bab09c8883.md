# visual-owner-G088 — legacy-bg

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Three integer background channels normalize through Color.rgb

```text
Identity: owner:G088:G088-S01-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
legacy-bg
Owner: runtime/g088_source_probe.asm::nebo_g088_source_probe
```
