# visual-owner-G088 — selection

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Selection semantic role is nominal

```text
Identity: owner:G088:G088-S02-05 (DOMAIN_CONTRACT_ID)
Edition: 1
