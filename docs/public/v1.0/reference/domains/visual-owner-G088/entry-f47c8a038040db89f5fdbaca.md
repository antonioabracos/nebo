# visual-owner-G088 — u8-overflow

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: A channel of 256 is rejected

```text
Identity: owner:G088:G088-S07-06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
u8-overflow
Owner: tests/rf204/G088/cases/invalid-space-boundary.no
```
