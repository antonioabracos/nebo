# visual-owner-G088 — u8-boundary

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: sRGB8 endpoints 0 and 255 are inclusive

```text
Identity: owner:G088:G088-S07-04 (DOMAIN_CONTRACT_ID)
Edition: 1
