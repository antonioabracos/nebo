# visual-owner-G089 — nebo_console_options_default;nebo_console_option_model;nebo_console_registry

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: default/init/model and named registry preserve payload 29

```text
Identity: owner:G089:G089-F02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
nebo_console_options_default;nebo_console_option_model;nebo_console_registry
Owner: runtime/console_options.asm;runtime/console_option_registry.asm
```
...
- runtime/console_options.asm — SHA-256 42c1ee79b2ba1e1b255af54f222a363e155b3818f4fc0697e6e9bf4065c60790
