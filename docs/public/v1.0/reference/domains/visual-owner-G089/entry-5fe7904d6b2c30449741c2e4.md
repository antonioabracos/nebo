...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: validated terminal effect publishes one receipt carrying method 65

```text
Identity: owner:G089:G089-F05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/console_call.asm
```
...
- runtime/console_call.asm — SHA-256 9b45b63c9727573af26b1ba54cc4b9f9da89e266ca3257ab6ebb33c02a815b91
