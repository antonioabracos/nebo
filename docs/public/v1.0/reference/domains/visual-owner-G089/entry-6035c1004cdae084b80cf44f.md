# visual-owner-G089 — nebo_console_options_init

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receiver-first AST preserves ordered spans and returns 17

```text
Identity: owner:G089:G089-F01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: compiler/parser/console_call.asm;compiler/semantic/visual/g089_source_vertical.inc
```
