# visual-owner-G089 — nebo_console_options_default;nebo_console_options_init;nebo_console_options_validate;nebo_console_option_model;nebo_console_registry;nebo_console_render_plan_is_safe;kind:

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: composed normalization plan safety and receipt publish value 113

```text
Identity: owner:G089:G089-F09 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
nebo_console_options_default;nebo_console_options_init;nebo_console_options_validate;nebo_console_option_model;nebo_console_registry;nebo_console_render_plan_is_safe;kind:
Owner: runtime/p01_integration.asm;runtime/g089_source_probe.asm
```
...
- runtime/p01_integration.asm — SHA-256 1ff6249e7e073f8e5efbaac3502672e579a71893d6de51b978fee457cd6e200b
