# visual-owner-G089 — nebo_console_options_validate

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: normalization sorts kinds and publishes payload 41 only after validation

```text
Identity: owner:G089:G089-F03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/console_options.asm
```
