# visual-owner-G090 — ConsoleRenderable;ConsoleValue;ConsoleRenderResult

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: tabular dimensions and schema validate before count 13 is published

```text
Identity: owner:G090:G090-F04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ConsoleRenderable;ConsoleValue;ConsoleRenderResult
