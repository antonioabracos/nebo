# visual-owner-G090 — ConsoleRenderable;ConsoleRenderableKind

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: collection family publishes bounded count 41 without reflection

```text
Identity: owner:G090:G090-F03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ConsoleRenderable;ConsoleRenderableKind
