# visual-owner-G090 — ConsoleRenderable;ConsoleValue

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Text and Bytes buffer metadata publishes bounded count 29

```text
Identity: owner:G090:G090-F02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ConsoleRenderable;ConsoleValue
Owner: runtime/render_model.asm;runtime/g090_source_probe.asm
```
