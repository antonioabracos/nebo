...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: registry schema limits privacy atomicity and contextual value selector close GREEN

```text
Identity: owner:G090:G090-F08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/console_renderable.asm;runtime/g090_source_probe.asm
```
