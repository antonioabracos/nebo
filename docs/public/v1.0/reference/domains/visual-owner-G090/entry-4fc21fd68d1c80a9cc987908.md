# visual-owner-G090 — ConsoleRenderable;ConsoleRenderableKind;ConsoleValue;ConsoleRenderResult

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: media adapter publishes metadata extent 89 without raw payload disclosure

```text
Identity: owner:G090:G090-F07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ConsoleRenderable;ConsoleRenderableKind;ConsoleValue;ConsoleRenderResult
