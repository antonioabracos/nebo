# visual-owner-G090 — ConsoleRenderable;ConsoleRenderableKind;ConsoleValue

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: dynamic depth and sample bounds publish source-derived count 77

```text
Identity: owner:G090:G090-F06 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ConsoleRenderable;ConsoleRenderableKind;ConsoleValue
