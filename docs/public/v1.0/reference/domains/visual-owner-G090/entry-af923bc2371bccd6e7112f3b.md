# visual-owner-G090 — ConsoleRenderable;ConsoleRenderableKind;ConsoleRenderResult

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: numeric rank and element product validate before count 65 is published

```text
Identity: owner:G090:G090-F05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ConsoleRenderable;ConsoleRenderableKind;ConsoleRenderResult
Owner: runtime/render_model.asm;runtime/console_renderable.asm
```
...
- runtime/render_model.asm — SHA-256 489b7a476b1fc1f0ec54ce4d3021a2249948b6050327fb128882c4db4c67abc0

- runtime/console_renderable.asm — SHA-256 d05ff87b1b9b966782ac9b0c60a2e11db7bbea3d7a4c117c3cb49bb524fc2e91
