# visual-owner-G090 — ConsoleRenderable;ConsoleRenderableKind;ConsoleValue;ConsoleRenderResult;.value(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: closed scalar TypeId dispatch publishes source value 17

```text
Identity: owner:G090:G090-F01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
ConsoleRenderable;ConsoleRenderableKind;ConsoleValue;ConsoleRenderResult;.value(...)
