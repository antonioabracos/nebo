# visual-owner-G091 — .size(...);width:;height:

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: checked 29 by 1 cell size publishes width 29 and area 29

```text
Identity: owner:G091:G091-F02 (DOMAIN_CONTRACT_ID)
Edition: 1
