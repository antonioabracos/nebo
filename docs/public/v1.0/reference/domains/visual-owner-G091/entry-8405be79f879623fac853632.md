# visual-owner-G091 — .refresh(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: composed three-record headless document validates before refresh generation 125 is observed

```text
Identity: owner:G091:G091-F10 (DOMAIN_CONTRACT_ID)
Edition: 1
