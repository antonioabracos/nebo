# visual-owner-G091 — .viewport(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: explicit headless 1:1 target map publishes x coordinate 113

```text
Identity: owner:G091:G091-F09 (DOMAIN_CONTRACT_ID)
Edition: 1
