# visual-owner-G091 — .at(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: canonical x coordinate 17 is published without row/column inversion

```text
Identity: owner:G091:G091-F01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.at(...)
Owner: runtime/console_geometry.asm;runtime/g091_source_probe.asm
```
...
- runtime/console_geometry.asm — SHA-256 7fa774f261f4e9556a51e53b9aba7da3d62e1ca6ed411debec8c05eccda1e144
