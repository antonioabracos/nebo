# visual-owner-G091 — .panel(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: explicit parent and layer validation publishes panel identity 53

```text
Identity: owner:G091:G091-F04 (DOMAIN_CONTRACT_ID)
Edition: 1
