# visual-owner-G091 — .region(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: headless region identity 41 is ready without a live-window claim

```text
Identity: owner:G091:G091-F03 (DOMAIN_CONTRACT_ID)
Edition: 1
