...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: typed ANSI foreground preserves source-derived alpha byte 77 with explicit capability

```text
Identity: owner:G092:G092-F05 (DOMAIN_CONTRACT_ID)
Edition: 1
