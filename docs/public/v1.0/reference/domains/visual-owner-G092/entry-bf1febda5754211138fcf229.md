# visual-owner-G092 — .bold(...);.italic(...);.underline(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: validated decoration bitset 7 is published after all three methods are consumed

```text
Identity: owner:G092:G092-F01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/style_tokens.asm;runtime/g092_source_probe.asm
```
...
- runtime/style_tokens.asm — SHA-256 05f44338197032f0942b4b4c6b0d3fa34f8641dea67eb18d2319d7f1e3a1cf47
