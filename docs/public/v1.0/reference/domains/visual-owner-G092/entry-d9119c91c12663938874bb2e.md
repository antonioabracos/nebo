...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: noColor plus ASCII profile 5 disables color and masks unsupported effects

```text
Identity: owner:G092:G092-F07 (DOMAIN_CONTRACT_ID)
Edition: 1
