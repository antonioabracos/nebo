# visual-owner-G093 — .grid(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ordered dashboard receipt publishes root identity 49

```text
Identity: owner:G093:G093-F04 (DOMAIN_CONTRACT_ID)
Edition: 1
