# visual-owner-G093 — .present(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: refresh transition publishes generation 101 with one evaluation

```text
Identity: owner:G093:G093-F08 (DOMAIN_CONTRACT_ID)
Edition: 1
