# visual-owner-G093 — .layout(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: complete box snapshot preserves request and publishes content width 61

```text
Identity: owner:G093:G093-F05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.layout(...)
Owner: runtime/layout_model.asm;runtime/g093_source_probe.asm
```
...
- runtime/layout_model.asm — SHA-256 18aba26d33ef79815e3727a3b78a6afc01eb60ce33728075b709c9a4a06a111e
