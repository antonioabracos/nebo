...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: semantic hash covers exactly 113 ordered nodes

```text
Identity: owner:G093:G093-F09 (DOMAIN_CONTRACT_ID)
Edition: 1
