# visual-owner-G093 — .view(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: headless dashboard profile publishes identity 37

```text
Identity: owner:G093:G093-F03 (DOMAIN_CONTRACT_ID)
Edition: 1
