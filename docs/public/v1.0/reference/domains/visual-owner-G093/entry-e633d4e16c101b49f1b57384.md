# visual-owner-G093 — .cell(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: validated cell placement publishes node identity 23

```text
Identity: owner:G093:G093-F02 (DOMAIN_CONTRACT_ID)
Edition: 1
