...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: rooted tree receipt publishes exact node count 127

```text
Identity: owner:G093:G093-F10 (DOMAIN_CONTRACT_ID)
Edition: 1
