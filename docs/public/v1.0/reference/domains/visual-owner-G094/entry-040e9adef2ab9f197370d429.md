...
RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: headless closeout generation 43

```text
Identity: owner:G094:G094-F10 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.table(...)
Owner: runtime/p02_integration.asm;runtime/g094_source_probe.asm
```
...
- runtime/p02_integration.asm — SHA-256 a0ae3a15cf9ebadedea78a0643558b230b513b127d6ae78c3f6dbaa6ca0798af
