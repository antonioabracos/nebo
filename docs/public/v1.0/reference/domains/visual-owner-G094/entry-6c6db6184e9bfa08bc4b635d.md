# visual-owner-G094 — .preview(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: present extent 57 and explicit truncation

```text
Identity: owner:G094:G094-F07 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.preview(...)
Owner: runtime/structured_views.asm;runtime/g094_source_probe.asm
```
...
- runtime/structured_views.asm — SHA-256 1a2c63f9a0c38662819d7d8c54d515eb45de735874be28bd3616335ed3ffe65d
