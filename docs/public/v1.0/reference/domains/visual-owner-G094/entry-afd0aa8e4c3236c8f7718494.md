# visual-owner-G094 — .preview(...);maxRows:;maxColumns:;table:

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: virtual window generation 27 bounded by 27 rows and 8 columns

```text
Identity: owner:G094:G094-F08 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.preview(...);maxRows:;maxColumns:;table:
