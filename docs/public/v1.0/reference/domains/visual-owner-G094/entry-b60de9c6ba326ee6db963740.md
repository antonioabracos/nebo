# visual-owner-G094 — .table(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: object/tuple/schema identity 29

```text
Identity: owner:G094:G094-F05 (DOMAIN_CONTRACT_ID)
Edition: 1
