# visual-owner-G094 — .columns(...);.pageSize(...);.freezeHeader(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ordered columns, page size 17 and frozen header

```text
Identity: owner:G094:G094-F02 (DOMAIN_CONTRACT_ID)
Edition: 1
