# visual-owner-G095 — .labels

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 41; categorical labels option consumed

```text
Identity: owner:G095:.labels (DOMAIN_CONTRACT_ID)
Edition: 1
