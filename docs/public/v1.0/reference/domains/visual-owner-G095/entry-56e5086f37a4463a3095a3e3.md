# visual-owner-G095 — .plot

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 17; paired finite X/Y time series

```text
Identity: owner:G095:.plot (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.plot
Owner: compiler/semantic/visual/g095_source_vertical.inc + runtime/g095_source_probe.asm
```
