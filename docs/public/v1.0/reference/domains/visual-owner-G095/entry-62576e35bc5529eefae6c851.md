# visual-owner-G095 — .xLabel

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 37; X label option consumed

```text
Identity: owner:G095:.xLabel (DOMAIN_CONTRACT_ID)
Edition: 1
