# visual-owner-G095 — .chart

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 11; registered kind reaches target-neutral schema

```text
Identity: owner:G095:.chart (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.chart
Owner: compiler/semantic/visual/g095_source_vertical.inc + runtime/g095_chart_model.asm
```
