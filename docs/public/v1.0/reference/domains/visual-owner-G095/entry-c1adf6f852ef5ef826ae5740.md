# visual-owner-G095 — .heatmap

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 31; rows*columns equals numeric extent

```text
Identity: owner:G095:.heatmap (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.heatmap
Owner: runtime/g095_chart_model.asm
```
