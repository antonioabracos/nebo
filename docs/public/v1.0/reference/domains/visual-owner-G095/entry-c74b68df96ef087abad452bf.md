# visual-owner-G095 — .bins

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 23; bounded histogram bins

```text
Identity: owner:G095:.bins (DOMAIN_CONTRACT_ID)
Edition: 1
