# visual-owner-G095 — .sizeBy

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 41; size encoding consumed

```text
Identity: owner:G095:.sizeBy (DOMAIN_CONTRACT_ID)
Edition: 1
