# visual-owner-G095 — .colorBy

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 41; color encoding consumed

```text
Identity: owner:G095:.colorBy (DOMAIN_CONTRACT_ID)
Edition: 1
