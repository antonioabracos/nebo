# visual-owner-G096 — .orbit

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 31; orbit camera mode is exclusive with free

```text
Identity: owner:G096:.orbit (DOMAIN_CONTRACT_ID)
Edition: 1
