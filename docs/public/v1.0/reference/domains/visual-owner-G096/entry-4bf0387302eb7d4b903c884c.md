# visual-owner-G096 — .free

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 53; free camera mode is exclusive with orbit

```text
Identity: owner:G096:.free (DOMAIN_CONTRACT_ID)
Edition: 1
