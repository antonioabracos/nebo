# visual-owner-G096 — .plot3d

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 13; one of four registered 3D kinds is selected

```text
Identity: owner:G096:.plot3d (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.plot3d
Owner: compiler/semantic/visual/g096_source_vertical.inc + runtime/g096_scene_model.asm
```
