# visual-owner-G096 — .scene3d

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 41; composed scene receipt retains all options

```text
Identity: owner:G096:.scene3d (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.scene3d
Owner: runtime/g096_source_probe.asm
```
