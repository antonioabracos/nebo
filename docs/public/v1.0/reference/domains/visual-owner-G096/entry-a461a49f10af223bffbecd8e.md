# visual-owner-G096 — .grid3d

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 37; 3D grid option is retained

```text
Identity: owner:G096:.grid3d (DOMAIN_CONTRACT_ID)
Edition: 1
