# visual-owner-G096 — .position

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 31; finite camera position is consumed

```text
Identity: owner:G096:.position (DOMAIN_CONTRACT_ID)
Edition: 1
