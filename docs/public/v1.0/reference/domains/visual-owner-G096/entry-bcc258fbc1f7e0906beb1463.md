# visual-owner-G096 — .ambient

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 37; finite ambient intensity is bounded to 0..1

```text
Identity: owner:G096:.ambient (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.ambient
Owner: runtime/g096_scene_model.asm
```
