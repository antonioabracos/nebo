# visual-owner-G096 — .axis3d

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 37; three-dimensional axes are enabled

```text
Identity: owner:G096:.axis3d (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.axis3d
Owner: compiler/semantic/visual/g096_source_vertical.inc
```
