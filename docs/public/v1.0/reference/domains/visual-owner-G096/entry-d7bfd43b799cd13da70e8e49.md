# visual-owner-G096 — .camera

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 31; camera configuration reaches the model

```text
Identity: owner:G096:.camera (DOMAIN_CONTRACT_ID)
Edition: 1
