# visual-owner-G096 — .lookAt

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 31; finite look-at vector differs from position

```text
Identity: owner:G096:.lookAt (DOMAIN_CONTRACT_ID)
Edition: 1
