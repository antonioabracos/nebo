# visual-owner-G097 — .matrix

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 7; a rank-two matrix receipt is produced

```text
Identity: owner:G097:.matrix (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.matrix
Owner: compiler/semantic/visual/g097_source_vertical.inc + runtime/g097_scientific_view.asm
```
