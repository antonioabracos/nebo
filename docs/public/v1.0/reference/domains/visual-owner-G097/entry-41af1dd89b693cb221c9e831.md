# visual-owner-G097 — .threshold

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 19; finite threshold is applied to actual volume values

```text
Identity: owner:G097:.threshold (DOMAIN_CONTRACT_ID)
Edition: 1
