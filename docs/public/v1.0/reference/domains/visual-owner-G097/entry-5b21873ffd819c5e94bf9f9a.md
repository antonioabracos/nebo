# visual-owner-G097 — .volume

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 17; rank-three volume shape is validated

```text
Identity: owner:G097:.volume (DOMAIN_CONTRACT_ID)
Edition: 1
