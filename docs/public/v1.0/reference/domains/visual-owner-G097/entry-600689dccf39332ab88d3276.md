# visual-owner-G097 — .tensorSlice

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 13; tensor-slice option requires slice and index

```text
Identity: owner:G097:.tensorSlice (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.tensorSlice
Owner: compiler/semantic/visual/g097_source_vertical.inc
```
