# visual-owner-G097 — .tensor

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 11; rank-three tensor data is finite and owner-backed

```text
Identity: owner:G097:.tensor (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.tensor
Owner: runtime/g097_source_probe.asm
```
