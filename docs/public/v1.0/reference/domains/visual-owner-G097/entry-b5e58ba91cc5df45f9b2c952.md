# visual-owner-G097 — .index

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 13; index is below the selected axis extent

```text
Identity: owner:G097:.index (DOMAIN_CONTRACT_ID)
Edition: 1
