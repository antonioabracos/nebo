# visual-owner-G097 — .compare

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 23; equal-shape operands reach a selected metric

```text
Identity: owner:G097:.compare (DOMAIN_CONTRACT_ID)
Edition: 1
