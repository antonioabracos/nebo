# visual-owner-G097 — .with

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 23; peer shape data and distinct provenance are consumed

```text
Identity: owner:G097:.with (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.with
Owner: runtime/g097_scientific_view.asm
```
