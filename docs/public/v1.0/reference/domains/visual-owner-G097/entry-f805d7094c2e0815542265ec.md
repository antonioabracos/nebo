# visual-owner-G097 — .slice

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 17; slice axis and index are retained

```text
Identity: owner:G097:.slice (DOMAIN_CONTRACT_ID)
Edition: 1
