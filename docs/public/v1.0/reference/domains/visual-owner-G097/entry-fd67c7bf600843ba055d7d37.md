# visual-owner-G097 — .isosurface

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exit 19; selected voxel count is positive and bounded

```text
Identity: owner:G097:.isosurface (DOMAIN_CONTRACT_ID)
Edition: 1
