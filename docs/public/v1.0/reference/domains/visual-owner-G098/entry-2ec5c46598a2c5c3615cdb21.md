# visual-owner-G098 — .project

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: projection executes once and publishes a calculated digest

```text
Identity: owner:G098:.project (DOMAIN_CONTRACT_ID)
Edition: 1
