# visual-owner-G098 — .highlightPath

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: every consecutive path pair is a real directed edge

```text
Identity: owner:G098:.highlightPath (DOMAIN_CONTRACT_ID)
Edition: 1
