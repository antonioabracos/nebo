# visual-owner-G098 — .highlight

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: highlighted node is in bounds and generation-owned

```text
Identity: owner:G098:.highlight (DOMAIN_CONTRACT_ID)
Edition: 1
