# visual-owner-G098 — .dimensions

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: input and output dimensions satisfy bounded projection rules

```text
Identity: owner:G098:.dimensions (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.dimensions
Owner: runtime/g098_graph_view.asm
```
