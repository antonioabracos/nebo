# visual-owner-G100 — .window

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: window_count=5 window_start=4 and last_count=2

```text
Identity: owner:G100:.window (DOMAIN_CONTRACT_ID)
Edition: 1
