# visual-owner-G100 — .last

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: last_count=3 and bounded by window_count=6

```text
Identity: owner:G100:.last (DOMAIN_CONTRACT_ID)
Edition: 1
