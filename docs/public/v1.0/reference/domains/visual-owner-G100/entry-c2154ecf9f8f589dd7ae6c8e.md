# visual-owner-G100 — .source

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: source generation is preserved and equals owner/timeline generation

```text
Identity: owner:G100:.source (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.source
Owner: compiler/semantic/visual/g100_source_vertical.inc;runtime/g100_observability.asm
```
