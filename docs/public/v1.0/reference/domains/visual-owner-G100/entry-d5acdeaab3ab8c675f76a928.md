# visual-owner-G100 — .time

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: nondecreasing source times fit the explicit duration window

```text
Identity: owner:G100:.time (DOMAIN_CONTRACT_ID)
Edition: 1
