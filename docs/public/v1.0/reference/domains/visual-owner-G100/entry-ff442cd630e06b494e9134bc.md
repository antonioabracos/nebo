# visual-owner-G100 — .stream

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: 9 events with capacity 8 accept exactly 8 under pause policy

```text
Identity: owner:G100:.stream (DOMAIN_CONTRACT_ID)
Edition: 1
