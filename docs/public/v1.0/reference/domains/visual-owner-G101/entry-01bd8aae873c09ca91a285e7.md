# visual-owner-G101 — .sample

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: seeded reservoir digest changes with generation

```text
Identity: owner:G101:.sample (DOMAIN_CONTRACT_ID)
Edition: 1
