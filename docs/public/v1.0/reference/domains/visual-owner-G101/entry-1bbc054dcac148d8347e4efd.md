# visual-owner-G101 — .chunks

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: four logical tiles are produced

```text
Identity: owner:G101:.chunks (DOMAIN_CONTRACT_ID)
Edition: 1
