# visual-owner-G101 — .lod

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: 16 points reduce to target 6 at LOD level 2

```text
Identity: owner:G101:.lod (DOMAIN_CONTRACT_ID)
Edition: 1
