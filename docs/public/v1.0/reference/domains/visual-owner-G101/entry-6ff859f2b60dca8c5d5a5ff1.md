# visual-owner-G101 — .quality

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: explicit quality 1 through 4 is retained in the report

```text
Identity: owner:G101:.quality (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
.quality
Owner: nebo_g101_large_data_model
```
