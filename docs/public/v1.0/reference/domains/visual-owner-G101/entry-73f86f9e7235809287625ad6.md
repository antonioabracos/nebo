# visual-owner-G101 — .lru

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: eight misses followed by eight hits with no eviction

```text
Identity: owner:G101:.lru (DOMAIN_CONTRACT_ID)
Edition: 1
