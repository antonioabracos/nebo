# visual-owner-G101 — .frameMs

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: deterministic work units fit the frame budget

```text
Identity: owner:G101:.frameMs (DOMAIN_CONTRACT_ID)
Edition: 1
