# visual-owner-G101 — .aggregate

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: four deterministic aggregate buckets

```text
Identity: owner:G101:.aggregate (DOMAIN_CONTRACT_ID)
Edition: 1
