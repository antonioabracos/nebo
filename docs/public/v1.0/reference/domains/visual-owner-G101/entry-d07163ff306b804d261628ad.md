# visual-owner-G101 — .decimate

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: deterministic nonzero LTTB selection digest

```text
Identity: owner:G101:.decimate (DOMAIN_CONTRACT_ID)
Edition: 1
