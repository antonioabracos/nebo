# visual-owner-G101 — .cache

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: cache generation matches data generation

```text
Identity: owner:G101:.cache (DOMAIN_CONTRACT_ID)
Edition: 1
