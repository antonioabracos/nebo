# visual-owner-G102 — .frames

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: bounded frame count is observed from the timeline

```text
Identity: owner:G102:.frames (DOMAIN_CONTRACT_ID)
Edition: 1
