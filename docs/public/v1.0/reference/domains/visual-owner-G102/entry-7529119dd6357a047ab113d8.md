# visual-owner-G102 — hideOnScreen:

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: capability-gated named schema key suppresses live presentation

```text
Identity: owner:G102:hideOnScreen: (DOMAIN_CONTRACT_ID)
Edition: 1
