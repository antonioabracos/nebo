# visual-owner-G102 — .capture

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: nonzero target-neutral capture digest

```text
Identity: owner:G102:.capture (DOMAIN_CONTRACT_ID)
Edition: 1
