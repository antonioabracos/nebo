# visual-owner-G102 — .screenshot

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: synthetic screenshot capture is deterministic across targets

```text
Identity: owner:G102:.screenshot (DOMAIN_CONTRACT_ID)
Edition: 1
