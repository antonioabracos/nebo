# visual-owner-G102 — .fps

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: explicit fps derives a stable nanosecond interval

```text
Identity: owner:G102:.fps (DOMAIN_CONTRACT_ID)
Edition: 1
