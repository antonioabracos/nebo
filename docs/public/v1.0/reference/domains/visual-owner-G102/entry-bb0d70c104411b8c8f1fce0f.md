# visual-owner-G102 — .duration

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: ceil(frameCount*1000/fps) duration is retained

```text
Identity: owner:G102:.duration (DOMAIN_CONTRACT_ID)
Edition: 1
