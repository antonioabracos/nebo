# visual-owner-G102 — .animation

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: versioned animation plan is accepted

```text
Identity: owner:G102:.animation (DOMAIN_CONTRACT_ID)
Edition: 1
