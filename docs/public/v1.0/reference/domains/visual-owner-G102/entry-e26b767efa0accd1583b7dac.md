# visual-owner-G102 — .loop

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: looping produces two logical passes without ambient time

```text
Identity: owner:G102:.loop (DOMAIN_CONTRACT_ID)
Edition: 1
