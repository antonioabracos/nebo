# visual-owner-G102 — .png

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: PNG manifest accounts dimensions without a core codec

```text
Identity: owner:G102:.png (DOMAIN_CONTRACT_ID)
Edition: 1
