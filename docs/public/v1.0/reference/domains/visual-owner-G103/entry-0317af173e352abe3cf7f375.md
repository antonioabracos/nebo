# visual-owner-G103 — console.plot2d

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: plot event uses visual capability and stable kind 07

```text
Identity: owner:G103:console.plot2d (DOMAIN_CONTRACT_ID)
Edition: 1
