# visual-owner-G103 — console.scan.timeout

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: terminal timeout has no response payload

```text
Identity: owner:G103:console.scan.timeout (DOMAIN_CONTRACT_ID)
Edition: 1
