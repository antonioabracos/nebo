# visual-owner-G103 — console.region

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: bounded region identity survives round-trip

```text
Identity: owner:G103:console.region (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
console.region
Owner: nebo_g103_roundtrip_event
```
