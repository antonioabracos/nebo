# visual-owner-G103 — console.text

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: text event is represented by canonical kind 04

```text
Identity: owner:G103:console.text (DOMAIN_CONTRACT_ID)
Edition: 1
