# visual-owner-G103 — console.write

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: write event shares the authorized text capability

```text
Identity: owner:G103:console.write (DOMAIN_CONTRACT_ID)
Edition: 1
