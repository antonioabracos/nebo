# visual-owner-G103 — console.scan.request

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: request contains no response value or private flag

```text
Identity: owner:G103:console.scan.request (DOMAIN_CONTRACT_ID)
Edition: 1
