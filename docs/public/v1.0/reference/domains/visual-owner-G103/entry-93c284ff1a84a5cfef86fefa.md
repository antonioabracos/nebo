# visual-owner-G103 — console.clear

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: scoped clear requires its declared capability

```text
Identity: owner:G103:console.clear (DOMAIN_CONTRACT_ID)
Edition: 1
