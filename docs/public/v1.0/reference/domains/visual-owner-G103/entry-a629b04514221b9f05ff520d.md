# visual-owner-G103 — console.scan.response

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: response carries only a private redacted digest

```text
Identity: owner:G103:console.scan.response (DOMAIN_CONTRACT_ID)
Edition: 1
