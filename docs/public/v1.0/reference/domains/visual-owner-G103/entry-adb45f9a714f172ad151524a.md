# visual-owner-G103 — console.dashboard

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: dashboard event uses visual capability and stable kind 09

```text
Identity: owner:G103:console.dashboard (DOMAIN_CONTRACT_ID)
Edition: 1
