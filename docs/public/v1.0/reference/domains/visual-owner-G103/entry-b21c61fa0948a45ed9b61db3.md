# visual-owner-G103 — console.graph

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: graph event uses visual capability and stable kind 08

```text
Identity: owner:G103:console.graph (DOMAIN_CONTRACT_ID)
Edition: 1
