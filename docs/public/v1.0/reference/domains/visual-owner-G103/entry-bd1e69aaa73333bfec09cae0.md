# visual-owner-G103 — console.table

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: table event is bounded and independently decoded

```text
Identity: owner:G103:console.table (DOMAIN_CONTRACT_ID)
Edition: 1
