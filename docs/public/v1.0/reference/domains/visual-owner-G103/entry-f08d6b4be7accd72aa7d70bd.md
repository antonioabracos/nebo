# visual-owner-G103 — console.scan.validation_failed

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: validation feedback requires a diagnostic capability

```text
Identity: owner:G103:console.scan.validation_failed (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
console.scan.validation_failed
Owner: nebo_g103_validate_event
```
