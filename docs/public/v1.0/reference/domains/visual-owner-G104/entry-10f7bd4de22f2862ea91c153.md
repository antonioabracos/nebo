# visual-owner-G104 — nebo_visual_console_should_close

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: close request observed independently

```text
Identity: owner:G104:nebo_visual_console_should_close (DOMAIN_CONTRACT_ID)
Edition: 1
