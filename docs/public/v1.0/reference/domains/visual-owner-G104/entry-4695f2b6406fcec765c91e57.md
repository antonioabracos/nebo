# visual-owner-G104 — nebo_visual_console_open_default

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: validated context publication or atomic failure

```text
Identity: owner:G104:nebo_visual_console_open_default (DOMAIN_CONTRACT_ID)
Edition: 1
