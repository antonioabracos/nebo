# visual-owner-G104 — nebo_visual_console_end_frame

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: present digest published only after adapter success

```text
Identity: owner:G104:nebo_visual_console_end_frame (DOMAIN_CONTRACT_ID)
Edition: 1
