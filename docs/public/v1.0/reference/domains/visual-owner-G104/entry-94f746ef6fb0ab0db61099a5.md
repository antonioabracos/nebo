# visual-owner-G104 — nebo_visual_console_run_once

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: bounded resize redraw and close effects

```text
Identity: owner:G104:nebo_visual_console_run_once (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/g104_live_console.asm
```
