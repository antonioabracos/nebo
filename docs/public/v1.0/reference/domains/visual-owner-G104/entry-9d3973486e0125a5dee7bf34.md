# visual-owner-G104 — nebo_visual_console_is_available

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: built-ins available and unregistered hardware unavailable

```text
Identity: owner:G104:nebo_visual_console_is_available (DOMAIN_CONTRACT_ID)
Edition: 1
