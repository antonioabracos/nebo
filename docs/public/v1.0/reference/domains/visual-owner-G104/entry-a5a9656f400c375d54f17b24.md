# visual-owner-G104 — renderer:

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exact software/opengl/bgfx renderer mapping

```text
Identity: owner:G104:renderer: (DOMAIN_CONTRACT_ID)
Edition: 1
