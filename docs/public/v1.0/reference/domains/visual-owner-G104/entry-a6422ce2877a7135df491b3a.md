# visual-owner-G104 — nebo_visual_console_begin_frame

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: monotonic frame token and frame state

```text
Identity: owner:G104:nebo_visual_console_begin_frame (DOMAIN_CONTRACT_ID)
Edition: 1
