# visual-owner-G105 — .secret()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: secret policy redacts event values and permits zeroization

```text
Identity: owner:G105:.secret() (DOMAIN_CONTRACT_ID)
Edition: 1
