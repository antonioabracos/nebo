# visual-owner-G105 — .jsonBlock()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: JSON block input mode is admitted by the bounded profile

```text
Identity: owner:G105:.jsonBlock() (DOMAIN_CONTRACT_ID)
Edition: 1
