# visual-owner-G105 — .untrusted()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: untrusted-source policy is explicit in security flags

```text
Identity: owner:G105:.untrusted() (DOMAIN_CONTRACT_ID)
Edition: 1
