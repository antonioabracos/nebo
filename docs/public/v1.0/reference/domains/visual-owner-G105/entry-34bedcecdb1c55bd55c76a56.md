# visual-owner-G105 — .yesNo()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Boolean choice is explicit in the choice flags

```text
Identity: owner:G105:.yesNo() (DOMAIN_CONTRACT_ID)
Edition: 1
