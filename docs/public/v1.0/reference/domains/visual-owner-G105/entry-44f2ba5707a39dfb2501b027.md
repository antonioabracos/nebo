# visual-owner-G105 — .minStrength(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: canonical native G077 validation accepts 1..4 character classes; zero and five reject

```text
Identity: owner:G105:.minStrength(...) (DOMAIN_CONTRACT_ID)
Edition: 1
