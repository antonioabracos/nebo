# visual-owner-G105 — .replay(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: monotonic replay and explicit headless fallback are observable

```text
Identity: owner:G105:.replay(...) (DOMAIN_CONTRACT_ID)
Edition: 1
