# visual-owner-G105 — .until(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: nonempty delimiter metadata is bounded

```text
Identity: owner:G105:.until(...) (DOMAIN_CONTRACT_ID)
Edition: 1
