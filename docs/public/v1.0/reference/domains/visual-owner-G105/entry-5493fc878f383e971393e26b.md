# visual-owner-G105 — .select(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: single selection participates in the choice flags

```text
Identity: owner:G105:.select(...) (DOMAIN_CONTRACT_ID)
Edition: 1
