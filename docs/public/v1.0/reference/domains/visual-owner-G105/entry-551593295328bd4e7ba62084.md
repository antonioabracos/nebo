# visual-owner-G105 — .field(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: bounded field count and schema metadata are observable

```text
Identity: owner:G105:.field(...) (DOMAIN_CONTRACT_ID)
Edition: 1
