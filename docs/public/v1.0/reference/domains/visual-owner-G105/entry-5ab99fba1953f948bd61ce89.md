# visual-owner-G105 — .mask(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: nonempty visual mask metadata is validated

```text
Identity: owner:G105:.mask(...) (DOMAIN_CONTRACT_ID)
Edition: 1
