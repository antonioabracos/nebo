# visual-owner-G105 — .password()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: password policy is explicit and caller-owned

```text
Identity: owner:G105:.password() (DOMAIN_CONTRACT_ID)
Edition: 1
