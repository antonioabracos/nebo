# visual-owner-G105 — .sensitive()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: sensitive data never enters request or event records

```text
Identity: owner:G105:.sensitive() (DOMAIN_CONTRACT_ID)
Edition: 1
