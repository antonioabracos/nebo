# visual-owner-G105 — .confirm()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: confirmation is explicit in the choice flags

```text
Identity: owner:G105:.confirm() (DOMAIN_CONTRACT_ID)
Edition: 1
