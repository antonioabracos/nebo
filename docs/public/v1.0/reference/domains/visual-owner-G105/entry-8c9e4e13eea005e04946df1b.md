# visual-owner-G105 — .multiline()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: multiline mode and line budget are observed

```text
Identity: owner:G105:.multiline() (DOMAIN_CONTRACT_ID)
Edition: 1
