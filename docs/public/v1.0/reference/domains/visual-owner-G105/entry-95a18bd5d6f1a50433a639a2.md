# visual-owner-G105 — .redact()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: public event digest is a fixed redaction marker

```text
Identity: owner:G105:.redact() (DOMAIN_CONTRACT_ID)
Edition: 1
