# visual-owner-G105 — .mock(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: mock supplies bytes only at the response boundary

```text
Identity: owner:G105:.mock(...) (DOMAIN_CONTRACT_ID)
Edition: 1
