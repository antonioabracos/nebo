# visual-owner-G105 — .style(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: style identifier is bounded explicit metadata

```text
Identity: owner:G105:.style(...) (DOMAIN_CONTRACT_ID)
Edition: 1
