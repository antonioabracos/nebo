# visual-owner-G105 — .view(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: view identifier participates in deterministic plan digest

```text
Identity: owner:G105:.view(...) (DOMAIN_CONTRACT_ID)
Edition: 1
