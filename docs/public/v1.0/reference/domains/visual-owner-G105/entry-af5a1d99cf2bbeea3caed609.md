# visual-owner-G105 — .panel(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: panel identifier participates in deterministic plan digest

```text
Identity: owner:G105:.panel(...) (DOMAIN_CONTRACT_ID)
Edition: 1
