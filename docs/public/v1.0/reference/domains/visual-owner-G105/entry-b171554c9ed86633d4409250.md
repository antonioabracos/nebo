# visual-owner-G105 — .rawBlock()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: actual raw bytes preserve line breaks and contribute to the observed byte length

```text
Identity: owner:G105:.rawBlock() (DOMAIN_CONTRACT_ID)
Edition: 1
