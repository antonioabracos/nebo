# visual-owner-G105 — .markdown()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: Markdown input mode reaches the plan owner

```text
Identity: owner:G105:.markdown() (DOMAIN_CONTRACT_ID)
Edition: 1
