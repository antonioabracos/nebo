# visual-owner-G105 — .console()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: exact nested frontend selects console without output routing

```text
Identity: owner:G105:.console() (DOMAIN_CONTRACT_ID)
Edition: 1
