# visual-owner-G105 — .maxLines(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: line budget accepts 1..256 and rejects out of range

```text
Identity: owner:G105:.maxLines(...) (DOMAIN_CONTRACT_ID)
Edition: 1
