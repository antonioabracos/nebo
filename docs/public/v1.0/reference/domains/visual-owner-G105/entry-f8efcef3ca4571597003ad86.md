# visual-owner-G105 — .menu(...)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: menu choice participates in the choice flags

```text
Identity: owner:G105:.menu(...) (DOMAIN_CONTRACT_ID)
Edition: 1
