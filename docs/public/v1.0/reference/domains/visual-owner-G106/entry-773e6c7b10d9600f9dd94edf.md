# visual-owner-G106 — privacy:

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: named privacy policy is classified and applied before RenderPlan publication

```text
Identity: owner:G106:privacy: (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
privacy:
Owner: compiler/semantic/visual/g106_source_vertical.inc;runtime/privacy_accessibility.asm
```
...
- runtime/privacy_accessibility.asm — SHA-256 c0eb0d9b46d2b4b0a1991641f8493a2ae6c432cebcdcaa1aa776bd92b1c21b60
