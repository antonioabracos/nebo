# visual-owner-G108 — profile:

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: each profile lowers once to a deterministic capture, versioned snapshot and inert replay observation

```text
Identity: owner:G108:profile: (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
profile:
Owner: compiler/semantic/visual/g108_source_vertical.inc;runtime/console_testability.asm
```
...
- runtime/console_testability.asm — SHA-256 e33d80490aa9a72cded24a0d0da60652d93aec36311b5907e5d3e58febac68ed
