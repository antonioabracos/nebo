# visual-owner-G110 — visual.panel.get

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: lookup returns a pointer-free snapshot and missing ids preserve the destination

```text
Identity: owner:G110:visual.panel.get (DOMAIN_CONTRACT_ID)
Edition: 1
