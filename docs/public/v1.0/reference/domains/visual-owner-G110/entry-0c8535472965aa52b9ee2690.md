# visual-owner-G110 — visual.console.show

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: show consumes one bounded line and publishes a source-derived digest

```text
Identity: owner:G110:visual.console.show (DOMAIN_CONTRACT_ID)
Edition: 1
