# visual-owner-G110 — visual.monitorStream(stream,limit)
...
```text
Identity: owner:G110:visual.monitorStream(stream,limit) (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
visual.monitorStream(stream,limit)
