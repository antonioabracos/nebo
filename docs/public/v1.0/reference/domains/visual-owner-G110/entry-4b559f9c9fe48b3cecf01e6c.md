# visual-owner-G110 — visual.show(value)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: historical facade is rejected; receiver-first visual effect is source-derived

```text
Identity: owner:G110:visual.show(value) (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
visual.show(value)
Owner: runtime/g110_source_probe.asm
```
