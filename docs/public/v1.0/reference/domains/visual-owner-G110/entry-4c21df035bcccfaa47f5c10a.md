# visual-owner-G110 — visual.console.close

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: close rejects live panels and performs one idempotent cleanup

```text
Identity: owner:G110:visual.console.close (DOMAIN_CONTRACT_ID)
Edition: 1
