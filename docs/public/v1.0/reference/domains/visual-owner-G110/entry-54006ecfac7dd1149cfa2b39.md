# visual-owner-G110 — visual.console.setLimits

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: limits cannot shrink below observed resources and failures preserve state

```text
Identity: owner:G110:visual.console.setLimits (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
visual.console.setLimits
Owner: runtime/internal_visual_console.asm
```
...
- runtime/internal_visual_console.asm — SHA-256 faeba0b6bc5a84dd8fa6edaf4838a3537b743156e907a261881f31fd9b6f56d0
