# visual-owner-G110 — visual.console.setMode

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: only the five bounded internal modes are accepted

```text
Identity: owner:G110:visual.console.setMode (DOMAIN_CONTRACT_ID)
Edition: 1
