# visual-owner-G110 — visual.panel.remove

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: remove clears content and decrements the console panel count exactly once

```text
Identity: owner:G110:visual.panel.remove (DOMAIN_CONTRACT_ID)
Edition: 1
