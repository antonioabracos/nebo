# visual-owner-G110 — visual.export(node,path)

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: historical facade is rejected and reserved for the G114 internal service

```text
Identity: owner:G110:visual.export(node,path) (DOMAIN_CONTRACT_ID)
Edition: 1
