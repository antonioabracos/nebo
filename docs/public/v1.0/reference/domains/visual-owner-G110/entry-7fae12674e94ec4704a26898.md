# visual-owner-G110 — visual.console.inspect

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: inspection requires explicit capability and publishes no pointer

```text
Identity: owner:G110:visual.console.inspect (DOMAIN_CONTRACT_ID)
Edition: 1
