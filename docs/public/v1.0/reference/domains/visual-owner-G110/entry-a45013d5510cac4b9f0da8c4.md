# visual-owner-G110 — visual.console.fallbackText

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: text fallback has a distinct bounded digest operation

```text
Identity: owner:G110:visual.console.fallbackText (DOMAIN_CONTRACT_ID)
Edition: 1
