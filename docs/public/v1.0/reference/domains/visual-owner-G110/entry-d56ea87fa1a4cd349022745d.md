# visual-owner-G110 — visual.console.open

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: caller-owned console opens only after mode theme limits and capabilities validate

```text
Identity: owner:G110:visual.console.open (DOMAIN_CONTRACT_ID)
Edition: 1
