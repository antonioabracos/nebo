# visual-owner-G110 — visual.configureHeadless()

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: historical public facade is rejected; headless mode is configured internally

```text
Identity: owner:G110:visual.configureHeadless() (DOMAIN_CONTRACT_ID)
Edition: 1
