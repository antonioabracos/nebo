# visual-owner-G111 — G111-S08-03

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: export format and authenticated digest are exact

```text
Identity: owner:G111:G111-S08-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G111-S08-03
Owner: nebo_g111_timeline_export
```
