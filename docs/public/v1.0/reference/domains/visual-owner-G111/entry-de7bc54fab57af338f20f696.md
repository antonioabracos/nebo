# visual-owner-G111 — G111-S02-02

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: tag changes deterministic digest

```text
Identity: owner:G111:G111-S02-02 (DOMAIN_CONTRACT_ID)
Edition: 1
