# visual-owner-G111 — G111-S08-02

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: window contains 3 events from offset 1

```text
Identity: owner:G111:G111-S08-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G111-S08-02
Owner: nebo_g111_timeline_window
```
