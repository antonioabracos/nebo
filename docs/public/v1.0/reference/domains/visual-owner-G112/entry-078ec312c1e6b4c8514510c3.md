# visual-owner-G112 — G112-S02-02

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: histogram retains four bounded bins

```text
Identity: owner:G112:G112-S02-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G112-S02-02
Owner: nebo_g112_chart_histogram
```
