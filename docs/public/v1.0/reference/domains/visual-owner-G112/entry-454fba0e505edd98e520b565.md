# visual-owner-G112 — G112-S01-02

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: bar receipt retains operation 2

```text
Identity: owner:G112:G112-S01-02 (DOMAIN_CONTRACT_ID)
Edition: 1
