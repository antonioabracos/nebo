# visual-owner-G112 — G112-S04-01

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: time series delegates to G095 time-series kind

```text
Identity: owner:G112:G112-S04-01 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G112-S04-01
Owner: nebo_g112_chart_time_series
```
