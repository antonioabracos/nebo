# visual-owner-G112 — G112-S07-03

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: filter summary has exact core and service digests

```text
Identity: owner:G112:G112-S07-03 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G112-S07-03
Owner: nebo_g112_table_filter_summary
```
