# visual-owner-G112 — G112-S06-01

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: sample count 5 produces a G101 digest

```text
Identity: owner:G112:G112-S06-01 (DOMAIN_CONTRACT_ID)
Edition: 1
