# visual-owner-G112 — G112-S06-02

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: row limit publishes eight rows

```text
Identity: owner:G112:G112-S06-02 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G112-S06-02
Owner: nebo_g112_table_limit_rows
```
