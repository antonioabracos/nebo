# visual-owner-G113 — visual.ml.metricChart

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=15 redacted metric view

```text
Identity: owner:G113:visual.ml.metricChart (DOMAIN_CONTRACT_ID)
Edition: 1
