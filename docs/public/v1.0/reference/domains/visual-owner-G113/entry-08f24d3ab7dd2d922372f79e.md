# visual-owner-G113 — visual.ml.confusionMatrix

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=16 bounded matrix view

```text
Identity: owner:G113:visual.ml.confusionMatrix (DOMAIN_CONTRACT_ID)
Edition: 1
