# visual-owner-G113 — visual.dashboard.show

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=9 target-neutral show effect

```text
Identity: owner:G113:visual.dashboard.show (DOMAIN_CONTRACT_ID)
Edition: 1
