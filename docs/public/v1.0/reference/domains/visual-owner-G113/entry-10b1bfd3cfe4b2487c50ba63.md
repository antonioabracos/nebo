# visual-owner-G113 — visual.media.metadata

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=27 redacted metadata

```text
Identity: owner:G113:visual.media.metadata (DOMAIN_CONTRACT_ID)
Edition: 1
