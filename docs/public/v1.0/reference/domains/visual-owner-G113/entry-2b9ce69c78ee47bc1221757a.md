# visual-owner-G113 — visual.ml.modelSummary

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=19 redacted model summary

```text
Identity: owner:G113:visual.ml.modelSummary (DOMAIN_CONTRACT_ID)
Edition: 1
