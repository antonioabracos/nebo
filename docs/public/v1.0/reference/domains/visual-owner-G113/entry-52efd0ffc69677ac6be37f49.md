# visual-owner-G113 — visual.graph.layout

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=32 explicit layout

```text
Identity: owner:G113:visual.graph.layout (DOMAIN_CONTRACT_ID)
Edition: 1
