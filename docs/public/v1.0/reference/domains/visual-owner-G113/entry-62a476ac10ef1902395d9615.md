# visual-owner-G113 — visual.graph.tree

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=29 bounded tree view

```text
Identity: owner:G113:visual.graph.tree (DOMAIN_CONTRACT_ID)
Edition: 1
