# visual-owner-G113 — visual.graph.computationalGraph

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=31 computational view

```text
Identity: owner:G113:visual.graph.computationalGraph (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
visual.graph.computationalGraph
Owner: runtime/internal_domain_visual_services.asm
```
...
- runtime/internal_domain_visual_services.asm — SHA-256 7d6041e42fd5084a17c43728f4b7932b8d95ffebc1a6366abdde8fbbca9b015b
