# visual-owner-G113 — visual.dashboard.addTable

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: receipt operation=7 table adapter digest

```text
Identity: owner:G113:visual.dashboard.addTable (DOMAIN_CONTRACT_ID)
Edition: 1
