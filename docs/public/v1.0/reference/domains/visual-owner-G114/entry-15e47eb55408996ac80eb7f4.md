# visual-owner-G114 — G114-S01-F003

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: bounded image receipt under export capability

```text
Identity: owner:G114:G114-S01-F003 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G114-S01-F003
Owner: runtime/internal_export_privacy_services.asm:nebo_g114_export_image
```
