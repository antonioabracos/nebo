# visual-owner-G114 — G114-S06-F003

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: audit capability and permission produce independent report receipt

```text
Identity: owner:G114:G114-S06-F003 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G114-S06-F003
Owner: runtime/internal_export_privacy_services.asm:nebo_g114_report
```
...
- runtime/internal_export_privacy_services.asm — SHA-256 a91974971e1034a8305a65799b11a1389baeccc5179c3cf66275bcdc2f17f77b
