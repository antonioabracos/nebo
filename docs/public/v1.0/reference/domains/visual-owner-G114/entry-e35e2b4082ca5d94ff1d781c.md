# visual-owner-G114 — G114-S02-F001

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: open recording receipt with deterministic nonzero handle

```text
Identity: owner:G114:G114-S02-F001 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
G114-S02-F001
Owner: runtime/internal_export_privacy_services.asm:nebo_g114_record
```
