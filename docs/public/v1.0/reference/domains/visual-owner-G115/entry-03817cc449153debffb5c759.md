# visual-owner-G115 — nebo_console_options_default

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: canonical default options observed then committed

```text
Identity: owner:G115:nebo_console_options_default (DOMAIN_CONTRACT_ID)
Edition: 1
