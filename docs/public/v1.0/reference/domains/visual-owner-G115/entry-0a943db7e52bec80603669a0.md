# visual-owner-G115 — nebo_console_render_section

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=27;section render receipt

```text
Identity: owner:G115:nebo_console_render_section (DOMAIN_CONTRACT_ID)
Edition: 1
