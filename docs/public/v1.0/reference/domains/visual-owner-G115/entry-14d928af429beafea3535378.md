# visual-owner-G115 — nebo_console_render_plot_bar

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=24;bar render receipt

```text
Identity: owner:G115:nebo_console_render_plot_bar (DOMAIN_CONTRACT_ID)
Edition: 1
