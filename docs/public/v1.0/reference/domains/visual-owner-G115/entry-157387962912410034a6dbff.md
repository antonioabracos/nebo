# visual-owner-G115 — nebo_console_print_event

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=19;historical name internal only

```text
Identity: owner:G115:nebo_console_print_event (DOMAIN_CONTRACT_ID)
Edition: 1
