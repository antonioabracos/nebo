# visual-owner-G115 — nebo_console_event_stream_write_jsonl

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=7;normalized JSONL flag required

```text
Identity: owner:G115:nebo_console_event_stream_write_jsonl (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
nebo_console_event_stream_write_jsonl
