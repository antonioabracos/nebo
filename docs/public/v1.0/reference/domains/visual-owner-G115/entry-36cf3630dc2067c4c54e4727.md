# visual-owner-G115 — nebo_console_render_table

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=29;table render receipt

```text
Identity: owner:G115:nebo_console_render_table (DOMAIN_CONTRACT_ID)
Edition: 1
