# visual-owner-G115 — nebo_console_event_stream

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=6;bounded stream receipt

```text
Identity: owner:G115:nebo_console_event_stream (DOMAIN_CONTRACT_ID)
Edition: 1
