# visual-owner-G115 — nebo_console_options_validate

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: canonical validation observed then committed

```text
Identity: owner:G115:nebo_console_options_validate (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/console_contract.asm
```
...
- runtime/console_contract.asm — SHA-256 f13346ae67544ceec3434f02473b6673c2dcf2a74a76ea5442b88511289a550d
