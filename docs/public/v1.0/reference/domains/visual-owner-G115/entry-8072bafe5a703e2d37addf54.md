# visual-owner-G115 — nebo_console_emit_plot2d

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=1;target-neutral result/audit;plugin active

```text
Identity: owner:G115:nebo_console_emit_plot2d (DOMAIN_CONTRACT_ID)
Edition: 1
