# visual-owner-G115 — nebo_console_registry

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: canonical registry observed then committed

```text
Identity: owner:G115:nebo_console_registry (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/console_option_registry.asm
```
