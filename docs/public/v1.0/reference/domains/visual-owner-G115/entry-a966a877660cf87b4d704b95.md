# visual-owner-G115 — nebo_console_render_plan_is_safe

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: canonical safety validation observed then committed

```text
Identity: owner:G115:nebo_console_render_plan_is_safe (DOMAIN_CONTRACT_ID)
Edition: 1
...
Owner: runtime/render_intent.asm
```
...
- runtime/render_intent.asm — SHA-256 74d0d820606dc50f7231f6ab1b24a82bdedf68690f2af7c98e2d42ffebe71394
