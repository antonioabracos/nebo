# visual-owner-G115 — nebo_console_render_plot_points

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=26;points render receipt

```text
Identity: owner:G115:nebo_console_render_plot_points (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
nebo_console_render_plot_points
