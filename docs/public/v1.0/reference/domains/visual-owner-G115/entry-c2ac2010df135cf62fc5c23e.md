# visual-owner-G115 — nebo_console_emit_text

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=3;headless/live logical parity

```text
Identity: owner:G115:nebo_console_emit_text (DOMAIN_CONTRACT_ID)
Edition: 1
