# visual-owner-G115 — nebo_console_event_value_none

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=10;unique None event receipt

```text
Identity: owner:G115:nebo_console_event_value_none (DOMAIN_CONTRACT_ID)
Edition: 1
