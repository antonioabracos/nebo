# visual-owner-G115 — nebo_console_option_model

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: canonical option model observed then committed

```text
Identity: owner:G115:nebo_console_option_model (DOMAIN_CONTRACT_ID)
Edition: 1
