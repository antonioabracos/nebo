# visual-owner-G115 — nebo_console_event_value_float

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=9;unique Float event receipt

```text
Identity: owner:G115:nebo_console_event_value_float (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
nebo_console_event_value_float
