# visual-owner-G115 — nebo_console_options_x

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=17;X model receipt

```text
Identity: owner:G115:nebo_console_options_x (DOMAIN_CONTRACT_ID)
Edition: 1
