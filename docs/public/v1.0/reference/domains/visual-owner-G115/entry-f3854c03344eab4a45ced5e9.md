# visual-owner-G115 — nebo_console_render_summary

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=28;summary render receipt

```text
Identity: owner:G115:nebo_console_render_summary (DOMAIN_CONTRACT_ID)
Edition: 1
