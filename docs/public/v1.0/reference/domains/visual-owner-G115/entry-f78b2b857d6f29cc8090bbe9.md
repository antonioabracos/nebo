# visual-owner-G115 — nebo_console_write_stdout

RF116 internal visual/model receipt; not a public visual.* facade. Public receiver-first Console/Scan has separate public identities. No live hardware claim.; original observation: operation=31;checked write receipt without ambient I/O

```text
Identity: owner:G115:nebo_console_write_stdout (DOMAIN_CONTRACT_ID)
Edition: 1
