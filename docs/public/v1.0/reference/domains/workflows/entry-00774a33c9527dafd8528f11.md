# workflows — table.validateConflicts()

Bounded local workflow/agent state machine; no remote scheduler or external side effects; original observation: unique rows report no conflict; SDK bounds: {"MAX_ATTEMPTS":8,"MAX_DOMAIN_CASES":256,"MAX_HISTORY":256,"MAX_ROWS":64,"MAX_RULES":64,"MAX_SAGA_STEPS":16,"MAX_STATES":128,"MAX_STEPS":64,"MAX_TRANSITIONS":1024}

```text
Identity: owner:G045:G045-S06-05 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
DecisionTable.validateConflicts(self) -> dict[str, Any]
```
...
[
  ...
  {
    "excerpt": "176: ok(\"positive\", \"table.validateCoverage\", coverage == {\"covered\": True, \"cases\": 2, \"gaps\": ()})\n177: conflicts = table.validateConflicts()\n178: ok(\"positive\", \"table.validateConflicts\", conflicts == {\"valid\": True, \"conflicts\": ()})\n179: generated = table.generateTests()\n180: ok(\"positive\", \"table.generateTests\", generated[0][\"input\"] == {\"tier\": 0, \"region\": \"EU\"}",
