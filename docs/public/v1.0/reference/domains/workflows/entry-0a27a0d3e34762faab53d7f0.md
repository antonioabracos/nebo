# workflows — workflow.timeline(instance)

Bounded local workflow/agent state machine; no remote scheduler or external side effects; original observation: ordered timeline contains redacted migration history; SDK bounds: {"MAX_ATTEMPTS":8,"MAX_DOMAIN_CASES":256,"MAX_HISTORY":256,"MAX_ROWS":64,"MAX_RULES":64,"MAX_SAGA_STEPS":16,"MAX_STATES":128,"MAX_STEPS":64,"MAX_TRANSITIONS":1024}

```text
Identity: owner:G045:G045-S07-04 (DOMAIN_CONTRACT_ID)
Edition: 1
...
```text
Workflow.timeline(self, instance: str | None=None) -> tuple[dict[str, Any], ...]
```
...
[
  ...
  {
    "excerpt": "209:    and instances[0][\"context\"][\"secretNote\"] == \"<redacted>\")\n210: timeline = ops_v2.timeline(ops_instance[\"id\"])\n211: ok(\"positive\", \"workflow.timeline\", timeline[-1][\"kind\"] == \"migrated\"\n212:    and timeline[0][\"data\"][\"input\"][\"secretNote\"] == \"<redacted>\")\n213: metrics = ops_v2.metrics()",
...
- runtime/workflow/workflow_ops.asm — SHA-256 c1c84962a9178143b1f48ea4095b2043e4fe68cb099bafa76a79bb2c40430790
