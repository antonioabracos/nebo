# builtin.Console — Color.toHexWithAlpha
...
```text
Identity: g170-console:Color.toHexWithAlpha (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### console:color-sugar-rgba-(17_29_53_71); expected 23

```nebo
start(){Color(17,29,53,71).c;c.toHex().console();c.toHexWithAlpha().console();23.return;}
```
...
### console:color-serialize-arity; expected NEBO_TYPE_MISMATCH

```nebo
start(){Color.rgb(17,29,53).toHex(1);23.return;}
```
