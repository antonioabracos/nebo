...
```text
Identity: claim:3d68dc5fd9e828e756c26f2d (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### random:categorical-17-1.0-3; expected 23

```nebo
start(){Random.seed(17).r;Vector<Float> [1.0,2.0,3.0].weights;r.categorical(weights).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "2", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "ada65271c31b0bc29d43a86977c740d413f0cae3cb9363a295e8b2642318c565", "text": {"bytes_hex": "32"}}

## Rejected examples

### random:categorical-arity; expected NEBO_TYPE_MISMATCH

```nebo
start(){Random.seed(17).r;r.categorical().v;23.return;}
```
