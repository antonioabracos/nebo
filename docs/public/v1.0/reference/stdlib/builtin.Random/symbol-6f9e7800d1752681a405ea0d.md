...
```text
Identity: claim:c76165af03df20e5abaf51e2 (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### random:normal-17-0.0-1.0; expected 23

```nebo
start(){Random.seed(17).r;r.normal(0.0,1.0).v;"${v:fixed(6)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "-0.911270", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "859cef86bad2091340e6a3bd719eaa425eadba2dd88fe40546962630aaa94cb4", "text": {"bytes_hex": "2d302e393131323730"}}

## Rejected examples

### random:normal-arity; expected NEBO_TYPE_MISMATCH

```nebo
start(){Random.seed(17).r;r.normal(0.0).v;23.return;}
```
