...
```text
Identity: claim:b4ef49137abb98c4399ea805 (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### random:sample-29--31-4-1; expected 23

```nebo
start(){Random.seed(29).r;Vector<Int> [-31,7,59,101].a;r.sample(a,1).s;s.at(0).v0;"${v0}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "-31", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "bf377937bbf17aa86547160e99da285182cba130a67796e33d6c785d2683a707", "text": {"bytes_hex": "2d3331"}}

## Rejected examples

### random:sample-scalar; expected NEBO_TYPE_MISMATCH

```nebo
start(){Random.seed(17).r;r.sample(17,1);23.return;}
```
