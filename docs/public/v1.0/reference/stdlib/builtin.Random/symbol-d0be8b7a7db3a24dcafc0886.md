...
```text
Identity: claim:a04f7c67ac62f3dffd7e2d2d (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### random:bernoulli-arity; expected NEBO_TYPE_MISMATCH

```nebo
start(){Random.seed(17).r;r.bernoulli().v;23.return;}
```
