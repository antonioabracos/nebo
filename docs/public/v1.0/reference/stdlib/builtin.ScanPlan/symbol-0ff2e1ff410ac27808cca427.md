# builtin.ScanPlan — ScanPlan.noEcho
...
```text
Identity: g170-scan:noEcho (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:security-16-0-4; expected 23

```nebo
start(){"Synthetic input".scan(.text(),.console(),.noEcho(),.mock("Aa7!")).byteLength().console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "4", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "observation": {"native_oracle": "scan_public_test.observe"}, "process_exit": 23, "runtime_determinism": "DOMAIN_INVARIANTS", "runtime_sha256": "685a4fd5781b9f1bbcc69209fcbe6ddbbc6fdb5e5e00d79d7e27bab88f374229", "scan_trace": true, "text": {"bytes_hex": "34"}}
