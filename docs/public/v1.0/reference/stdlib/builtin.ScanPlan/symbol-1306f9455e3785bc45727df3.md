# builtin.ScanPlan — ScanPlan.minLen
...
```text
Identity: g170-scan:minLen (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:minlen-exact; expected 23

```nebo
start(){"Input".scan(.text(),.minLen(2),.mock("ab")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "ab", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "c1500aa38126b7d205e0e7482e851a7ac68101d5aeb4a65f1dc904b5d068b4ca", "text": {"bytes_hex": "6162"}}

## Rejected examples

### scan:option-type-minLen; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.minLen(true));23.return;}
```
