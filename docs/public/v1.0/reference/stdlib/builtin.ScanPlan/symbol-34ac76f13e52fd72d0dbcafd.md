...
```text
Identity: g170-scan:int (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:int-7-return-23; expected 23

```nebo
start(){"Age: ".scan(.int(),.mock("7")).console();23.return;}
```
