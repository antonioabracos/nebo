# builtin.ScanPlan — ScanPlan.retry
...
```text
Identity: g170-scan:retry (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:retry-default-eighth; expected 29

```nebo
start(){"Input".scan(.int(),.retry(),.replay("answers.txt")).return;}
```

Oracle: {"capabilities": {"console": "NO_DOCUMENT_OBSERVER", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "filesystem_effects": {}, "independent_builds": 2, "inputs": {"answers.txt": {"bytes_hex": "696e76616c69640a696e76616c69640a696e76616c69640a696e76616c69640a696e76616c69640a696e76616c69640a696e76616c69640a32390a"}}, "process_exit": 29, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}

## Rejected examples

### scan:option-arity-retry; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.retry(17));23.return;}
```
