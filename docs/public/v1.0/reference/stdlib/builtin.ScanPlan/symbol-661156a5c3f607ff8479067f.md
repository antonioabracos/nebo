# builtin.ScanPlan — ScanPlan.bool
...
```text
Identity: g170-scan:bool (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:bool-True; expected 23

```nebo
start(){"Ready: ".scan(.bool(),.mock("true")).console();23.return;}
```
...
### scan:option-arity-bool; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.bool(17));23.return;}
```
