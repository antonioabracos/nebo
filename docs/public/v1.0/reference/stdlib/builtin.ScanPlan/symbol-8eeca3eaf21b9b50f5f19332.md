# builtin.ScanPlan — ScanPlan.maxLines
...
```text
Identity: g170-scan:maxLines (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:multiline-line-limit-1; expected 23

```nebo
start(){"Input".scan(.multiline(),.maxLines(1),.mock("line")).byteLength().console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "4", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "24376fee255443343dd82183aec0410bb84abdd51e022adce77caacd30fc3b11", "text": {"bytes_hex": "34"}}
