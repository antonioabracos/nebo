# builtin.ScanPlan — ScanPlan.eofAsNone
...
```text
Identity: g170-scan:eofAsNone (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:eof-option-eof; expected 23

```nebo
start(){"Input".scan(.int(),.eofAsNone()).isSome().console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "false", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[5\], "process_exit": 23, "prompt": {"bytes_hex": "496e707574"}, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "3054b65e0ebb6e285d1be34005b20dd0668c812025ed22550cbe5a47496b05d3", "stdin": {"bytes_hex": ""}, "text": {"bytes_hex": "66616c7365"}}

## Rejected examples

### scan:option-arity-eofAsNone; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.eofAsNone(17));23.return;}
```
