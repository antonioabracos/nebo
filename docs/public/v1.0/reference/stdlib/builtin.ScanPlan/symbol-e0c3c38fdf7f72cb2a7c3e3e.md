# builtin.ScanPlan — ScanPlan.maxAttempts
...
```text
Identity: g170-scan:maxAttempts (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:replay-retry-29-1; expected 23

```nebo
start(){"Age".scan(.int(),.replay("answers.txt"),.retry(),.maxAttempts(1)).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "29", "filesystem_effects": {}, "independent_builds": 2, "inputs": {"answers.txt": {"bytes_hex": "32390a"}}, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "370d97f6e26f23ed81e9c021bd2ab29ed3ebfce8dd258bf43154946597952637", "text": {"bytes_hex": "3239"}}
