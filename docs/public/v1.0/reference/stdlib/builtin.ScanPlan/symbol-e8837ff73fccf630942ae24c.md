# builtin.ScanPlan — ScanPlan.multiSelect
...
```text
Identity: g170-scan:multiSelect (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:multi-select-3-red; expected 23

```nebo
start(){"Choice".scan(.console(),.multiSelect(["red","green","blue"]),.mock("red")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "1", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "observation": {"native_oracle": "scan_public_test.observe"}, "process_exit": 23, "runtime_determinism": "DOMAIN_INVARIANTS", "runtime_sha256": "125a678536209aea4c1f30d505c5ade3b455749fb64928d989fc4015bb8dc710", "scan_trace": true, "text": {"bytes_hex": "31"}}

## Rejected examples

### scan:choice-type-multiSelect; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Choice".scan(.console(),.multiSelect([17,29]));23.return;}
```
