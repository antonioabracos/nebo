# builtin.ScanPlan — ScanPlan.upper
...
```text
Identity: g170-scan:upper (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:upper-48654c4c6f; expected 23

```nebo
start(){"Input".scan(.text(),.upper(),.mock("HeLLo")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "HELLO", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "0812d6f3ebd563abd65cc4bf6bbb3700874e179b333d82b10d7d17cdb5d901bf", "text": {"bytes_hex": "48454c4c4f"}}

## Rejected examples

### scan:option-arity-upper; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.upper(17));23.return;}
```
