# builtin.ScanPlan — ScanPlan.trim
...
```text
Identity: g170-scan:trim (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:trim-204e65626f20; expected 23

```nebo
start(){"Input".scan(.text(),.trim(),.mock(" Nebo ")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "Nebo", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "d02f70fc076802b5a7e6686bb0bc588d367d132172f8206a0591691df2193773", "text": {"bytes_hex": "4e65626f"}}

## Rejected examples

### scan:option-arity-trim; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.trim(17));23.return;}
```
