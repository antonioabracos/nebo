# builtin.ScanPlan — ScanPlan.rawBlock
...
```text
Identity: g170-scan:rawBlock (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:multiline-raw-stdin; expected 23

```nebo
start(){"Input".scan(.rawBlock()).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "first\nsecond\n", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2, 3, 2, 3\], "process_exit": 23, "prompt": {"bytes_hex": "496e707574"}, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "4fcd4500b8569db887eee96a3ec617b51129e777a90855e4c5ad3bfb121c14cc", "stdin": {"bytes_hex": "66697273740a7365636f6e640a"}, "text": {"bytes_hex": "66697273740a7365636f6e640a"}}

## Rejected examples

### scan:multiline-mode-conflict; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.multiline(),.rawBlock());23.return;}
```
