...
```text
Identity: g170-scan:max (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:range-17; expected 23

```nebo
start(){"Age".scan(.int(),.min(17),.max(83),.mock("17")).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "17", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "50b51beedee62ac56116895bebfe5602de0a663f834a7fb6a1fdb11dbdb27d18", "text": {"bytes_hex": "3137"}}
