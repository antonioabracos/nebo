# builtin.ScanPlan — ScanPlan.forgetAfterUse
...
```text
Identity: g170-scan:forgetAfterUse (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### scan:forget-trace-11-S; expected 23

```nebo
start(){"Input".scan(.text(),.console(),.secret(),.forgetAfterUse(),.mock("Synthetic7!")).byteLength().console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "11", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "observation": {"native_oracle": "scan_public_test.observe"}, "process_exit": 23, "runtime_determinism": "DOMAIN_INVARIANTS", "runtime_sha256": "2a2a44e67ccff981b7cc317a4f63d395d33c4b40e40994ff2d43c3d770108108", "scan_trace": true, "text": {"bytes_hex": "3131"}}

## Rejected examples

### scan:security-arity-forgetAfterUse; expected NEBO_TYPE_MISMATCH

```nebo
start(){"Input".scan(.text(),.secret(),.forgetAfterUse(17));23.return;}
```
