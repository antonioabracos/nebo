# builtin.Text — InterpolationPurityCheck
...
```text
Identity: g061-format:InterpolationPurityCheck (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:numeric-method; expected 23

```nebo
start(){"${81.sqrt()}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "9", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "5eb6ad141b25862e9a6d5226d2f8aa3c41ed9ca78342f5b3f186f62dcf2a9ecf", "text": {"bytes_hex": "39"}}
