...
```text
Identity: g060-format:%.2f (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:fixed-nearest-even-1.125; expected 23

```nebo
start(){"%.2f".format(1.125).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "1.12", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "d354942d260e526ac1c7b010b09719772235cc0d30bd67d239f85744b4be5023", "text": {"bytes_hex": "312e3132"}}
