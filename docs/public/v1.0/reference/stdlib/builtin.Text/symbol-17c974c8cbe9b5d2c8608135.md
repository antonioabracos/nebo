...
```text
Identity: g059-format:format(...).binding (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:two-live; expected 23

```nebo
start(){"%d".format(17).one;"%s".format("Nebo").two;one.console();two.console();one.console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "17Nebo17", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2, 2, 2\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "0f00e27f99f8d4bf4ab2bd57ffa9945a84dad79120ec513a2721afbfdcc5ec0a", "text": {"bytes_hex": "31374e65626f3137"}}
