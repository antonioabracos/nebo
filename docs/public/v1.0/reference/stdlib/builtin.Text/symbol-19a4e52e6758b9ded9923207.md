# builtin.Text — InterpolationRecovery
...
```text
Identity: g061-format:InterpolationRecovery (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:source-value; expected 23

```nebo
// Interpolation must observe the actual bound values and preserve the return.
start() {
    17.first;
    29.second;
    "sum=${first + second}".console();
    23.return;
}

```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "sum=46", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "4889a7f72284ed23371c2861b6f7b3913ef75ac6ec0298da6ae8ff427edf7d65", "text": {"bytes_hex": "73756d3d3436"}}

## Rejected examples

### interpolation:nesting-limit; expected NEBO_LIMIT_EXCEEDED
...
[
  {
    "case_id": "interpolation:lexer-missing-expression-end",
    "category": "native-owner"
  },
  {
    "case_id": "interpolation:lexer-missing-quote",
    "category": "native-owner"
  },
  {
    "case_id": "interpolation:ast-empty-expression",
    "category": "native-owner"
  }
]
```
