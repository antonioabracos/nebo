# builtin.Text — InterpolationStartToken
...
```text
Identity: g061-format:InterpolationStartToken (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
[
  {
    "case_id": "interpolation:lexer-one",
    "category": "native-owner"
  },
  {
    "case_id": "interpolation:ast-integer",
    "category": "native-owner"
  }
]
```
