...
```text
Identity: g060-format:%e (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:scientific-0.0; expected 23

```nebo
start(){"%.2e".format(0.0).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "0.00e+00", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "ad2c3d564442b024c515d7a471e52fccf8ea87d95363831f4b8b44bec0383046", "text": {"bytes_hex": "302e3030652b3030"}}

## Rejected examples

### format:wrong-scientific; expected NEBO-FORMAT-003

```nebo
start(){"%e".format(17);23.return;}
```
