...
```text
Identity: g060-format:%o (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:octal-29; expected 23

```nebo
start(){"%o".format(29).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "35", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "4956171a55255cd002e1ba6749834b8c7ae99d963acc5abccc5097830b0a624d", "text": {"bytes_hex": "3335"}}

## Rejected examples

### format:wrong-octal; expected NEBO-FORMAT-003

```nebo
start(){"%o".format("Nebo");23.return;}
```
