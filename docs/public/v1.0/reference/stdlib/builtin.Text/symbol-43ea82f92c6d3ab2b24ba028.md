...
```text
Identity: g060-format:%q (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:quote-4e65626f; expected 23

```nebo
start(){"%q".format("Nebo").console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "\"Nebo\"", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "be05dc7692deb0a346ba4e4808981307b3daae7611eeda5c0f66ae007b1bc735", "text": {"bytes_hex": "224e65626f22"}}

## Rejected examples

### format:wrong-quote; expected NEBO-FORMAT-003

```nebo
start(){"%q".format(true);23.return;}
```
