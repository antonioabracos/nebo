...
```text
Identity: g060-format:.formatOnly() (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:configured-format; expected 23

```nebo
start(){"%d".validateOnly().formatOnly().format(17).unwrapOr("fallback").console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "17", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "23a56f3b59ae6d2baab671310a8224028ec7a9e6b943d41e6b7a3d5bf65691c5", "text": {"bytes_hex": "3137"}}

## Rejected examples

### format:configured-arity-formatOnly; expected NEBO-FORMAT-002

```nebo
start(){"%d".formatOnly(17);23.return;}
```
