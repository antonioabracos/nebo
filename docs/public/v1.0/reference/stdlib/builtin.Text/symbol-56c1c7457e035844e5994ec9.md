...
```text
Identity: g060-format:%04d (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:zero-width-7; expected 23

```nebo
start(){"%04d".format(7).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "0007", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e6a37ee6109602567390bfdb07f430c55fe41cb5228711c0628abf69e18f514d", "text": {"bytes_hex": "30303037"}}
