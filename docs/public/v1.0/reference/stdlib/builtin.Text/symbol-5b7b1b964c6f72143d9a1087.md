# builtin.Text — LSP interpolation tokens
...
```text
Identity: g061-format:LSP interpolation tokens (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:tooling-nested; expected 23

```nebo
start(){"outer=${"inner=${29}"}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "outer=inner=29", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "fb81dcb023dde4d1638c43269c8c7b9341a689abca7690aeb50424f673bd1ed8", "text": {"bytes_hex": "6f757465723d696e6e65723d3239"}}
...
[
  {
    "case_id": "interpolation:tooling-token-limit",
    "category": "tooling"
  }
]
```
