# builtin.Text — A_B_FORMAT_PLAN_EQUIVALENCE
...
```text
Identity: g061-format:A_B_FORMAT_PLAN_EQUIVALENCE (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:equivalence-decimal; expected 23

```nebo
start(){"${29}".console();23.return;}
```
