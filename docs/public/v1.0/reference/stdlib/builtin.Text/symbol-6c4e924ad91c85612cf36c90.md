# builtin.Text — InterpolatedTextExpr
...
```text
Identity: g061-format:InterpolatedTextExpr (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
[
  {
    "case_id": "interpolation:ast-arithmetic",
  ...
  {
    "case_id": "interpolation:ast-nested",
    "category": "native-owner"
  }
]
```
