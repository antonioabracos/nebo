...
### format:structure-#-Int-3137; expected 23

```nebo
start(){"%#".format(17).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "{Int:17}", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "75c80e91c2d57b91e9c16efedd64a9ab6eaddefcccfaef0f57d84cde0242d2ec", "text": {"bytes_hex": "7b496e743a31377d"}}

## Rejected examples

### format:wrong-value; expected NEBO-FORMAT-003

```nebo
start(){"%v".format(List<Int>.new());23.return;}
```
