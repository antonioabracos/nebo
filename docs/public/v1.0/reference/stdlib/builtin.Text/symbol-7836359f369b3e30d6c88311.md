# builtin.Text — rename inside interpolation
...
```text
Identity: g061-format:rename inside interpolation (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:tooling-rename-source; expected 23

```nebo
(Int.value)raised(){(value+7).return;}start(){"${29.raised()} / literal add \${29.add()}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "36 / literal add ${29.add()}", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "2a43f56e2586584a9a935c99dfbb1e4f7888bfea2d8126b9d58a851b059ea420", "text": {"bytes_hex": "3336202f206c69746572616c2061646420247b32392e61646428297d"}}
...
[
  {
    "case_id": "interpolation:tooling-rename-literal",
    "category": "tooling"
  }
]
```
