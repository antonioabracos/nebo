...
```text
Identity: g060-format:%? (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:structure-?-Int-2d3833; expected 23

```nebo
start(){"%?".format(-83).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "&lt;Int -83&gt;", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "f265eb8d9d4ddb7f140dc711951b04188533a7c0ed4384b9302c32fa01ecf4a5", "text": {"bytes_hex": "3c496e74202d38333e"}}
