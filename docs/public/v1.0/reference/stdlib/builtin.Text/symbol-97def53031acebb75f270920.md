...
### format:align-left-4e65626f; expected 23

```nebo
start(){"%-8s".format("Nebo").console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "Nebo    ", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "565b31091685ebb9eafa52eb2e7d00adda16cca2d34978e97e016a4a02dbfed2", "text": {"bytes_hex": "4e65626f20202020"}}
