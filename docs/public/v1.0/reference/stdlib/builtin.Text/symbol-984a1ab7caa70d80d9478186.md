# builtin.Text — ${nome:align(right, 20)}
...
```text
Identity: g061-format:${nome:align(right, 20)} (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:align-right-4e65626f; expected 23

```nebo
start(){"Nebo".value;"[${value:align(right,9)}]".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "\[     Nebo\]", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "5f32246ebc6fd0c0f8c7aa3ee28690962d4708ebbc0724d08aa141b3cbcb8d26", "text": {"bytes_hex": "5b20202020204e65626f5d"}}

## Rejected examples

### interpolation:align-side; expected NEBO-FORMAT-003

```nebo
start(){"${"Nebo":align(unknown,8)}";23.return;}
```
