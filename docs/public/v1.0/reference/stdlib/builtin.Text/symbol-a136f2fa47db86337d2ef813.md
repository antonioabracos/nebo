# builtin.Text — InterpolationEndToken
...
```text
Identity: g061-format:InterpolationEndToken (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
[
  {
    "case_id": "interpolation:lexer-comment-brace",
