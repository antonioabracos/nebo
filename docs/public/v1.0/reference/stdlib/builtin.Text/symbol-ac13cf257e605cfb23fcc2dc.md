# builtin.Text — Text.format(args...) -&gt; Text
...
```text
Identity: g059-format:Text.format(args...) -> Text (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:return-0; expected 0

```nebo
start(){"%d".format(83).console();0.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "83", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 0, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "73f6dd8723c8af25841482547d05001efc04dbb691d1ddb5c45e5bf2d3545db7", "text": {"bytes_hex": "3833"}}
