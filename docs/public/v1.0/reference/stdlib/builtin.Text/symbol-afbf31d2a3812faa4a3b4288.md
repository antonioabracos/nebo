...
```text
Identity: g060-format:%2$s (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:position-reorder; expected 23

```nebo
start(){"%2$s %1$d".format(29,"Nebo").console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "Nebo 29", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "24253aa11c0a6b29cceeba77358c8993612e4583acf386028a1da0cb42d43f26", "text": {"bytes_hex": "4e65626f203239"}}

## Rejected examples

### format:position-missing; expected NEBO-FORMAT-006

```nebo
start(){"%2$d".format(17);23.return;}
```

Oracle: {"artifact_publication": "REJECTED", "compiler_exit": 1, "diagnostic": "NEBO-FORMAT-006"}
