...
```text
Identity: g060-format:%d (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:decimal-9223372036854775807; expected 23

```nebo
start(){"%d".format(9223372036854775807).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "9223372036854775807", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "a1c171b585b269fd9323509cc4acc06f0abdbef853a63378a5a73a37585df699", "text": {"bytes_hex": "39323233333732303336383534373735383037"}}
