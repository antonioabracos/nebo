# builtin.Text — FormatProfileExpr
...
```text
Identity: g061-format:FormatProfileExpr (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:hex-width-29; expected 23

```nebo
start(){(29).value;"${value:hex(width:8)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "      1d", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "4d2fec4623204621c51e7093838b254ca5e606d20c3f14e4bac4b2fa19447e33", "text": {"bytes_hex": "2020202020203164"}}

## Rejected examples

### interpolation:unknown-profile; expected NEBO-FORMAT-001

```nebo
start(){"${17:absent(2)}";23.return;}
```
