...
```text
Identity: g060-format:%T (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### format:typename-Int; expected 23

```nebo
start(){"%T".format(-29).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "Int", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "00a4372b77b443e78840e7a99a2fd0466fa3590dedf09827634860bc12c38e35", "text": {"bytes_hex": "496e74"}}

## Rejected examples

### format:wrong-typename; expected NEBO-FORMAT-003

```nebo
start(){"%T".format(List<Int>.new());23.return;}
```
