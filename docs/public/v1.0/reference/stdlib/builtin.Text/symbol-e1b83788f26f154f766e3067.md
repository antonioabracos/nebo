...
```text
Identity: g061-format:${id:hex(width: 8)} (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:hex-width-7; expected 23

```nebo
start(){(7).value;"${value:hex(width:8)}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "       7", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "0bee00c256142f8d2935469926db29c984d9feb875872594a622ffa4e10f7b49", "text": {"bytes_hex": "2020202020202037"}}

## Rejected examples

### interpolation:width-name; expected NEBO-FORMAT-005

```nebo
start(){"${17:hex(other:8)}";23.return;}
```
