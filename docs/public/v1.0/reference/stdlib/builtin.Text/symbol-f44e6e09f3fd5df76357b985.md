...
```text
Identity: g061-format:\${ (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "${value}", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "b338f8e71d8727b21df2a635ac488bef9b8eca21843c09d92a5b85d89253a08e", "text": {"bytes_hex": "247b76616c75657d"}}
...
[
  {
    "case_id": "interpolation:lexer-escaped",
