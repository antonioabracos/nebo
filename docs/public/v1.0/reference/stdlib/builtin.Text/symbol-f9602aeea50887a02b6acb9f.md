...
```text
Identity: g061-format:${nome} (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:text-61c3a7c3a36f; expected 23

```nebo
start(){"ação".text;"[${text}]".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "\[ação\]", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "0f514fb492023e879b21bb2e46332a3e7b6eba3f05c31f63fe47e500ac8440bd", "text": {"bytes_hex": "5b61c3a7c3a36f5d"}}
