# builtin.Text — ${texto.codepointCount()}
...
```text
Identity: g061-format:${texto.codepointCount()} (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### interpolation:pure-method-4e65626f; expected 23

```nebo
start(){"Nebo".text;"${text.codepointCount()}".console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "4", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e57ec58b924e93c95faa933f670ada2aa72548494e4b46dbdb65cae014d6a1d4", "text": {"bytes_hex": "34"}}
