# builtin.channels — Channel.close

Closes this owner and rejects subsequent sends without changing another channel.

```text
Identity: material:Channel.close (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
Closes this owner and rejects subsequent sends without changing another channel. Int64 FIFO capacity 1..64; unbuffered no-peer; closed/empty/full/wait error codes; independent token state
