# builtin.channels — Channel.trySend

Enqueues once; full yields 10 and closed yields 9.

```text
Identity: material:Channel.trySend (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
```text
Channel<Int>.trySend(Int) -> Result<Int,Int>
```

## Bounded behavior

Enqueues once; full yields 10 and closed yields 9. Int64 FIFO capacity 1..64; unbuffered no-peer; closed/empty/full/wait error codes; independent token state
