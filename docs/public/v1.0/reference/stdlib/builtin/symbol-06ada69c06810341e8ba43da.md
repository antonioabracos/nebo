...
```text
Identity: g007-public:Stack.peek (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:stack-list-method; expected NEBO_TYPE_MISMATCH

```nebo
start(){Stack<Int>.new().a;a.at(0);23.return;}
```
