...
```text
Identity: g007-public:List<Int>.new (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:List-return-23; expected 23

```nebo
start(){List<Int>.new().items;23.return;}
```
