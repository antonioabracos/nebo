...
```text
Identity: g010-public:Dataset.collect (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### data:collect-return-0; expected 0

```nebo
start(){Table.fromColumns([Tuple.of("age",Column<Int>.from([17,29]))]).a;Table.fromColumns([Tuple.of("age",Column<Int>.from([71]))]).b;Dataset.fromTables([a,b]).d;d.collect().rows;rows.at(2).get("age").expect("v").console();0.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "71", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4\], "process_exit": 0, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "995e31d70757ca903bb2942c64a1bcfa917a115a950df2a2465cb3c9cad0b07e", "text": {"bytes_hex": "3731"}}
