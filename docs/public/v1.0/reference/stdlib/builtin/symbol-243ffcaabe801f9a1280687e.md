...
```text
Identity: g007-public:List.deduplicate (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:deduplicate-adjacent; expected 23

```nebo
start(){List<Int>.from([17,17,29,17]).a;a.deduplicate();a.length().console();a.at(2).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "317", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4, 4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "50caf127b407640a0bbcd72dff98e2ead1713ddb2f8189fc24b528b1954c8718", "text": {"bytes_hex": "333137"}}

## Rejected examples

### sequence:list-deduplicate-arity; expected NEBO_TYPE_MISMATCH

```nebo
start(){List<Int>.new().a;a.deduplicate(17);23.return;}
```
