...
```text
Identity: g007-public:collection.iterator (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:iterator-copy; expected NEBO_COPY_UNIQUE

```nebo
start(){List<Int>.new().a;a.iterator().i;i.j;23.return;}
```
