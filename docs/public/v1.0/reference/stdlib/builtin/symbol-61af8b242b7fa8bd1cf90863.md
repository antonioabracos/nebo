...
```text
Identity: g009-public:Graph.removeEdge (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### relation:graph-directed-remove-edge; expected 23

```nebo
start(){Graph<Int,Int>.directed().g;g.addNode(17).a;g.addNode(71).b;g.addEdge(a,b,5).e;g.removeEdge(e).console();g.neighbors(a).length().console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "true0", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[5, 4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "798bf0ab6231fa0819798027a8752d8f1f48dbda47a7a7564a17e8a6fbb9c632", "text": {"bytes_hex": "7472756530"}}

## Rejected examples

### relation:graph-remove-edge-type; expected NEBO_TYPE_MISMATCH

```nebo
start(){Graph<Int,Int>.directed().g;g.removeEdge(17);23.return;}
```
