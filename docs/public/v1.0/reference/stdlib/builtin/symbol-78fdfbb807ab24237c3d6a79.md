...
```text
Identity: g007-public:Deque.popFront (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:deque-list-method; expected NEBO_TYPE_MISMATCH

```nebo
start(){Deque<Int>.new().a;a.insert(0,17);23.return;}
```
