...
```text
Identity: g007-public:List<Int>.withCapacity (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:List-element-type; expected NEBO_TYPE_MISMATCH

```nebo
start(){List<Text>.new().a;23.return;}
```
