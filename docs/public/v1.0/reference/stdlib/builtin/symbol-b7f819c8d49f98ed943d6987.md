...
```text
Identity: g010-public:Column<Int> [values] (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### data:column-prefix; expected 10

```nebo
start(){Column<Int> [1,2,3,4].c;c.sum().return;}
```

Oracle: {"capabilities": {"console": "NO_DOCUMENT_OBSERVER", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "filesystem_effects": {}, "independent_builds": 2, "process_exit": 10, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}

## Rejected examples

### data:column-element-type; expected NEBO_TYPE_MISMATCH

```nebo
start(){Column<Text>.from([17]).c;23.return;}
```
