...
```text
Identity: g009-public:Tree.removeSubtree (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### relation:tree-removed-count; expected 2

```nebo
start(){Tree<Int>.new(17).t;t.root().r;t.addChild(r,29).a;t.addChild(a,71);t.removeSubtree(a).return;}
```
...
### relation:tree-removeSubtree-node-type; expected NEBO_TYPE_MISMATCH

```nebo
start(){Tree<Int>.new(17).t;t.removeSubtree(17);23.return;}
```
