...
```text
Identity: g007-public:Queue.enqueue (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:Queue-wrong-value; expected NEBO_TYPE_MISMATCH

```nebo
start(){Queue<Int>.new().a;a.enqueue(true);23.return;}
```
