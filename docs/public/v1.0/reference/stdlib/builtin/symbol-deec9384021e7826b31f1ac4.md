...
```text
Identity: g007-public:Stack.clear (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:Stack-clear; expected 0

```nebo
start(){Stack<Int>.new().a;a.push(17);a.clear();a.length().return;}
```
