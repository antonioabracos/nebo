...
```text
Identity: g009-public:Tree.addChild (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### relation:tree-raw-handle; expected NEBO_TYPE_MISMATCH

```nebo
start(){Tree<Int>.new(17).t;t.addChild(0,71);23.return;}
```
