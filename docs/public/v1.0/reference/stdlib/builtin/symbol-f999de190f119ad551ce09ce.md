...
```text
Identity: g010-public:Table.columnCount (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### data:table-dimensions-many; expected 23

```nebo
start(){Table.fromColumns([Tuple.of("age",Column<Int>.from([17,29,71])),Tuple.of("score",Column<Int>.from([83,7,53]))]).t;t.rowCount().console();t.columnCount().console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "32", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4, 4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "203b978cd45dba2f37e626ce17f2d7a358fcad5dc24ed77427c0f26294f841ed", "text": {"bytes_hex": "3332"}}

## Rejected examples

### data:table-column-count-arity; expected NEBO_TYPE_MISMATCH

```nebo
start(){Table.fromColumns([Tuple.of("age",Column<Int>.from([17]))]).t;t.columnCount(17);23.return;}
```
