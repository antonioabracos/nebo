...
```text
Identity: g007-public:Stack.pop (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:stack-pop-empty; expected 23

```nebo
start(){Stack<Int>.new().a;a.pop().isNone().console();23.return;}
```
