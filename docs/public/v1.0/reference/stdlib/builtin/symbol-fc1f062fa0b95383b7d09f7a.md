...
```text
Identity: g007-public:Stack.push (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### sequence:stack-lifo; expected 23

```nebo
start(){Stack<Int>.new().s;s.push(17);s.push(29);s.peek().console();s.pop().expect("top").console();s.pop().expect("top").console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "292917", "filesystem_effects": {}, "independent_builds": 2, "kinds": \[4, 4, 4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "9a2fc1d3c4247ba1c9320408c0239875d7abb2893f972bcf42471f1a6d0f4a02", "text": {"bytes_hex": "323932393137"}}

## Rejected examples

### sequence:Stack-wrong-value; expected NEBO_TYPE_MISMATCH

```nebo
start(){Stack<Int>.new().a;a.push(true);23.return;}
```
