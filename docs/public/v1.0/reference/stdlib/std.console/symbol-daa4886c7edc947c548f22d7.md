...
{"availability": "BOUNDED_PUBLIC", "capabilities": \["console"\], "editions": \["1"\], "effects": \["console", "input"\], "exports": \["console", "scan"\], "importGrantsCapabilities": false, "layer": "STDLIB", "name": "std.console", "since": "Edition 1", "stability": "stable", "targets": \["x86_64-systemv-elf-linux"\]}

```text
Identity: module:std.console (MODULE_IDENTITY)
Edition: 1
...
```text
import "std.console" { console; scan; }.library;
```
...
import "std.console" { console; scan; }.library; Importing never grants capabilities. std.core and std.console exports retain their canonical core/prelude reference owners.
...
[
  {
    "case_id": "local:module-std.console",
    "category": "SDK",
    "record": {
      "availability": "BOUNDED_PUBLIC",
      "capabilities": [
