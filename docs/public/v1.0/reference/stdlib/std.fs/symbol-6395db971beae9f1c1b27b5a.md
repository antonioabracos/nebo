...
Returns the final lexical component, preserving UTF-8 bytes.

```text
Identity: qualified:Path.fileName (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
