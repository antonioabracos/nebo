...
Publishes the completed output at the atomic commit point.

```text
Identity: qualified:atomic (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### filesystem:write-created; expected 23

```nebo
import "std.fs" { Path; File; }.fs;
start(){Path.parse("new.txt").p;File.writeText(p,"Nebo71",utf8,atomic).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "6", "expected_files": {"new.txt": {"bytes_hex": "4e65626f3731"}}, "filesystem_effects": {"new.txt": "25f0ac1f57c2cd5597f4f9dce2a19a7d79bc976f7bee1a4c71bd094de53da30b"}, "independent_builds": 2, "kinds": \[4\], "process_exit": 23, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "7fc83690b6147dc43ed5990a43a0fecb21bef032a0f184b0a68c08037713aa3a", "text": {"bytes_hex": "36"}}
