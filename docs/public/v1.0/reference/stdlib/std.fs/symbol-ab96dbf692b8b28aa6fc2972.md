...
Parses and normalizes typed path components; empty, NUL, escaping parent, overlong component and excessive depth fail.

```text
Identity: qualified:Path.parse (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
