...
Appends to existing private file contents.

```text
Identity: qualified:append (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### filesystem:write-append-0; expected 23

```nebo
import "std.fs" { Path; File; }.fs;
start(){Path.parse("output.txt").p;File.writeText(p,"",utf8,append);File.readText(p,utf8,64).console();23.return;}
```

Oracle: {"capabilities": {"console": "RETAINED_DOCUMENT", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "console_text_utf8": "before", "expected_files": {}, "filesystem_effects": {}, "independent_builds": 2, "inputs": {"output.txt": {"bytes_hex": "6265666f7265"}}, "kinds": \[2\], "process_exit": 23, "publications": 1, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "937a93bde428d4522fa5153ded23f6d4c862aeb312aeadb8de118396b44112e5", "text": {"bytes_hex": "6265666f7265"}}
