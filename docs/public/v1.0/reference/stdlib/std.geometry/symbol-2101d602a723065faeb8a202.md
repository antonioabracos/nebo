...
```text
Intrinsic namespace: std.geometry. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace.
```
...
Intrinsic namespace: std.geometry. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace. Importing never grants capabilities. std.core and std.console exports retain their canonical core/prelude reference owners.
...
### linear:parallel-right-scalar; expected NEBO_TYPE_MISMATCH
...
- [symbol-5831dd94bae09d6cb655a901](symbol-5831dd94bae09d6cb655a901.md)
