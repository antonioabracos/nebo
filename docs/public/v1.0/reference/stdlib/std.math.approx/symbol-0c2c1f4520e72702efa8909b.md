...
```text
Intrinsic namespace: std.math.approx. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace.
```
...
Intrinsic namespace: std.math.approx. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace. Importing never grants capabilities. std.core and std.console exports retain their canonical core/prelude reference owners.
...
- [symbol-aa38abbdf5bce095ce6e4f09](symbol-aa38abbdf5bce095ce6e4f09.md)

- [symbol-77ed037837f30181289aebfb](symbol-77ed037837f30181289aebfb.md)
