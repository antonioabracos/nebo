...
```text
Intrinsic namespace: std.math.combinatorics. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace.
```
...
Intrinsic namespace: std.math.combinatorics. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace. Importing never grants capabilities. std.core and std.console exports retain their canonical core/prelude reference owners.
...
- [symbol-3f14ea90d8a94f4ae3b8f5b3](symbol-3f14ea90d8a94f4ae3b8f5b3.md)
