...
```text
Intrinsic namespace: std.math.constants. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace.
```
...
Intrinsic namespace: std.math.constants. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace. Importing never grants capabilities. std.core and std.console exports retain their canonical core/prelude reference owners.
...
- [symbol-cccf8646004e3b1d67c9ca83](symbol-cccf8646004e3b1d67c9ca83.md)

- [symbol-1c2ff3dda1c7b3d128eac9a5](symbol-1c2ff3dda1c7b3d128eac9a5.md)
