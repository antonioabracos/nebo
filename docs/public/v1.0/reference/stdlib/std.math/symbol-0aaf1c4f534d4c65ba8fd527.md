...
```text
Identity: NSR-DOM-003 (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
lexeme: ∜
arity: 1
operand_rule: FourthRoot protocol
result_rule: type-specific root or Result
canonical_ascii: fourthRoot()
```
...
### operator:root-e2889c-0; expected 23
...
### operator:wrong-unary-e2889c; expected NEBO_TYPE_MISMATCH
