...
```text
Identity: claim:efa3beb45cb68277b395a2a8 (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### math:exp; expected 29

```nebo
start(){std.math.exp(1.25);29.return;}
```

Oracle: {"binary64_tolerance": {"absolute": 1e-12, "relative": 1e-12}, "capabilities": {"console": "NO_DOCUMENT_OBSERVER", "filesystem": "EXPLICIT_SCRATCH_EFFECT_ORACLE", "network": "DENIED_BY_SECCOMP"}, "filesystem_effects": {}, "independent_builds": 2, "independent_math_values": \[\[12, 2, 3.4903429574618414\]\], "math_trace_sha256": "8af11d89a85653090366faa44d6f882a2230773f06f73fbbc9cb887da882cb31", "observed_math_calls": 1, "process_exit": 29, "runtime_determinism": "BYTE_IDENTICAL", "runtime_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"}
