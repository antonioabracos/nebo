...
```text
Identity: module:std.meta (MODULE_IDENTITY)
Edition: 1
...
```text
Intrinsic namespace: std.meta. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace.
```
...
Intrinsic namespace: std.meta. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace. Importing never grants capabilities. std.core and std.console exports retain their canonical core/prelude reference owners.
...
- [symbol-d18248265a853fd2be4df7d2](symbol-d18248265a853fd2be4df7d2.md)
