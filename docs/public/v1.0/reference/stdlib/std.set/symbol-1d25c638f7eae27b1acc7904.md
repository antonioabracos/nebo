...
```text
Identity: NSR-DOM-027 (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### operator:set-e288a9-4; expected 23
...
### operator:wrong-set-e288a9; expected NEBO_TYPE_MISMATCH
