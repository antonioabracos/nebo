...
```text
Identity: NSR-DOM-028 (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### operator:set-e28896-4; expected 23
...
### operator:wrong-set-e28896; expected NEBO_TYPE_MISMATCH
