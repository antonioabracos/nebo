...
```text
Identity: NSR-DOM-073 (QUALIFIED_INTRINSIC_OR_REGISTRY_ID)
Edition: 1
...
### boundedoperator:dom-073-endpoint-0-False; expected 29
...
- [symbol-d5b7c4c2d9795733809f3ba9](symbol-d5b7c4c2d9795733809f3ba9.md)
