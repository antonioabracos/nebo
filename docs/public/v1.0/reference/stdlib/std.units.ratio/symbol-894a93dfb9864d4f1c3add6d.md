...
```text
Intrinsic namespace: std.units.ratio. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace.
```
...
Intrinsic namespace: std.units.ratio. Use the exact receiver-qualified or operator syntax on each member page; no selective import is declared for this namespace. Importing never grants capabilities. std.core and std.console exports retain their canonical core/prelude reference owners.
...
### operator:ratio-e280b0-0-False; expected 23
...
### operator:wrong-domain-e280b0; expected NEBO_TYPE_MISMATCH
...
- [symbol-68868e7209c90ef2b637226e](symbol-68868e7209c90ef2b637226e.md)

- [symbol-cfcb433a8926ee9ffe210ebb](symbol-cfcb433a8926ee9ffe210ebb.md)
