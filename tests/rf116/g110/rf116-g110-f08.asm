...
global _start
extern nebo_servicos_internos_visual_console_e_visual_panel_snapshot_lifecycle_contract_validate
...
_start:
    ...
    call nebo_servicos_internos_visual_console_e_visual_panel_snapshot_lifecycle_contract_validate
    test eax, eax
    jne .fail
