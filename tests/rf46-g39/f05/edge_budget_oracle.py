...
assert result==(130,0xd8ea04111dfb1fcc,13,52)
try:
    evaluate([ITEM_MAX+1])
    raise AssertionError("invalid value accepted")
except AssertionError:
    pass
print("RF46_G39_F05_ORACLE_PASS schema=edge_budget count=4 sum=%d hash=%016x" % result[:2])
